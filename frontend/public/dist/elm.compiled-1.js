...
{
	if (region.eA.cg === region.e8.cg)
	{
		return 'on line ' + region.eA.cg;
	}
	return 'on lines ' + region.eA.cg + ' through ' + region.e8.cg;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { hK: 'hidden', g7: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { hK: 'mozHidden', g7: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { hK: 'msHidden', g7: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { hK: 'webkitHidden', g7: 'webkitvisibilitychange' }
		: { hK: 'hidden', g7: 'visibilitychange' };
}
...
function _Browser_getViewport()
{
	return {
		...
		gs: {
			...
			gz: _Browser_window.pageYOffset,
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ff: fragment, fl: host, fU: path, fW: port_, f$: protocol, em: query};
	});
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {bc: frag, iy: params, a3: unvisited, aG: value, bq: visited};
	});
		...
		return $elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					...
					_List_Nil,
					$elm$url$Url$Parser$preparePath(url.fU),
...
var $author$project$Shared$classifyDevice = function (options) {
	return (options.jB < 900) ? A4($author$project$Shared$Device, 0, 0, options.jB, options.hI) : ((options.jB < 1400) ? A4($author$project$Shared$Device, 1, 0, options.jB, options.hI) : A4($author$project$Shared$Device, 2, 1, options.jB, options.hI));
};
				...
				switch (response.$) {
					...
					case 3:
						...
						if (!_v1.$) {
							var value = _v1.a;
							return $elm$core$Result$Err(
								A2($author$project$Api$BadStatus, metadata.eB, value));
						} else {
							var err = _v1.a;
							return $elm$core$Result$Err(
								A2(
...
var $elm$http$Http$riskyRequest = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{gO: true, a6: r.a6, bb: r.bb, be: r.be, bf: r.bf, bk: r.bk, bn: r.bn, bp: r.bp}));
};
var $author$project$Models$User = F5(
	function (id, username, email, privilege, moodleUrl) {
		return {e7: email, hN: id, h9: moodleUrl, fX: privilege, eK: username};
	});
	...
	return $elm$http$Http$riskyRequest(
		{
			...
			bb: A2($author$project$Api$expectJson, options.d8, $author$project$Api$Homework$User$userDecoder),
			be: _List_Nil,
			bf: 'GET',
		...
		return _Utils_Tuple2(
			A4(
				...
				$author$project$Shared$classifyDevice(
					{hI: flags.hI, jB: flags.jB})),
			$author$project$Api$Homework$User$getUserFromSession(
				{d8: $author$project$Shared$GotUser}));
	});
...
var $author$project$Models$Course = F5(
	function (id, name, assignments, fromMoodle, user) {
		return {gS: assignments, hE: fromMoodle, hN: id, ia: name, go: user};
	});
var $author$project$Models$Assignment = F6(
	function (id, courseId, user, title, dueDate, fromMoodle) {
		return {hh: courseId, hr: dueDate, hE: fromMoodle, hN: id, jo: title, go: user};
	});
	...
	function (defaultOffset, posixMinutes, eras) {
		...
		while (true) {
			if (!eras.b) {
				...
				if (_Utils_cmp(era.eA, posixMinutes) < 0) {
...
var $elm$time$Time$toDay = F2(
	function (zone, time) {
		return $elm$time$Time$toCivil(
			A2($elm$time$Time$toAdjustedMinutes, zone, time)).e2;
	});
...
var $elm$time$Time$toYear = F2(
	function (zone, time) {
		return $elm$time$Time$toCivil(
			A2($elm$time$Time$toAdjustedMinutes, zone, time)).gA;
	});
...
var $author$project$Pages$Dashboard$initCommands = _List_fromArray(
	[
		...
		{d8: $author$project$Pages$Dashboard$GotCourseData}),
		...
		7,
		{d8: $author$project$Pages$Dashboard$GotAssignmentData}),
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'title',
				$elm$json$Json$Encode$string(assignment.jo)),
				_Utils_Tuple2(
				'course',
				$elm$json$Json$Encode$int(assignment.hh)),
				_Utils_Tuple2(
				'due_date',
				$elm$json$Json$Encode$int(
					$author$project$Api$Homework$Assignment$dateEncoder(assignment.hr))),
				_Utils_Tuple2(
				'from_moodle',
				$elm$json$Json$Encode$bool(assignment.hE))
			]));
};
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				bb: A2($author$project$Api$expectJson, options.d8, $author$project$Api$Homework$Course$assignmentDecoder),
				be: _List_Nil,
				bf: 'POST',
				bk: $elm$core$Maybe$Nothing,
				bn: $elm$core$Maybe$Nothing,
...
var $author$project$Api$Homework$Course$MinimalCourse = F3(
	function (id, name, fromMoodle) {
		return {hE: fromMoodle, hN: id, ia: name};
	});
...
var $justinmimbs$date$Date$toOrdinalDate = function (_v0) {
	...
	return {
		d9: rd - $justinmimbs$date$Date$daysBeforeYear(y),
		gA: y
	};
};
var $justinmimbs$date$Date$toCalendarDate = function (_v0) {
	...
	return A3($justinmimbs$date$Date$toCalendarDateHelp, date.gA, 0, date.d9);
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {e0: col, hg: contextStack, fY: problem, f5: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.f5, s.e0, x, s.f));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.f5, s.e0, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{e0: newCol, f: s.f, k: s.k, b: newOffset, f5: newRow, a: s.a});
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{e0: 1, f: s.f, k: s.k, b: s.b + 1, f5: s.f5 + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{e0: s.e0 + 1, f: s.f, k: s.k, b: newOffset, f5: s.f5, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{e0: col, f: s0.f, k: s0.k, b: offset, f5: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.f5, s.e0, s);
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {e0: col, fY: problem, f5: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.f5, p.e0, p.fY);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{e0: 1, f: _List_Nil, k: 1, b: 0, f5: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
			return $elm$core$Result$Ok(value);
		} else {
...
var $justinmimbs$date$Date$language_en = {
	dA: $justinmimbs$date$Date$withOrdinalSuffix,
	d3: $justinmimbs$date$Date$monthToName,
	c6: A2(
		$elm$core$Basics$composeR,
		$justinmimbs$date$Date$monthToName,
		$elm$core$String$left(3)),
	eL: $justinmimbs$date$Date$weekdayToName,
	br: A2(
		$elm$core$Basics$composeR,
				...
				if (data.$ === 2) {
					...
					if (e.$ === 3) {
						...
						return ((s === 401) || (s === 403)) ? _Utils_Tuple2(
							model,
							A2($author$project$Utils$Route$navigate, model.bp.h0, 2)) : _Utils_Tuple2(
							_Utils_update(
								model,
								{y: data}),
							$elm$core$Platform$Cmd$none);
			...
			case 1:
				...
				return $elm$core$String$isEmpty(
					...
					A2(
						...
						text,
						{d8: $author$project$Pages$Dashboard$GotSearchCoursesData})) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							d: A2(
					...
					A2(
						$author$project$Api$Homework$Course$searchCourses,
						text,
						{d8: $author$project$Pages$Dashboard$GotSearchCoursesData})));
			case 3:
				var course = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
					...
					if (!_v5.$) {
						...
						return _Utils_Tuple2(
							...
							A2(
								...
								{hh: course.hN, hr: dueDate, hE: course.hE, jo: model.a0},
								{d8: $author$project$Pages$Dashboard$GotCreateAssignmentData}));
					} else {
			...
			case 10:
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						id,
						{d8: $author$project$Pages$Dashboard$GotRemoveAssignmentData}));
			case 11:
				var data = msg.a;
				if (data.$ === 3) {
												...
												return _Utils_update(
													c,
													{
														gS: A2(
															$elm$core$List$filter,
															function (a) {
																return !_Utils_eq(a.hN, assignment.hN);
															},
															c.gS)
													});
											},
											...
											return _Utils_update(
												c,
												{
													gS: A2(
														$elm$core$List$map,
														function (a) {
															return _Utils_eq(a.hN, assignmentId) ? _Utils_update(
																a,
																{jo: model.ba}) : a;
														},
														c.gS)
...
var $mdgriffith$elm_ui$Internal$Model$asColumn = 1;
var $mdgriffith$elm_ui$Internal$Style$classes = {gC: 'a', gD: 'atv', gG: 'ab', gH: 'cx', gI: 'cy', gJ: 'acb', gK: 'accx', gL: 'accy', gM: 'acr', eT: 'al', eU: 'ar', gN: 'at', dp: 'ah', dq: 'av', gQ: 's', gW: 'bh', gX: 'b', gZ: 'w7', g$: 'bd', g0: 'bdt', cF: 'bn', g1: 'bs', cJ: 'cpe', ha: 'cp', hb: 'cpx', hc: 'cpy', aN: 'c', cL: 'ctr', cN: 'cb', cO: 'ccx', aO: 'ccy', b1: 'cl', cP: 'cr', hf: 'ct', hi: 'cptr', hj: 'ctxt', hC: 'fcs', fd: 'focus-within', hF: 'fs', hH: 'g', dH: 'hbh', dI: 'hc', fj: 'he', dJ: 'hf', fk: 'hfp', hL: 'hv', hO: 'ic', hQ: 'fr', cZ: 'lbl', hV: 'iml', hW: 'imlf', hX: 'imlp', hY: 'implw', hZ: 'it', h$: 'i', fB: 'lnk', bI: 'nb', fJ: 'notxt', $9: 'ol', ip: 'or', bg: 'oq', ix: 'oh', aA: 'pg', fS: 'p', iz: 'ppe', iJ: 'ui', f5: 'r', iP: 'sb', iQ: 'sbx', iR: 'sby', iT: 'sbt', iX: 'e', iY: 'cap', iZ: 'sev', i4: 'sk', dj: 't', ja: 'tc', jb: 'w8', jc: 'w2', jd: 'w9', je: 'tj', dk: 'tja', jf: 'tl', jg: 'w3', jh: 'w5', ji: 'w4', jj: 'tr', jk: 'w6', jl: 'w1', jm: 'tun', aa: 'ts', bo: 'clr', jx: 'u', eM: 'wc', gv: 'we', eN: 'wf', gw: 'wfp', eO: 'wrp'};
var $mdgriffith$elm_ui$Internal$Model$Generic = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$div = $mdgriffith$elm_ui$Internal$Model$Generic;
var $mdgriffith$elm_ui$Internal$Model$NoNearbyChildren = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.gQ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aN);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.gQ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.hH);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.gQ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aA);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.gQ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fS);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.gQ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.f5);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.gQ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.iX);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.iK)) + ('-cols-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.ar)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.i_.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.i_.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.f5) + ('-' + ($elm$core$String$fromInt(pos.e0) + ('-' + ($elm$core$String$fromInt(pos.jB) + ('-' + $elm$core$String$fromInt(pos.hI)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.gc) + 'px'),
					$elm$core$Maybe$Just(
...
var $mdgriffith$elm_ui$Internal$Model$renderFocusStyle = function (focus) {
	return _List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.fd) + ':focus-within',
			A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				_List_fromArray(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.hL, $mdgriffith$elm_ui$Internal$Style$classes.bo)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.hL, $mdgriffith$elm_ui$Internal$Style$classes.bg)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.hC, $mdgriffith$elm_ui$Internal$Style$classes.bo)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.hC, $mdgriffith$elm_ui$Internal$Style$classes.bg)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gD, $mdgriffith$elm_ui$Internal$Style$classes.bo)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gD, $mdgriffith$elm_ui$Internal$Style$classes.bg)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gQ) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.f5) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gQ) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gQ) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.f5) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gQ) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cL) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Model$hasSmallCaps = function (typeface) {
	if (typeface.$ === 5) {
		var font = typeface.a;
		return A2($elm$core$List$any, $mdgriffith$elm_ui$Internal$Model$isSmallCaps, font.gq);
	} else {
		return false;
	}
};
	...
	if (typeface.$ === 5) {
		...
		return $elm$core$Maybe$Just(
			A2(
				$elm$core$String$join,
				', ',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$renderVariant, font.gq)));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 8:
				...
				var xSpacing = toGridLength(template.i_.a);
				var ySpacing = toGridLength(template.i_.b);
				var rows = function (x) {
					...
					A2(
						$elm$core$String$join,
						' ',
						A2($elm$core$List$map, toGridLength, template.iK)));
				...
				var msColumns = function (x) {
					...
					A2(
						...
						ySpacing,
						A2($elm$core$List$map, toGridLength, template.ar)));
				var gapY = 'grid-row-gap:' + (toGridLength(template.i_.b) + ';');
				var gapX = 'grid-column-gap:' + (toGridLength(template.i_.a) + ';');
			...
			case 9:
				...
				var msPosition = A2(
					...
					_List_fromArray(
						[
							'-ms-grid-row: ' + ($elm$core$String$fromInt(position.f5) + ';'),
							'-ms-grid-row-span: ' + ($elm$core$String$fromInt(position.hI) + ';'),
							'-ms-grid-column: ' + ($elm$core$String$fromInt(position.e0) + ';'),
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.f5) + (' / ' + ($elm$core$String$fromInt(position.f5 + position.hI) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.e0) + (' / ' + ($elm$core$String$fromInt(position.e0 + position.jB) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.f5) + ('-' + ($elm$core$String$fromInt(position.e0) + ('-' + ($elm$core$String$fromInt(position.jB) + ('-' + $elm$core$String$fromInt(position.hI)))))));
...
var $mdgriffith$elm_ui$Internal$Model$renderFontAdjustmentRule = F3(
	function (fontToAdjust, _v0, otherFontName) {
		...
		return A2(
			...
			' ',
			_Utils_ap(
				A3($mdgriffith$elm_ui$Internal$Model$fontRule, name, $mdgriffith$elm_ui$Internal$Style$classes.iY, capital),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.iY + (', ' + ('.' + (name + (' .' + $mdgriffith$elm_ui$Internal$Style$classes.iY))))))),
					_List_fromArray(
						[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.iY + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.dj + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.iY + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.dj)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {hI: height / size, gc: size, gr: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.g5, adjustment.gV, adjustment.ho, adjustment.h4]);
	var lineHeight = 1.5;
	...
	return {
		g5: A3($mdgriffith$elm_ui$Internal$Model$adjust, capitalSize, ascender - newBaseline, capitalVertical),
		fg: A3($mdgriffith$elm_ui$Internal$Model$adjust, fullSize, ascender - descender, fullVertical)
	};
};
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'line-height',
				$elm$core$String$fromFloat(converted.hI)),
				_Utils_Tuple2(
				'vertical-align',
				$elm$core$String$fromFloat(converted.gr) + 'em'),
				_Utils_Tuple2(
				'font-size',
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.gQ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.iX))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.gQ, $mdgriffith$elm_ui$Internal$Style$classes.iX, $mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.aO, $mdgriffith$elm_ui$Internal$Style$classes.gM])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.gQ, $mdgriffith$elm_ui$Internal$Style$classes.iX, $mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.aO, $mdgriffith$elm_ui$Internal$Style$classes.gK])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.gQ, $mdgriffith$elm_ui$Internal$Style$classes.iX, $mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.gL])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.gQ, $mdgriffith$elm_ui$Internal$Style$classes.iX, $mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.gJ])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.gQ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dj + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.eM + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dI)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.gQ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dj + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.eN + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dJ)))));
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.hM, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bI, $mdgriffith$elm_ui$Internal$Style$classes.iX, $mdgriffith$elm_ui$Internal$Style$classes.gC]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bI, $mdgriffith$elm_ui$Internal$Style$classes.iX, $mdgriffith$elm_ui$Internal$Style$classes.gX]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bI, $mdgriffith$elm_ui$Internal$Style$classes.iX, $mdgriffith$elm_ui$Internal$Style$classes.ip]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bI, $mdgriffith$elm_ui$Internal$Style$classes.iX, $mdgriffith$elm_ui$Internal$Style$classes.$9]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bI, $mdgriffith$elm_ui$Internal$Style$classes.iX, $mdgriffith$elm_ui$Internal$Style$classes.hQ]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bI, $mdgriffith$elm_ui$Internal$Style$classes.iX, $mdgriffith$elm_ui$Internal$Style$classes.gW]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.hM, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, $mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.dp + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eT);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.dp + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eU);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.dp + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.gH);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.dq + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.gN);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.dq + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.gG);
		default:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.gQ + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.aN + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Internal$Model$renderWidth = function (w) {
	switch (w.$) {
		case 0:
			...
			return _Utils_Tuple3(
				$mdgriffith$elm_ui$Internal$Flag$none,
				$mdgriffith$elm_ui$Internal$Style$classes.gv + (' width-px-' + $elm$core$String$fromInt(px)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_Nil) : _Utils_Tuple3(
				A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$widthFill, $mdgriffith$elm_ui$Internal$Flag$none),
				$mdgriffith$elm_ui$Internal$Style$classes.gw + (' width-fill-' + $elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.gQ + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.f5 + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
					...
					case 7:
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$width, has)) {
							...
							switch (width.$) {
								case 0:
									var px = width.a;
									var $temp$classes = ($mdgriffith$elm_ui$Internal$Style$classes.gv + (' width-px-' + $elm$core$String$fromInt(px))) + (' ' + classes),
										$temp$node = node,
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.gw + (' width-fill-' + $elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
											$mdgriffith$elm_ui$Internal$Flag$widthFill,
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.hf + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b1)),
				A2(
					$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$Font$bold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.gZ);
...
var $mdgriffith$elm_ui$Element$pointer = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$cursor, $mdgriffith$elm_ui$Internal$Style$classes.hi);
...
var $mdgriffith$elm_ui$Element$clip = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.ha);
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {g2: -box.g2, h2: -box.h2, iI: -box.iI, jw: -box.jw};
};
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.fJ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.iz)),
...
var $mdgriffith$elm_ui$Element$scrollbarY = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.iR);
...
var $mdgriffith$elm_ui$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
		...
		var redistributed = A3(
			...
			$mdgriffith$elm_ui$Element$Input$isStacked(textOptions.h1),
			withDefaults);
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Input$hiddenLabelAttribute(textOptions.h1),
					...
					_Utils_ap(
						(heightConstrained ? $elm$core$List$cons($mdgriffith$elm_ui$Element$scrollbarY) : $elm$core$Basics$identity)(
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
									A2($elm$core$List$any, $mdgriffith$elm_ui$Element$Input$hasFocusStyle, withDefaults) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.fd),
										...
										if (_v2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.Q, textOptions.dj === ''))
												]);
										}
									}()
									])))),
		...
		return A3(
			...
			A2(
				$elm$core$List$cons,
				A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$cursor, $mdgriffith$elm_ui$Internal$Style$classes.hj),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$Input$isHiddenLabel(textOptions.h1) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : $mdgriffith$elm_ui$Element$spacing(5),
										...
										[
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
																	_Utils_eq(user.hN, assignment.go.hN) ? $mdgriffith$elm_ui$Element$Events$onClick(
																	$author$project$Pages$Dashboard$FocusAssignmentTitle(assignment.jo)) : $mdgriffith$elm_ui$Element$pointer,
																	$mdgriffith$elm_ui$Element$pointer
																]),
															model.bt ? A2(
																...
																_List_fromArray(
																	[
																		...
																		$author$project$Pages$Dashboard$ChangeAssignmentTitle(assignment.hN),
																		$author$project$Pages$Dashboard$UnfocusAssignmentTitle)
																	]),
																{
																	h1: $mdgriffith$elm_ui$Element$Input$labelHidden('edit assignment title'),
																	c9: $author$project$Pages$Dashboard$ChangeAssignmentTitleTfText,
																...
																$mdgriffith$elm_ui$Element$text(assignment.jo)))
														])),
													A2(
													$mdgriffith$elm_ui$Element$el,
													_List_fromArray(
											...
											$mdgriffith$elm_ui$Element$text(
												'Course: ' + A2(
													$elm$core$Maybe$withDefault,
													'undefined',
													A2($author$project$Pages$Dashboard$getCourseNameById, courses, assignment.hh)))),
											A2(
											$mdgriffith$elm_ui$Element$row,
											_List_fromArray(
												[
											...
											_List_fromArray(
												[
													_Utils_eq(user.hN, assignment.go.hN) ? A3(
													$author$project$Pages$Dashboard$viewButton,
													'[delete]',
													$author$project$Styling$Colors$redColor,
													$author$project$Pages$Dashboard$RemoveAssignment(assignment.hN)) : $mdgriffith$elm_ui$Element$none
												]))
										]);
								case 1:
									return _List_fromArray(
...
var $gampleman$elm_visualization$Shape$defaultPieConfig = {dy: 0, dF: 2 * $elm$core$Basics$pi, hU: 0, fO: 100, ea: 0, eb: 0, ge: $elm$core$Basics$compare, cp: 0, gp: $elm$core$Basics$identity};
...
var $gampleman$elm_visualization$Shape$Pie$pie = F2(
	function (settings, data) {
		...
		var da = A2(
			...
			A2($elm$core$Basics$max, (-2) * $elm$core$Basics$pi, settings.dF - settings.cp));
		var p = A2(
			$elm$core$Basics$min,
		...
		var computeValue = F2(
			function (el, angle) {
				var value = settings.gp(el);
				return {
					dy: settings.dy,
					dF: (angle + ((value > 0) ? (value * k) : 0)) + pa,
					hU: settings.hU,
					fO: settings.fO,
					ea: p,
					eb: settings.eb,
...
var $gampleman$elm_visualization$Shape$Pie$centroid = function (arcData) {
	var r = (arcData.hU + arcData.fO) / 2;
	var a = ((arcData.cp + arcData.dF) / 2) - ($elm$core$Basics$pi / 2);
	return _Utils_Tuple2(
...
var $author$project$Components$PieChart$pieLabel = F2(
	function (slice, _v0) {
		...
		var _v1 = $gampleman$elm_visualization$Shape$centroid(
			_Utils_update(
				slice,
				{hU: $author$project$Components$PieChart$radius - 40, fO: $author$project$Components$PieChart$radius - 40}));
		var x = _v1.a;
		var y = _v1.b;
		return A2(
...
var $folkertdev$one_true_path_experiment$SubPath$with = F2(
	function (moveto, drawtos) {
		return $folkertdev$one_true_path_experiment$SubPath$SubPath(
			{
				e5: $folkertdev$elm_deque$Deque$fromList(drawtos),
				fI: moveto
			});
	});
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									{
									ds: $folkertdev$one_true_path_experiment$LowLevel$Command$largestArc,
									dC: cw,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									{
									ds: $gampleman$elm_visualization$Shape$Pie$boolToArc(
...
var $folkertdev$one_true_path_experiment$SubPath$close = function (subpath) {
	if (subpath.$ === 1) {
		...
		var moveto = subpath.a.fI;
		var drawtos = subpath.a.e5;
		...
		if ((!_v1.a.$) && (_v1.a.a.$ === 4)) {
			...
			return $folkertdev$one_true_path_experiment$SubPath$SubPath(
				{
					e5: A2($folkertdev$elm_deque$Deque$pushBack, $folkertdev$one_true_path_experiment$LowLevel$Command$closePath, drawtos),
					fI: moveto
				});
		}
	}
...
var $folkertdev$one_true_path_experiment$SubPath$pushBack = F2(
	function (drawto, data) {
		return _Utils_update(
			data,
			{
				e5: A2($folkertdev$elm_deque$Deque$pushBack, drawto, data.e5)
			});
	});
...
var $folkertdev$one_true_path_experiment$SubPath$unsafeConcatenate = F2(
	function (a, b) {
		return _Utils_update(
			a,
			{
				e5: A2($folkertdev$elm_deque$Deque$append, a.e5, b.e5)
			});
	});
...
var $folkertdev$one_true_path_experiment$SubPath$finalCursorState = function (_v0) {
	...
	var _v1 = moveto;
	var start = _v1;
	var initial = {l: start, x: $elm$core$Maybe$Nothing, eA: start};
...
var $gampleman$elm_visualization$Shape$Pie$arc = function (arcData) {
	var a1 = arcData.dF - ($elm$core$Basics$pi / 2);
	var a0 = arcData.cp - ($elm$core$Basics$pi / 2);
	var cw = _Utils_cmp(a1, a0) > 0;
	var da = $elm$core$Basics$abs(a1 - a0);
	var _v0 = (_Utils_cmp(arcData.hU, arcData.fO) > 0) ? _Utils_Tuple2(arcData.fO, arcData.hU) : _Utils_Tuple2(arcData.hU, arcData.fO);
	var r0 = _v0.a;
	var r1 = _v0.b;
	var path = function () {
		if (_Utils_cmp(r1, $gampleman$elm_visualization$Shape$Pie$epsilon) < 1) {
			...
			if (_Utils_cmp(da, (2 * $elm$core$Basics$pi) - $gampleman$elm_visualization$Shape$Pie$epsilon) > 0) {
				...
				var rc = A2(
					...
					arcData.dy);
				var ap = arcData.ea / 2;
				var rp = (_Utils_cmp(ap, $gampleman$elm_visualization$Shape$Pie$epsilon) > 0) ? ((arcData.eb > 0) ? arcData.eb : $elm$core$Basics$sqrt(
...
var $avh4$elm_color$Color$fromRgba = function (components) {
	return A4($avh4$elm_color$Color$RgbaSpace, components.iD, components.hG, components.gY, components.bs);
};
	...
	if (subpath.$ === 1) {
		...
		return $folkertdev$one_true_path_experiment$SubPath$SubPath(
			_Utils_update(
				data,
				{
					e5: $folkertdev$one_true_path_experiment$SubPath$compressHelper(data.e5)
				}));
	}
};
var $folkertdev$svg_path_lowlevel$Path$LowLevel$DecimalPlaces = $elm$core$Basics$identity;
var $folkertdev$svg_path_lowlevel$Path$LowLevel$decimalPlaces = $elm$core$Basics$identity;
var $folkertdev$one_true_path_experiment$SubPath$defaultConfig = {cU: $elm$core$Maybe$Nothing, c5: false};
		...
		return $elm$core$Maybe$Just(
			{
				...
				fI: $folkertdev$one_true_path_experiment$LowLevel$Command$toLowLevelMoveTo(moveto)
			});
	}
};
		...
		return A2(
			...
			A2(
				...
				$folkertdev$one_true_path_experiment$SubPath$toLowLevel(
					(config.c5 ? $folkertdev$one_true_path_experiment$SubPath$compress : $elm$core$Basics$identity)(subpath))));
	});
...
var $author$project$Components$PieChart$view = function (model) {
	var pieData = A2(
		...
		_Utils_update(
			...
			{fO: $author$project$Components$PieChart$radius}),
		A2(
			$elm$core$List$map,
			$elm$core$Basics$toFloat,
...
var $author$project$Components$PieChart$mainn = function (users) {
	return $author$project$Components$PieChart$view(users);
};
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cO + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aO + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.iT + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fJ)))))),
						A2(
							$elm$core$List$cons,
							$mdgriffith$elm_ui$Element$pointer,
							A2(
...
var $mdgriffith$elm_ui$Element$Border$dotted = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$borderStyle, $mdgriffith$elm_ui$Internal$Style$classes.g0);
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					{cG: 10, cH: 10, dm: 0, dn: 0}) : $mdgriffith$elm_ui$Element$Border$rounded(0),
			...
			_List_fromArray(
				[
					...
					A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text(course.ia)
							])))
				]));
	});
var $author$project$Pages$Dashboard$courseToKeyValue = F2(
	function (last, course) {
		return _Utils_Tuple2(
			$elm$core$String$fromInt(course.hN),
			A2(
				$author$project$Pages$Dashboard$viewSearchDropdownElement,
				course,
				_Utils_eq(course.hN, last.hN)));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Pages$Dashboard$viewCreateAssignmentFormStatus(model.cQ),
				A2(
				function () {
					var _v0 = model.hp.g9;
					if (!_v0) {
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
									...
									]),
								{
									...
									c9: $author$project$Pages$Dashboard$SearchCourses,
								...
								[$mdgriffith$elm_ui$Element$alignTop])),
						{
							...
							c9: $author$project$Pages$Dashboard$CAFChangeTitle,
							de: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
				...
				_List_fromArray(
					[
								...
								])),
						{
							...
							c9: $author$project$Pages$Dashboard$CAFChangeDate,
							de: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
					...
					]),
				{
					h1: A2(
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
						$mdgriffith$elm_ui$Element$text('Submit')),
					fM: $elm$core$Maybe$Just($author$project$Pages$Dashboard$CreateAssignment)
				})
			]));
};
	...
	function (unit, n, _v0) {
		...
		switch (unit) {
			...
			case 1:
				...
				var wholeMonths = ((12 * (date.gA - 1)) + ($justinmimbs$date$Date$monthToNumber(date.fG) - 1)) + n;
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$List$cons,
								$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cO + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aO + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fB)))),
								attrs))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
	...
	function (today, courses) {
		...
		return A2(
				...
				return _Utils_update(
					course,
					{
						gS: A2(
							$elm$core$List$filter,
							function (a) {
								return _Utils_eq(a.hh, course.hN);
							},
							validAssignments)
					});
			},
			A2(
				$elm$core$List$filter,
				function (course) {
					return A2($elm$core$List$member, course.hN, validCourseIds);
				},
				courses));
	});
var $mdgriffith$elm_ui$Element$Border$solid = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$borderStyle, $mdgriffith$elm_ui$Internal$Style$classes.g1);
var $author$project$Pages$Dashboard$ViewAssignmentModal = function (a) {
	return {$: 13, a: a};
};
var $mdgriffith$elm_ui$Internal$Model$Right = 2;
var $mdgriffith$elm_ui$Element$alignRight = $mdgriffith$elm_ui$Internal$Model$AlignX(2);
var $mdgriffith$elm_ui$Element$Font$italic = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.h$);
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$pointer,
					$mdgriffith$elm_ui$Element$Events$onClick(
					$author$project$Pages$Dashboard$ViewAssignmentModal(assignment.hN))
				]),
			_List_fromArray(
				[
					A2(
					...
					A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text(
								_Utils_ap(
									displayDate ? ($author$project$Pages$Dashboard$toGermanDateString(assignment.hr) + ': ') : '',
									assignment.jo))
							]))),
					A2(
					$mdgriffith$elm_ui$Element$el,
					...
					$mdgriffith$elm_ui$Element$text(assignment.go.eK))
				]));
	});
		...
		var assignments = function () {
			if (!maybeDate.$) {
				...
				return A2(
					$elm$core$List$filter,
					function (assignment) {
						return _Utils_eq(assignment.hr, date);
					},
					course.gS);
			} else {
				return course.gS;
		...
		var validCourses = A2(
			...
			A2(
				...
				A2(
					$elm$core$List$map,
					function (course) {
						return _Utils_Tuple2(course.hN, course.gS);
					},
					courses)));
		return A2(
			$elm$core$List$filter,
			function (course) {
				return A2($elm$core$List$member, course.hN, validCourses);
			},
			courses);
	});
		...
		_List_fromArray(
			[
				...
				function () {
					...
					if (!_v1.$) {
						var user = _v1.a;
						return (user.h9 !== '') ? _List_fromArray(
							[
...
var $mdgriffith$elm_ui$Element$Font$semiBold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.jk);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				($elm$core$String$length(user.eK) > 12) ? $mdgriffith$elm_ui$Element$text(
					'Hey, ' + (A3($elm$core$String$slice, 0, 12, user.eK) + '...')) : $mdgriffith$elm_ui$Element$text('Hey, ' + user.eK)),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				function () {
...
var $author$project$Components$Sidebar$viewSidebar = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Components$Sidebar$viewUser(model.go),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				A2($author$project$Components$Sidebar$viewLinks, links, model.gD))
			]));
};
				...
				return _Utils_Tuple2(
					...
					$elm$core$List$length(
						A2(
							...
							function (a) {
								return _Utils_eq(
									$author$project$Components$LineChart$dateToPosixTime(a.hr),
									x.a);
							},
							assignments)));
			},
...
var $gampleman$elm_visualization$Scale$convert = F2(
	function (_v0, value) {
		var scale = _v0;
		return A3(scale.P, scale.dD, scale.D, value);
	});
var $gampleman$elm_visualization$Scale$rangeExtent = function (_v0) {
	var options = _v0;
	return A2(options.bL, options.dD, options.D);
};
...
var $ryannhg$date_format$DateFormat$Language$Language = F6(
	function (toMonthName, toMonthAbbreviation, toWeekdayName, toWeekdayAbbreviation, toAmPm, toOrdinalSuffix) {
		return {jp: toAmPm, jq: toMonthAbbreviation, jr: toMonthName, bT: toOrdinalSuffix, ju: toWeekdayAbbreviation, jv: toWeekdayName};
	});
...
var $gampleman$elm_visualization$Scale$time = F3(
	function (zone, range_, domain_) {
		return {
			...
			dD: domain_,
			c_: $gampleman$elm_visualization$Scale$Time$invert,
			ci: $gampleman$elm_visualization$Scale$Time$nice(zone),
			D: range_,
			bL: $gampleman$elm_visualization$Scale$Time$rangeExtent,
			eE: $gampleman$elm_visualization$Scale$Time$tickFormat(zone),
			eF: $gampleman$elm_visualization$Scale$Time$ticks(zone)
		};
	});
...
var $gampleman$elm_visualization$Scale$linear = F2(
	function (range_, domain_) {
		return {P: $gampleman$elm_visualization$Scale$Linear$convert, dD: domain_, c_: $gampleman$elm_visualization$Scale$Linear$invert, ci: $gampleman$elm_visualization$Scale$Linear$nice, D: range_, bL: $gampleman$elm_visualization$Scale$Linear$rangeExtent, eE: $gampleman$elm_visualization$Scale$Linear$tickFormat, eF: $gampleman$elm_visualization$Scale$Linear$ticks};
	});
...
var $gampleman$elm_visualization$Scale$tickFormat = function (_v0) {
	var opts = _v0;
	return opts.eE(opts.dD);
};
var $gampleman$elm_visualization$Scale$ticks = F2(
	function (_v0, count) {
		var scale = _v0;
		return A2(scale.eF, scale.dD, count);
	});
var $gampleman$elm_visualization$Axis$computeOptions = F2(
	function (attrs, scale) {
		...
		return A3(
			...
			{
				bR: opts.bR,
				eE: A2($gampleman$elm_visualization$Scale$tickFormat, scale, opts.bR),
				cr: opts.cr,
				bS: opts.bS,
				a$: opts.a$,
				eF: A2($gampleman$elm_visualization$Scale$ticks, scale, opts.bR)
			},
			postList);
	});
...
var $gampleman$elm_visualization$Axis$element = F4(
	function (_v0, k, displacement, textAnchorPosition) {
		...
		var y1 = _v0.jH;
		var y2 = _v0.jI;
		var translate = _v0.eH;
		var horizontal = _v0.dK;
		return F2(
			function (attrs, scale) {
				...
				return A2(
					...
					A2(
						...
						A2(
							...
							_List_Nil),
						A2($elm$core$List$map, drawTick, opts.eF)));
			});
	});
...
var $gampleman$elm_visualization$Axis$verticalAttrs = {
	...
	gx: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$y, $elm$core$String$fromFloat),
	jD: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$y1, $elm$core$String$fromFloat),
	jE: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$y2, $elm$core$String$fromFloat),
...
var $gampleman$elm_visualization$Axis$horizontalAttrs = {
	...
	gx: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$x, $elm$core$String$fromFloat),
	jD: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$x1, $elm$core$String$fromFloat),
	jE: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$x2, $elm$core$String$fromFloat),
	...
	function (attrs, children) {
		...
		if (spaced.$ === 1) {
			return A4(
				...
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.b1 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aO + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eO)))),
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
						A2(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							{
								gD: $elm$core$Maybe$Just('dashboard'),
								hp: model.hp,
								go: model.go
							}),
							A2(
...
var $author$project$Pages$Dashboard$page = $author$project$Spa$Page$application(
	{hT: $author$project$Pages$Dashboard$init, h3: $author$project$Pages$Dashboard$load, iL: $author$project$Pages$Dashboard$save, i5: $author$project$Pages$Dashboard$subscriptions, jy: $author$project$Pages$Dashboard$update, jz: $author$project$Pages$Dashboard$view});
...
var $author$project$Pages$Dashboard$Admin$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{b3: $author$project$Api$Loading, hp: shared.hp, bp: url, go: shared.go},
					...
					_List_fromArray(
						[
							...
							function () {
								...
								if (!_v2.$) {
									var user = _v2.a;
									return (user.fX === 1) ? _List_fromArray(
										[
											A2(
											$mdgriffith$elm_ui$Element$column,
											_List_Nil,
...
var $author$project$Pages$Dashboard$Admin$page = $author$project$Spa$Page$application(
	{hT: $author$project$Pages$Dashboard$Admin$init, h3: $author$project$Pages$Dashboard$Admin$load, iL: $author$project$Pages$Dashboard$Admin$save, i5: $author$project$Pages$Dashboard$Admin$subscriptions, jy: $author$project$Pages$Dashboard$Admin$update, jz: $author$project$Pages$Dashboard$Admin$view});
var $author$project$Pages$Dashboard$Moodle$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{bZ: $author$project$Api$NotAsked, y: $author$project$Api$NotAsked, hp: shared.hp, aS: '', aT: $author$project$Api$NotAsked, ch: '', aU: '', bp: url, go: shared.go},
			$elm$core$Platform$Cmd$none);
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{gO: false, a6: r.a6, bb: r.bb, be: r.be, bf: r.bf, bk: r.bk, bn: r.bn, bp: r.bp}));
};
		...
		return $elm$http$Http$post(
			{
				...
				bb: A2($author$project$Api$expectJson, options.d8, $author$project$Api$Moodle$Moodle$decoder),
			...
			case 0:
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						{d8: $author$project$Pages$Dashboard$Moodle$GotSiteData}));
			case 1:
				var data = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
		...
		return A3(
			$mdgriffith$elm_ui$Element$Input$textHelper,
			{
				...
				E: $mdgriffith$elm_ui$Element$Input$TextInputNode(
					pass.iW ? 'text' : 'password')
			},
			attrs,
			{h1: pass.h1, c9: pass.c9, de: pass.de, dj: pass.dj});
	});
						...
						return _List_fromArray(
							[
										...
										])),
								{
									...
									c9: $author$project$Pages$Dashboard$Moodle$ChangeMoodleUsernameInput,
									de: $elm$core$Maybe$Just(
										A2(
											$mdgriffith$elm_ui$Element$Input$placeholder,
											_List_Nil,
										...
										])),
								{
									...
									c9: $author$project$Pages$Dashboard$Moodle$ChangeMoodlePasswordInput,
									de: $elm$core$Maybe$Just(
										A2(
											$mdgriffith$elm_ui$Element$Input$placeholder,
											_List_Nil,
											...
											]))),
								{
									...
									fM: ($elm$core$String$isEmpty(model.aU) || $elm$core$String$isEmpty(model.aS)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just($author$project$Pages$Dashboard$Moodle$Authenticate)
								})
							]);
					} else {
						return _List_fromArray(
							[
								...
								$author$project$Pages$Dashboard$Moodle$inputStyle,
								{
									...
									c9: $author$project$Pages$Dashboard$Moodle$ChangeMoodleUrlInput,
									de: $elm$core$Maybe$Just(
										A2(
											$mdgriffith$elm_ui$Element$Input$placeholder,
											_List_Nil,
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Components$Sidebar$viewSidebar(
							{
								gD: $elm$core$Maybe$Just('moodle integration'),
								hp: model.hp,
								go: model.go
							}),
							A2(
...
var $author$project$Pages$Dashboard$Moodle$page = $author$project$Spa$Page$application(
	{hT: $author$project$Pages$Dashboard$Moodle$init, h3: $author$project$Pages$Dashboard$Moodle$load, iL: $author$project$Pages$Dashboard$Moodle$save, i5: $author$project$Pages$Dashboard$Moodle$subscriptions, jy: $author$project$Pages$Dashboard$Moodle$update, jz: $author$project$Pages$Dashboard$Moodle$view});
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'username',
					$elm$json$Json$Encode$string(credentials.eK)),
					_Utils_Tuple2(
					'password',
					$elm$json$Json$Encode$string(credentials.ek))
				]));
				...
				if (data.$ === 3) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{bB: data}),
						A2($author$project$Utils$Route$navigate, model.bp.h0, 1));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			default:
				return _Utils_Tuple2(
					...
					A2(
						...
						{e7: $elm$core$Maybe$Nothing, ek: model.cm, eK: model.cy},
						{d8: $author$project$Pages$Login$GotLoginData}));
		}
	});
								...
								[
									...
									_List_fromArray(
										[
											...
											{
												h1: $mdgriffith$elm_ui$Element$Input$labelHidden('username'),
												c9: $author$project$Pages$Login$UsernameInput,
												de: $elm$core$Maybe$Just(
													A2(
														$mdgriffith$elm_ui$Element$Input$placeholder,
														_List_Nil,
									...
									_List_fromArray(
										[
											...
											{
												h1: $mdgriffith$elm_ui$Element$Input$labelHidden('password'),
												c9: $author$project$Pages$Login$PasswordInput,
												de: $elm$core$Maybe$Just(
													A2(
														$mdgriffith$elm_ui$Element$Input$placeholder,
														_List_Nil,
									...
									{
										h1: $author$project$Pages$Login$viewLoginButton(model),
										fM: $elm$core$Maybe$Just($author$project$Pages$Login$Login)
									})
								])))
					]))
			]),
...
var $author$project$Pages$Login$page = $author$project$Spa$Page$application(
	{hT: $author$project$Pages$Login$init, h3: $author$project$Pages$Login$load, iL: $author$project$Pages$Login$save, i5: $author$project$Pages$Login$subscriptions, jy: $author$project$Pages$Login$update, jz: $author$project$Pages$Login$view});
...
var $author$project$Pages$Register$init = F2(
	function (_v0, url) {
		return _Utils_Tuple2(
			{
				cb: '',
				d: {e7: $elm$core$Maybe$Nothing, ek: $elm$core$Maybe$Nothing, eK: $elm$core$Maybe$Nothing},
				cm: '',
...
var $author$project$Api$Homework$UsernameTaken$usernameTaken = F2(
	function (username, options) {
		return $elm$http$Http$get(
			{
				bb: A2($author$project$Api$expectJson, options.d8, $elm$json$Json$Decode$bool),
			...
			case 0:
				...
				return ($elm$core$String$length(input) > 0) ? _Utils_Tuple2(
					...
					A2(
						...
						input,
						{d8: $author$project$Pages$Register$GotUsernameTaken})) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							d: A2(
			...
			default:
				return $author$project$Pages$Register$areErrorsEmpty(model.d) ? _Utils_Tuple2(
					...
					A2(
						...
						{
							e7: $elm$core$Maybe$Just(model.cb),
							ek: model.cm,
							eK: model.cy
						},
						{d8: $author$project$Pages$Register$GotRegistrationData})) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Pages$Register$viewInputError = F2(
	function (model, inputName) {
		return (inputName === 'email') ? $author$project$Pages$Register$inputErrorMessage(model.d.e7) : ((inputName === 'username') ? $author$project$Pages$Register$inputErrorMessage(model.d.eK) : ((inputName === 'password') ? $author$project$Pages$Register$inputErrorMessage(model.d.ek) : $mdgriffith$elm_ui$Element$none));
	});
								...
								[
										...
										[
											...
											_List_fromArray(
												[
													...
													{
														h1: $mdgriffith$elm_ui$Element$Input$labelHidden('email'),
														c9: $author$project$Pages$Register$EmailInput,
														de: $elm$core$Maybe$Just(
															A2(
																$mdgriffith$elm_ui$Element$Input$placeholder,
																_List_Nil,
											...
											_List_fromArray(
												[
													...
													{
														h1: $mdgriffith$elm_ui$Element$Input$labelHidden('username'),
														c9: $author$project$Pages$Register$UsernameInput,
														de: $elm$core$Maybe$Just(
															A2(
																$mdgriffith$elm_ui$Element$Input$placeholder,
																_List_Nil,
									...
									_List_fromArray(
										[
											...
											{
												h1: $mdgriffith$elm_ui$Element$Input$labelHidden('password'),
												c9: $author$project$Pages$Register$PasswordInput,
												de: $elm$core$Maybe$Just(
													A2(
														$mdgriffith$elm_ui$Element$Input$placeholder,
														_List_Nil,
									...
									{
										h1: $mdgriffith$elm_ui$Element$Input$labelHidden('validate password'),
										c9: $author$project$Pages$Register$ValidatePasswordInput,
										de: $elm$core$Maybe$Just(
											A2(
												$mdgriffith$elm_ui$Element$Input$placeholder,
												_List_Nil,
									...
									{
										h1: $author$project$Pages$Register$viewRegistrationButton(model),
										fM: $elm$core$Maybe$Just($author$project$Pages$Register$Register)
									})
								])))
					]))
			]),
...
var $author$project$Pages$Register$page = $author$project$Spa$Page$application(
	{hT: $author$project$Pages$Register$init, h3: $author$project$Pages$Register$load, iL: $author$project$Pages$Register$save, i5: $author$project$Pages$Register$subscriptions, jy: $author$project$Pages$Register$update, jz: $author$project$Pages$Register$view});
var $mdgriffith$elm_ui$Element$Font$underline = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.jx);
	...
	function (params, key, url) {
		return {
			...
			em: A2(
				$elm$core$Maybe$withDefault,
				$elm$core$Dict$empty,
				A2($elm$core$Maybe$map, $author$project$Spa$Url$toQueryDict, url.em)),
			f0: url
		};
	});
...
var $author$project$Spa$Generated$Pages$upgrade = F3(
	function (toModel, toMsg, page) {
			...
			function (params, shared) {
				return A3(
					...
					A2(
						page.hT,
						shared,
						A3($author$project$Spa$Url$create, params, shared.h0, shared.bp)));
			});
		...
		return {aq: bundle_, hT: init_, jy: update_};
	});
var $author$project$Spa$Generated$Pages$pages = {
	cR: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Dashboard__Model, $author$project$Spa$Generated$Pages$Dashboard__Msg, $author$project$Pages$Dashboard$page),
	cS: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Dashboard__Admin__Model, $author$project$Spa$Generated$Pages$Dashboard__Admin__Msg, $author$project$Pages$Dashboard$Admin$page),
	cT: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Dashboard__Moodle__Model, $author$project$Spa$Generated$Pages$Dashboard__Moodle__Msg, $author$project$Pages$Dashboard$Moodle$page),
	c3: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Login__Model, $author$project$Spa$Generated$Pages$Login__Msg, $author$project$Pages$Login$page),
	c7: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$NotFound__Model, $author$project$Spa$Generated$Pages$NotFound__Msg, $author$project$Pages$NotFound$page),
	df: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Register__Model, $author$project$Spa$Generated$Pages$Register__Msg, $author$project$Pages$Register$page),
	jw: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Top__Model, $author$project$Spa$Generated$Pages$Top__Msg, $author$project$Pages$Top$page)
};
var $author$project$Spa$Generated$Pages$init = function (route) {
	switch (route) {
		case 0:
			return $author$project$Spa$Generated$Pages$pages.jw.hT(0);
		case 1:
			return $author$project$Spa$Generated$Pages$pages.cR.hT(0);
		case 2:
			return $author$project$Spa$Generated$Pages$pages.c3.hT(0);
		case 3:
			return $author$project$Spa$Generated$Pages$pages.c7.hT(0);
		case 4:
			return $author$project$Spa$Generated$Pages$pages.df.hT(0);
		case 5:
			return $author$project$Spa$Generated$Pages$pages.cS.hT(0);
		default:
			return $author$project$Spa$Generated$Pages$pages.cT.hT(0);
	}
};
...
var $elm$browser$Browser$Events$onSelfMsg = F3(
	function (router, _v0, state) {
		...
		var messages = A2($elm$core$List$filterMap, toMessage, state.gj);
		return A2(
			$elm$core$Task$andThen,
			function (_v1) {
				return $elm$core$Task$succeed(state);
...
var $author$project$Spa$Generated$Pages$bundle = function (bigModel) {
	switch (bigModel.$) {
		case 0:
			...
			return $author$project$Spa$Generated$Pages$pages.jw.aq(model);
		case 1:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.cR.aq(model);
		case 2:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.c3.aq(model);
		case 3:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.c7.aq(model);
		case 4:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.df.aq(model);
		case 5:
			var model = bigModel.a;
...
var $author$project$Spa$Generated$Pages$subscriptions = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).i5(0);
};
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				case 0:
					...
					if (_v4.$ === 1) {
						return _Utils_update(
							record,
							{
								hL: $elm$core$Maybe$Just(hoverable)
							});
					} else {
						return record;
					}
				...
				default:
					...
					if (_v6.$ === 1) {
						return _Utils_update(
							record,
							{
								h8: $elm$core$Maybe$Just(renderMode)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{hC: $elm$core$Maybe$Nothing, hL: $elm$core$Maybe$Nothing, h8: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.iJ, $mdgriffith$elm_ui$Internal$Style$classes.gQ, $mdgriffith$elm_ui$Internal$Style$classes.iX]))),
...
var $author$project$Spa$Generated$Pages$load = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).h3(0);
};
var $author$project$Spa$Generated$Pages$save = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).iL(0);
};
...
var $author$project$Api$Homework$User$logout = function (options) {
	return $elm$http$Http$riskyRequest(
		{
			a6: $elm$http$Http$emptyBody,
			bb: $elm$http$Http$expectWhatever(options.d8),
			be: _List_Nil,
			bf: 'POST',
			bk: $elm$core$Maybe$Nothing,
			bn: $elm$core$Maybe$Nothing,
			...
			case 1:
				return _Utils_Tuple2(
					...
					$author$project$Api$Homework$User$logout(
						{d8: $author$project$Shared$GotLogoutData}));
			case 2:
				var w = msg.a;
				var h = msg.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							hp: $author$project$Shared$classifyDevice(
								{hI: h, jB: w})
						}),
					$elm$core$Platform$Cmd$none);
			default:
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.jw.jy, msg, model);
					} else {
						break _v0$7;
					}
				case 1:
					if (_v0.b.$ === 1) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.cR.jy, msg, model);
					} else {
						break _v0$7;
					}
				case 2:
					if (_v0.b.$ === 2) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.c3.jy, msg, model);
					} else {
						break _v0$7;
					}
				case 3:
					if (_v0.b.$ === 3) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.c7.jy, msg, model);
					} else {
						break _v0$7;
					}
				case 4:
					if (_v0.b.$ === 4) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.df.jy, msg, model);
					} else {
						break _v0$7;
					}
				case 5:
					if (_v0.b.$ === 5) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.cS.jy, msg, model);
					} else {
						break _v0$7;
					}
				default:
					if (_v0.b.$ === 6) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.cT.jy, msg, model);
					} else {
						break _v0$7;
					}
			}
						...
						[
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$Events$onClick(
									options.js($author$project$Shared$Logout))
								]),
							A2(
								$author$project$Shared$navBarElement,
...
var $author$project$Main$view = function (model) {
	return A2(
		$author$project$Shared$view,
		{
			...
			js: $author$project$Main$Shared
		},
		model.am);
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		hT: $author$project$Main$init,
		iq: $author$project$Main$UrlChanged,
		ir: $author$project$Main$LinkClicked,
		i5: $author$project$Main$subscriptions,
		jy: $author$project$Main$update,
