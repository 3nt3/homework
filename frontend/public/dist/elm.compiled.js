		...
		return $mdgriffith$elm_ui$Element$htmlAttribute(
			A2(
				...
				A2(
					$elm$json$Json$Decode$andThen,
					function (key) {
						var _v0 = A2($elm$core$Debug$log, 'key', key);
	...
	if (_v0.$ === 'Just') {
		return A2(
			...
			A2(
				...
				function () {
					var _v1 = model.assignmentModalData;
					switch (_v1.$) {
						case 'Success':
							...
							return _List_fromArray(
								[
										...
										[
											...
											_List_fromArray(
												[
													...
													$author$project$Pages$Dashboard$FocusAssignmentTitle(assignment.title)),
													$mdgriffith$elm_ui$Element$pointer
												]),
									...
									_List_Nil,
									$mdgriffith$elm_ui$Element$text(
										'Course: ' + $elm$core$String$fromInt(assignment.courseId))),
									A2(
									$mdgriffith$elm_ui$Element$row,
									_List_fromArray(
										[
