...
{
	if (region.eB.cg === region.e9.cg)
	{
		return 'on line ' + region.eB.cg;
	}
	return 'on lines ' + region.eB.cg + ' through ' + region.e9.cg;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { hM: 'hidden', g9: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { hM: 'mozHidden', g9: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { hM: 'msHidden', g9: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { hM: 'webkitHidden', g9: 'webkitvisibilitychange' }
		: { hM: 'hidden', g9: 'visibilitychange' };
}
...
function _Http_configureRequest(xhr, request)
{
	...
	xhr.withCredentials = request.gQ;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {fg: fragment, fm: host, fW: path, fY: port_, f1: protocol, en: query};
	});
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {bc: frag, iA: params, a3: unvisited, aG: value, bq: visited};
	});
		...
		return $elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					...
					_List_Nil,
					$elm$url$Url$Parser$preparePath(url.fW),
...
var $author$project$Shared$Model = F5(
	function (url, key, user, device, overrideLoggedInRedirect) {
		return {hr: device, h2: key, fR: overrideLoggedInRedirect, bp: url, gq: user};
	});
var $author$project$Shared$Desktop = 2;
var $author$project$Shared$Device = F4(
	function (_class, orientation, width, height) {
		return {hb: _class, hK: height, ix: orientation, jD: width};
	});
...
var $author$project$Shared$classifyDevice = function (options) {
	return (options.jD < 900) ? A4($author$project$Shared$Device, 0, 0, options.jD, options.hK) : ((options.jD < 1400) ? A4($author$project$Shared$Device, 1, 0, options.jD, options.hK) : A4($author$project$Shared$Device, 2, 1, options.jD, options.hK));
};
				...
				switch (response.$) {
					...
					case 3:
						...
						if (!_v1.$) {
							var value = _v1.a;
							return $elm$core$Result$Err(
								A2($author$project$Api$BadStatus, metadata.eC, value));
						} else {
							var err = _v1.a;
							return $elm$core$Result$Err(
								A2(
...
var $elm$http$Http$riskyRequest = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{gQ: true, a6: r.a6, bb: r.bb, be: r.be, bf: r.bf, bk: r.bk, bn: r.bn, bp: r.bp}));
};
var $author$project$Models$User = F5(
	function (id, username, email, privilege, moodleUrl) {
		return {e8: email, hP: id, ib: moodleUrl, fZ: privilege, eL: username};
	});
	...
	return $elm$http$Http$riskyRequest(
		{
			...
			bb: A2($author$project$Api$expectJson, options.d9, $author$project$Api$Homework$User$userDecoder),
			be: _List_Nil,
			bf: 'GET',
		...
		return _Utils_Tuple2(
			A5(
				...
				$author$project$Shared$classifyDevice(
					{hK: flags.hK, jD: flags.jD}),
				false),
			$author$project$Api$Homework$User$getUserFromSession(
				{d9: $author$project$Shared$GotUser}));
	});
...
var $author$project$Models$Course = F5(
	function (id, name, assignments, fromMoodle, user) {
		return {gU: assignments, hG: fromMoodle, hP: id, ic: name, gq: user};
	});
var $author$project$Models$Assignment = F6(
	function (id, courseId, user, title, dueDate, fromMoodle) {
		return {hj: courseId, ht: dueDate, hG: fromMoodle, hP: id, jq: title, gq: user};
	});
	...
	function (defaultOffset, posixMinutes, eras) {
		...
		while (true) {
			if (!eras.b) {
				...
				if (_Utils_cmp(era.eB, posixMinutes) < 0) {
...
var $elm$time$Time$toMonth = F2(
	function (zone, time) {
		var _v0 = $elm$time$Time$toCivil(
			A2($elm$time$Time$toAdjustedMinutes, zone, time)).fH;
		switch (_v0) {
			case 1:
				return 0;
			case 2:
...
var $author$project$Pages$Dashboard$initCommands = _List_fromArray(
	[
		...
		{d9: $author$project$Pages$Dashboard$GotCourseData}),
		...
		7,
		{d9: $author$project$Pages$Dashboard$GotAssignmentData}),
...
var $author$project$Pages$Dashboard$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{
				a4: 0,
				cD: $author$project$Api$Loading,
				bY: $author$project$Api$NotAsked,
				bt: false,
				b2: $author$project$Api$Loading,
				y: $author$project$Api$Loading,
				cQ: $author$project$Api$Loading,
				cR: $author$project$Api$NotAsked,
				at: '',
				hr: shared.hr,
				ba: '',
				d: _List_Nil,
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'title',
				$elm$json$Json$Encode$string(assignment.jq)),
				_Utils_Tuple2(
				'course',
				$elm$json$Json$Encode$int(assignment.hj)),
				_Utils_Tuple2(
				'due_date',
				$elm$json$Json$Encode$int(
					$author$project$Api$Homework$Assignment$dateEncoder(assignment.ht))),
				_Utils_Tuple2(
				'from_moodle',
				$elm$json$Json$Encode$bool(assignment.hG))
			]));
};
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				bb: A2($author$project$Api$expectJson, options.d9, $author$project$Api$Homework$Course$assignmentDecoder),
				be: _List_Nil,
				bf: 'POST',
				bk: $elm$core$Maybe$Nothing,
				bn: $elm$core$Maybe$Nothing,
...
var $author$project$Api$Homework$Course$MinimalCourse = F3(
	function (id, name, fromMoodle) {
		return {hG: fromMoodle, hP: id, ic: name};
	});
...
var $justinmimbs$date$Date$toOrdinalDate = function (_v0) {
	...
	return {
		ea: rd - $justinmimbs$date$Date$daysBeforeYear(y),
		gC: y
	};
};
var $justinmimbs$date$Date$toCalendarDate = function (_v0) {
	...
	return A3($justinmimbs$date$Date$toCalendarDateHelp, date.gC, 0, date.ea);
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {e1: col, hi: contextStack, f_: problem, f7: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.f7, s.e1, x, s.f));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.f7, s.e1, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{e1: newCol, f: s.f, k: s.k, b: newOffset, f7: newRow, a: s.a});
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{e1: 1, f: s.f, k: s.k, b: s.b + 1, f7: s.f7 + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{e1: s.e1 + 1, f: s.f, k: s.k, b: newOffset, f7: s.f7, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{e1: col, f: s0.f, k: s0.k, b: offset, f7: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.f7, s.e1, s);
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {e1: col, f_: problem, f7: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.f7, p.e1, p.f_);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{e1: 1, f: _List_Nil, k: 1, b: 0, f7: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
			return $elm$core$Result$Ok(value);
		} else {
...
var $justinmimbs$date$Date$language_en = {
	dB: $justinmimbs$date$Date$withOrdinalSuffix,
	d4: $justinmimbs$date$Date$monthToName,
	c7: A2(
		$elm$core$Basics$composeR,
		$justinmimbs$date$Date$monthToName,
		$elm$core$String$left(3)),
	eM: $justinmimbs$date$Date$weekdayToName,
	br: A2(
		$elm$core$Basics$composeR,
				...
				if (data.$ === 2) {
					...
					if (e.$ === 3) {
						...
						return ((s === 401) || (s === 403)) ? _Utils_Tuple2(
							model,
							A2($author$project$Utils$Route$navigate, model.bp.h2, 2)) : _Utils_Tuple2(
							_Utils_update(
								model,
								{y: data}),
							$elm$core$Platform$Cmd$none);
			...
			case 1:
				...
				return $elm$core$String$isEmpty(
					...
					A2(
						...
						text,
						{d9: $author$project$Pages$Dashboard$GotSearchCoursesData})) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							d: A2(
					...
					A2(
						$author$project$Api$Homework$Course$searchCourses,
						text,
						{d9: $author$project$Pages$Dashboard$GotSearchCoursesData})));
			case 3:
				var course = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 8:
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							aE: time,
							B: A2($justinmimbs$date$Date$fromPosix, $elm$time$Time$utc, time)
						}),
					$elm$core$Platform$Cmd$none);
			case 6:
				var _v4 = model.aC;
					...
					if (!_v5.$) {
						...
						return _Utils_Tuple2(
							...
							A2(
								...
								{hj: course.hP, ht: dueDate, hG: course.hG, jq: model.a0},
								{d9: $author$project$Pages$Dashboard$GotCreateAssignmentData}));
					} else {
							...
							aE: $elm$time$Time$millisToPosix(
								$elm$core$Basics$floor(
									$justinmimbs$date$Date$toRataDie(
										A2($justinmimbs$date$Date$fromPosix, $elm$time$Time$utc, model.aE)) - epochStartOffset) * (((1000 * 60) * 60) * 24))
						}),
					$elm$core$Platform$Cmd$none);
			case 10:
				var id = msg.a;
				return _Utils_Tuple2(
					...
					A2(
						...
						id,
						{d9: $author$project$Pages$Dashboard$GotRemoveAssignmentData}));
			case 11:
				var data = msg.a;
				if (data.$ === 3) {
												...
												return _Utils_update(
													c,
													{
														gU: A2(
															$elm$core$List$filter,
															function (a) {
																return !_Utils_eq(a.hP, assignment.hP);
															},
															c.gU)
													});
											},
											...
											return _Utils_update(
												c,
												{
													gU: A2(
														$elm$core$List$map,
														function (a) {
															return _Utils_eq(a.hP, assignmentId) ? _Utils_update(
																a,
																{jq: model.ba}) : a;
														},
														c.gU)
...
var $mdgriffith$elm_ui$Internal$Model$asColumn = 1;
var $mdgriffith$elm_ui$Internal$Style$classes = {gE: 'a', gF: 'atv', gI: 'ab', gJ: 'cx', gK: 'cy', gL: 'acb', gM: 'accx', gN: 'accy', gO: 'acr', eU: 'al', eV: 'ar', gP: 'at', dq: 'ah', dr: 'av', gS: 's', gY: 'bh', gZ: 'b', g$: 'w7', g1: 'bd', g2: 'bdt', cF: 'bn', g3: 'bs', cJ: 'cpe', hc: 'cp', hd: 'cpx', he: 'cpy', aN: 'c', cL: 'ctr', cN: 'cb', cO: 'ccx', aO: 'ccy', b1: 'cl', cP: 'cr', hh: 'ct', hk: 'cptr', hl: 'ctxt', hE: 'fcs', fe: 'focus-within', hH: 'fs', hJ: 'g', dI: 'hbh', dJ: 'hc', fk: 'he', dK: 'hf', fl: 'hfp', hN: 'hv', hQ: 'ic', hS: 'fr', c_: 'lbl', hX: 'iml', hY: 'imlf', hZ: 'imlp', h_: 'implw', h$: 'it', h1: 'i', fC: 'lnk', bI: 'nb', fK: 'notxt', ip: 'ol', ir: 'or', bg: 'oq', iz: 'oh', aA: 'pg', fU: 'p', iB: 'ppe', iL: 'ui', f7: 'r', iR: 'sb', iS: 'sbx', iT: 'sby', iV: 'sbt', iZ: 'e', i_: 'cap', i$: 'sev', i6: 'sk', dk: 't', jc: 'tc', jd: 'w8', je: 'w2', jf: 'w9', jg: 'tj', dl: 'tja', jh: 'tl', ji: 'w3', jj: 'w5', jk: 'w4', jl: 'tr', jm: 'w6', jn: 'w1', jo: 'tun', aa: 'ts', bo: 'clr', jz: 'u', eN: 'wc', gx: 'we', eO: 'wf', gy: 'wfp', eP: 'wrp'};
var $mdgriffith$elm_ui$Internal$Model$Generic = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$div = $mdgriffith$elm_ui$Internal$Model$Generic;
var $mdgriffith$elm_ui$Internal$Model$NoNearbyChildren = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.gS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aN);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.gS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.hJ);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.gS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aA);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.gS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fU);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.gS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.f7);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.gS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.iZ);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.iM)) + ('-cols-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.ar)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.i0.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.i0.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.f7) + ('-' + ($elm$core$String$fromInt(pos.e1) + ('-' + ($elm$core$String$fromInt(pos.jD) + ('-' + $elm$core$String$fromInt(pos.hK)))))));
		case 11:
...
var $mdgriffith$elm_ui$Internal$Model$formatBoxShadow = function (shadow) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					shadow.fr ? $elm$core$Maybe$Just('inset') : $elm$core$Maybe$Nothing,
					$elm$core$Maybe$Just(
					...
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.ge) + 'px'),
					$elm$core$Maybe$Just(
...
var $mdgriffith$elm_ui$Internal$Model$renderFocusStyle = function (focus) {
	return _List_fromArray(
		[
			...
			A2(
			$mdgriffith$elm_ui$Internal$Model$Style,
			$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gS) + (':focus .focusable, ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gS) + '.focusable:focus')),
			A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Style$baseSheet = _List_fromArray(
	[
		...
		A2(
		$mdgriffith$elm_ui$Internal$Style$Class,
		$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gS) + ':focus',
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.hN, $mdgriffith$elm_ui$Internal$Style$classes.bo)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.hN, $mdgriffith$elm_ui$Internal$Style$classes.bg)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.hE, $mdgriffith$elm_ui$Internal$Style$classes.bo)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.hE, $mdgriffith$elm_ui$Internal$Style$classes.bg)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gF, $mdgriffith$elm_ui$Internal$Style$classes.bo)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gF, $mdgriffith$elm_ui$Internal$Style$classes.bg)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				_List_fromArray(
					[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.gO,
						_List_fromArray(
							[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:first-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.gM,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.gM,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:only-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.gM,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + ($mdgriffith$elm_ui$Internal$Style$classes.gM + ' ~ u'),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + ($mdgriffith$elm_ui$Internal$Style$classes.gO + (' ~ s.' + $mdgriffith$elm_ui$Internal$Style$classes.gM)),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
				...
				_List_fromArray(
					[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + ($mdgriffith$elm_ui$Internal$Style$classes.gL + (' ~ s.' + $mdgriffith$elm_ui$Internal$Style$classes.gN)),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
				...
				_List_fromArray(
					[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gS + ':first-child'),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						$mdgriffith$elm_ui$Internal$Style$Child,
						$mdgriffith$elm_ui$Internal$Style$dot(
							$mdgriffith$elm_ui$Internal$Style$classes.gS + ($mdgriffith$elm_ui$Internal$Style$selfName(3) + (':first-child + .' + $mdgriffith$elm_ui$Internal$Style$classes.gS))),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						$mdgriffith$elm_ui$Internal$Style$Child,
						$mdgriffith$elm_ui$Internal$Style$dot(
							$mdgriffith$elm_ui$Internal$Style$classes.gS + ($mdgriffith$elm_ui$Internal$Style$selfName(2) + (':first-child + .' + $mdgriffith$elm_ui$Internal$Style$classes.gS))),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
...
var $mdgriffith$elm_ui$Internal$Style$explainer = '\n.explain {\n    border: 6px solid rgb(174, 121, 15) !important;\n}\n.explain > .' + ($mdgriffith$elm_ui$Internal$Style$classes.gS + (' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n.ctr {\n    border: none !important;\n}\n.explain > .ctr > .' + ($mdgriffith$elm_ui$Internal$Style$classes.gS + ' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n')));
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gS) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.f7) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gS) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gS) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.f7) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gS) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cL) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {cK: closing, w: _List_Nil, aY: _List_Nil, al: selector};
	});
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.al + ('{' + (renderValues(rule.aY) + (rule.cK + '}')));
		}
	};
...
var $mdgriffith$elm_ui$Internal$Model$hasSmallCaps = function (typeface) {
	if (typeface.$ === 5) {
		var font = typeface.a;
		return A2($elm$core$List$any, $mdgriffith$elm_ui$Internal$Model$isSmallCaps, font.gs);
	} else {
		return false;
	}
};
			...
			switch (pseudo) {
				...
				case 0:
					var renderedProps = A3(
						...
						props);
					return _List_fromArray(
						[selector + ('-fs:focus {' + (renderedProps + '\n}')), ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.gS + (':focus ' + (selector + '-fs  {')))) + (renderedProps + '\n}'), (selector + '-fs:focus-within {') + (renderedProps + '\n}'), ('.focusable-parent:focus ~ ' + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.gS + (' ' + (selector + '-fs {'))))) + (renderedProps + '\n}')]);
				default:
					return _List_fromArray(
						[
	...
	if (typeface.$ === 5) {
		...
		return $elm$core$Maybe$Just(
			A2(
				$elm$core$String$join,
				', ',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$renderVariant, font.gs)));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 5:
				...
				var single = '.' + $mdgriffith$elm_ui$Internal$Style$classes.iZ;
				var row = '.' + $mdgriffith$elm_ui$Internal$Style$classes.f7;
				var wrappedRow = '.' + ($mdgriffith$elm_ui$Internal$Style$classes.eP + row);
				var right = '.' + $mdgriffith$elm_ui$Internal$Style$classes.eV;
				var paragraph = '.' + $mdgriffith$elm_ui$Internal$Style$classes.fU;
				...
				var _class = '.' + cls;
				var any = '.' + $mdgriffith$elm_ui$Internal$Style$classes.gS;
				return $elm$core$List$concat(
					_List_fromArray(
						[
							A4(
			...
			case 8:
				...
				var xSpacing = toGridLength(template.i0.a);
				var ySpacing = toGridLength(template.i0.b);
				var rows = function (x) {
					...
					A2(
						$elm$core$String$join,
						' ',
						A2($elm$core$List$map, toGridLength, template.iM)));
				...
				var msColumns = function (x) {
					...
					A2(
						...
						ySpacing,
						A2($elm$core$List$map, toGridLength, template.ar)));
				var gapY = 'grid-row-gap:' + (toGridLength(template.i0.b) + ';');
				var gapX = 'grid-column-gap:' + (toGridLength(template.i0.a) + ';');
			...
			case 9:
				...
				var msPosition = A2(
					...
					_List_fromArray(
						[
							'-ms-grid-row: ' + ($elm$core$String$fromInt(position.f7) + ';'),
							'-ms-grid-row-span: ' + ($elm$core$String$fromInt(position.hK) + ';'),
							'-ms-grid-column: ' + ($elm$core$String$fromInt(position.e1) + ';'),
							'-ms-grid-column-span: ' + ($elm$core$String$fromInt(position.jD) + ';')
						]));
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.f7) + (' / ' + ($elm$core$String$fromInt(position.f7 + position.hK) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.e1) + (' / ' + ($elm$core$String$fromInt(position.e1 + position.jD) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.f7) + ('-' + ($elm$core$String$fromInt(position.e1) + ('-' + ($elm$core$String$fromInt(position.jD) + ('-' + $elm$core$String$fromInt(position.hK)))))));
...
var $mdgriffith$elm_ui$Internal$Model$renderFontAdjustmentRule = F3(
	function (fontToAdjust, _v0, otherFontName) {
		...
		return A2(
			...
			' ',
			_Utils_ap(
				A3($mdgriffith$elm_ui$Internal$Model$fontRule, name, $mdgriffith$elm_ui$Internal$Style$classes.i_, capital),
				A3($mdgriffith$elm_ui$Internal$Model$fontRule, name, $mdgriffith$elm_ui$Internal$Style$classes.hH, full)));
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.i_ + (', ' + ('.' + (name + (' .' + $mdgriffith$elm_ui$Internal$Style$classes.i_))))))),
					_List_fromArray(
						[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.i_ + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.dk + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.i_ + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.dk)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {hK: height / size, ge: size, gt: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.g7, adjustment.gX, adjustment.hq, adjustment.h6]);
	var lineHeight = 1.5;
	...
	return {
		g7: A3($mdgriffith$elm_ui$Internal$Model$adjust, capitalSize, ascender - newBaseline, capitalVertical),
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'line-height',
				$elm$core$String$fromFloat(converted.hK)),
				_Utils_Tuple2(
				'vertical-align',
				...
				return {
					...
					cu: function () {
						...
						if (_v1.$ === 1) {
							...
							var topLevel = _v1.a;
							return A2($elm$core$List$cons, topLevel, rendered.cu);
						}
					}()
				};
			});
	...
	function (_static, opts, styles, children) {
		var dynamicStyleSheet = A2(
			...
			A3(
				...
				_Utils_Tuple2(
					$elm$core$Set$empty,
					$mdgriffith$elm_ui$Internal$Model$renderFocusStyle(opts.hE)),
				styles).b);
		return _static ? A2(
			$elm$core$List$cons,
			_Utils_Tuple2(
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.gS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.iZ))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.gS, $mdgriffith$elm_ui$Internal$Style$classes.iZ, $mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.aO, $mdgriffith$elm_ui$Internal$Style$classes.gO])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.gS, $mdgriffith$elm_ui$Internal$Style$classes.iZ, $mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.aO, $mdgriffith$elm_ui$Internal$Style$classes.gM])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.gS, $mdgriffith$elm_ui$Internal$Style$classes.iZ, $mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.gN])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.gS, $mdgriffith$elm_ui$Internal$Style$classes.iZ, $mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.gL])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.gS + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dk + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.eN + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dJ)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.gS + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dk + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.eO + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dK)))));
...
var $mdgriffith$elm_ui$Internal$Model$createElement = F3(
	function (context, children, rendered) {
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.hO, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.gk : _Utils_ap(styled.gk, existingStyles)) : _Utils_Tuple2(
							A2(
								$elm$core$List$cons,
								_Utils_Tuple2(
									key,
									A2(styled.hO, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.gk : _Utils_ap(styled.gk, existingStyles));
					case 2:
						var str = child.a;
						return _Utils_Tuple2(
							A2(
		...
		if (children.$ === 1) {
			...
			var keyed = _v1.a;
			var styles = _v1.b;
			var newStyles = $elm$core$List$isEmpty(styles) ? rendered.gk : _Utils_ap(rendered.gk, styles);
			if (!newStyles.b) {
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Keyed(
							A3($mdgriffith$elm_ui$Internal$Model$addKeyedChildren, 'nearby-element-pls', keyed, rendered.ha)),
				...
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Unkeyed(
							A2($mdgriffith$elm_ui$Internal$Model$addChildren, unkeyed, rendered.ha)),
						$mdgriffith$elm_ui$Internal$Model$NoStyleSheet));
			} else {
				var allStyles = newStyles;
				return $mdgriffith$elm_ui$Internal$Model$Styled(
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bI, $mdgriffith$elm_ui$Internal$Style$classes.iZ, $mdgriffith$elm_ui$Internal$Style$classes.gE]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bI, $mdgriffith$elm_ui$Internal$Style$classes.iZ, $mdgriffith$elm_ui$Internal$Style$classes.gZ]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bI, $mdgriffith$elm_ui$Internal$Style$classes.iZ, $mdgriffith$elm_ui$Internal$Style$classes.ir]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bI, $mdgriffith$elm_ui$Internal$Style$classes.iZ, $mdgriffith$elm_ui$Internal$Style$classes.ip]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bI, $mdgriffith$elm_ui$Internal$Style$classes.iZ, $mdgriffith$elm_ui$Internal$Style$classes.hS]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bI, $mdgriffith$elm_ui$Internal$Style$classes.iZ, $mdgriffith$elm_ui$Internal$Style$classes.gY]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.hO, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, $mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.dq + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eU);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.dq + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eV);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.dq + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.gJ);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.dr + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.gP);
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.gS + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.aN + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Internal$Model$renderWidth = function (w) {
	switch (w.$) {
		case 0:
			...
			return _Utils_Tuple3(
				$mdgriffith$elm_ui$Internal$Flag$none,
				$mdgriffith$elm_ui$Internal$Style$classes.gx + (' width-px-' + $elm$core$String$fromInt(px)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_Nil) : _Utils_Tuple3(
				A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$widthFill, $mdgriffith$elm_ui$Internal$Flag$none),
				$mdgriffith$elm_ui$Internal$Style$classes.gy + (' width-fill-' + $elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.gS + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.f7 + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
					...
					case 7:
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$width, has)) {
							...
							switch (width.$) {
								case 0:
									var px = width.a;
									var $temp$classes = ($mdgriffith$elm_ui$Internal$Style$classes.gx + (' width-px-' + $elm$core$String$fromInt(px))) + (' ' + classes),
										$temp$node = node,
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.gy + (' width-fill-' + $elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
											$mdgriffith$elm_ui$Internal$Flag$widthFill,
					...
					case 9:
						...
						var newStyles = function () {
							switch (elem.$) {
								...
								default:
									var styled = elem.a;
									return _Utils_ap(styles, styled.gk);
							}
						}();
						var $temp$classes = classes,
							$temp$node = node,
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.hh + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b1)),
				A2(
					$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.b1 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aO)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $mdgriffith$elm_ui$Element$Font$bold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.g$);
var $mdgriffith$elm_ui$Internal$Flag$fontAlignment = $mdgriffith$elm_ui$Internal$Flag$flag(12);
var $mdgriffith$elm_ui$Element$Font$center = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontAlignment, $mdgriffith$elm_ui$Internal$Style$classes.jc);
...
var $mdgriffith$elm_ui$Element$pointer = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$cursor, $mdgriffith$elm_ui$Internal$Style$classes.hk);
...
var $mdgriffith$elm_ui$Element$clip = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.hc);
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {g4: -box.g4, h4: -box.h4, iK: -box.iK, jy: -box.jy};
};
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.fK + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.iB)),
...
var $mdgriffith$elm_ui$Element$scrollbarY = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.iT);
...
var $mdgriffith$elm_ui$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
											...
											return _List_fromArray(
												[
													...
													A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.hY)
															]),
														_List_fromArray(
															[
										...
										if (_v2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.Q, textOptions.dk === ''))
												]);
										}
									}()
									])))),
		...
		return A3(
			...
			A2(
				$elm$core$List$cons,
				A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$cursor, $mdgriffith$elm_ui$Internal$Style$classes.hl),
				A2(
					$elm$core$List$cons,
										...
										[
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
																	_Utils_eq(user.hP, assignment.gq.hP) ? $mdgriffith$elm_ui$Element$Events$onClick(
																	$author$project$Pages$Dashboard$FocusAssignmentTitle(assignment.jq)) : $mdgriffith$elm_ui$Element$pointer,
																	$mdgriffith$elm_ui$Element$pointer
																]),
															model.bt ? A2(
																...
																_List_fromArray(
																	[
																		...
																		$author$project$Pages$Dashboard$ChangeAssignmentTitle(assignment.hP),
																		$author$project$Pages$Dashboard$UnfocusAssignmentTitle)
																	]),
																{
																	h3: $mdgriffith$elm_ui$Element$Input$labelHidden('edit assignment title'),
																	da: $author$project$Pages$Dashboard$ChangeAssignmentTitleTfText,
																...
																$mdgriffith$elm_ui$Element$text(assignment.jq)))
														])),
													A2(
													$mdgriffith$elm_ui$Element$el,
													_List_fromArray(
											...
											$mdgriffith$elm_ui$Element$text(
												'Course: ' + A2(
													$elm$core$Maybe$withDefault,
													'undefined',
													A2($author$project$Pages$Dashboard$getCourseNameById, courses, assignment.hj)))),
											A2(
											$mdgriffith$elm_ui$Element$row,
											_List_fromArray(
												[
											...
											_List_fromArray(
												[
													_Utils_eq(user.hP, assignment.gq.hP) ? A3(
													$author$project$Pages$Dashboard$viewButton,
													'[delete]',
													$author$project$Styling$Colors$redColor,
													$author$project$Pages$Dashboard$RemoveAssignment(assignment.hP)) : $mdgriffith$elm_ui$Element$none
												]))
										]);
								case 1:
									return _List_fromArray(
...
var $gampleman$elm_visualization$Shape$defaultPieConfig = {dz: 0, dG: 2 * $elm$core$Basics$pi, hW: 0, fP: 100, eb: 0, ec: 0, gg: $elm$core$Basics$compare, cp: 0, gr: $elm$core$Basics$identity};
...
var $gampleman$elm_visualization$Shape$Pie$pie = F2(
	function (settings, data) {
		...
		var da = A2(
			...
			A2($elm$core$Basics$max, (-2) * $elm$core$Basics$pi, settings.dG - settings.cp));
		var p = A2(
			$elm$core$Basics$min,
		...
		var computeValue = F2(
			function (el, angle) {
				var value = settings.gr(el);
				return {
					dz: settings.dz,
					dG: (angle + ((value > 0) ? (value * k) : 0)) + pa,
					hW: settings.hW,
					fP: settings.fP,
					eb: p,
					ec: settings.ec,
		...
		return $elm$core$Dict$values(
			A3(
				$elm$core$List$foldl,
				helper,
				_Utils_Tuple2(settings.cp, $elm$core$Dict$empty),
...
var $gampleman$elm_visualization$Shape$Pie$centroid = function (arcData) {
	var r = (arcData.hW + arcData.fP) / 2;
	var a = ((arcData.cp + arcData.dG) / 2) - ($elm$core$Basics$pi / 2);
	return _Utils_Tuple2(
...
var $author$project$Components$PieChart$pieLabel = F2(
	function (slice, _v0) {
		...
		var _v1 = $gampleman$elm_visualization$Shape$centroid(
			_Utils_update(
				slice,
				{hW: $author$project$Components$PieChart$radius - dings, fP: $author$project$Components$PieChart$radius - dings}));
		var x = _v1.a;
		var y = _v1.b;
		return A2(
...
var $folkertdev$one_true_path_experiment$SubPath$with = F2(
	function (moveto, drawtos) {
		return $folkertdev$one_true_path_experiment$SubPath$SubPath(
			{
				e6: $folkertdev$elm_deque$Deque$fromList(drawtos),
				fJ: moveto
			});
	});
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									{
									dt: $folkertdev$one_true_path_experiment$LowLevel$Command$largestArc,
									dD: cw,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									{
									dt: $gampleman$elm_visualization$Shape$Pie$boolToArc(
...
var $folkertdev$one_true_path_experiment$SubPath$close = function (subpath) {
	if (subpath.$ === 1) {
		...
		var moveto = subpath.a.fJ;
		var drawtos = subpath.a.e6;
		...
		if ((!_v1.a.$) && (_v1.a.a.$ === 4)) {
			...
			return $folkertdev$one_true_path_experiment$SubPath$SubPath(
				{
					e6: A2($folkertdev$elm_deque$Deque$pushBack, $folkertdev$one_true_path_experiment$LowLevel$Command$closePath, drawtos),
					fJ: moveto
				});
		}
	}
...
var $folkertdev$one_true_path_experiment$SubPath$pushBack = F2(
	function (drawto, data) {
		return _Utils_update(
			data,
			{
				e6: A2($folkertdev$elm_deque$Deque$pushBack, drawto, data.e6)
			});
	});
...
var $folkertdev$one_true_path_experiment$SubPath$unsafeConcatenate = F2(
	function (a, b) {
		return _Utils_update(
			a,
			{
				e6: A2($folkertdev$elm_deque$Deque$append, a.e6, b.e6)
			});
	});
...
var $folkertdev$one_true_path_experiment$SubPath$finalCursorState = function (_v0) {
	...
	var _v1 = moveto;
	var start = _v1;
	var initial = {l: start, x: $elm$core$Maybe$Nothing, eB: start};
...
var $gampleman$elm_visualization$Shape$Pie$arc = function (arcData) {
	var a1 = arcData.dG - ($elm$core$Basics$pi / 2);
	var a0 = arcData.cp - ($elm$core$Basics$pi / 2);
	var cw = _Utils_cmp(a1, a0) > 0;
	var da = $elm$core$Basics$abs(a1 - a0);
	var _v0 = (_Utils_cmp(arcData.hW, arcData.fP) > 0) ? _Utils_Tuple2(arcData.fP, arcData.hW) : _Utils_Tuple2(arcData.hW, arcData.fP);
	var r0 = _v0.a;
	var r1 = _v0.b;
	var path = function () {
		if (_Utils_cmp(r1, $gampleman$elm_visualization$Shape$Pie$epsilon) < 1) {
			...
			if (_Utils_cmp(da, (2 * $elm$core$Basics$pi) - $gampleman$elm_visualization$Shape$Pie$epsilon) > 0) {
				...
				var rc = A2(
					...
					arcData.dz);
				var ap = arcData.eb / 2;
				var rp = (_Utils_cmp(ap, $gampleman$elm_visualization$Shape$Pie$epsilon) > 0) ? ((arcData.ec > 0) ? arcData.ec : $elm$core$Basics$sqrt(
...
var $avh4$elm_color$Color$fromRgba = function (components) {
	return A4($avh4$elm_color$Color$RgbaSpace, components.iF, components.hI, components.g_, components.bs);
};
	...
	if (subpath.$ === 1) {
		...
		return $folkertdev$one_true_path_experiment$SubPath$SubPath(
			_Utils_update(
				data,
				{
					e6: $folkertdev$one_true_path_experiment$SubPath$compressHelper(data.e6)
				}));
	}
};
var $folkertdev$svg_path_lowlevel$Path$LowLevel$DecimalPlaces = $elm$core$Basics$identity;
var $folkertdev$svg_path_lowlevel$Path$LowLevel$decimalPlaces = $elm$core$Basics$identity;
var $folkertdev$one_true_path_experiment$SubPath$defaultConfig = {cV: $elm$core$Maybe$Nothing, c6: false};
		...
		return $elm$core$Maybe$Just(
			{
				...
				fJ: $folkertdev$one_true_path_experiment$LowLevel$Command$toLowLevelMoveTo(moveto)
			});
	}
};
var $folkertdev$svg_path_lowlevel$Path$LowLevel$defaultConfig = {cd: $elm$core$String$fromFloat};
...
var $folkertdev$svg_path_lowlevel$Path$LowLevel$optionFolder = F2(
	function (option, config) {
		...
		return _Utils_update(
			config,
			{
				cd: $folkertdev$svg_path_lowlevel$Path$LowLevel$roundTo(n)
			});
	});
...
var $folkertdev$svg_path_lowlevel$Path$LowLevel$stringifyCoordinate = F2(
	function (config, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		return config.cd(x) + (',' + config.cd(y));
	});
		...
		return A2(
			...
			A2(
				...
				$folkertdev$one_true_path_experiment$SubPath$toLowLevel(
					(config.c6 ? $folkertdev$one_true_path_experiment$SubPath$compress : $elm$core$Basics$identity)(subpath))));
	});
...
var $author$project$Components$PieChart$view = function (model) {
	var pieData = A2(
		...
		_Utils_update(
			...
			{fP: $author$project$Components$PieChart$radius}),
		A2(
			$elm$core$List$map,
			$elm$core$Basics$toFloat,
...
var $mdgriffith$elm_ui$Element$Font$italic = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.h1);
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cO + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aO + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.iV + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fK)))))),
						A2(
							$elm$core$List$cons,
							$mdgriffith$elm_ui$Element$pointer,
							A2(
...
var $mdgriffith$elm_ui$Element$Border$dotted = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$borderStyle, $mdgriffith$elm_ui$Internal$Style$classes.g2);
...
var $mdgriffith$elm_ui$Element$Border$roundEach = function (_v0) {
	var topLeft = _v0.dn;
	var topRight = _v0.$7;
	var bottomLeft = _v0.cG;
	var bottomRight = _v0.cH;
	return A2(
		$mdgriffith$elm_ui$Internal$Model$StyleClass,
		$mdgriffith$elm_ui$Internal$Flag$borderRound,
		A3(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					{cG: 10, cH: 10, dn: 0, $7: 0}) : $mdgriffith$elm_ui$Element$Border$rounded(0),
			...
			_List_fromArray(
				[
					...
					A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text(course.ic)
							])))
				]));
	});
var $author$project$Pages$Dashboard$courseToKeyValue = F2(
	function (last, course) {
		return _Utils_Tuple2(
			$elm$core$String$fromInt(course.hP),
			A2(
				$author$project$Pages$Dashboard$viewSearchDropdownElement,
				course,
				_Utils_eq(course.hP, last.hP)));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Pages$Dashboard$viewCreateAssignmentFormStatus(model.cR),
				A2(
				function () {
					var _v0 = model.hr.hb;
					if (!_v0) {
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
									...
									]),
								{
									...
									da: $author$project$Pages$Dashboard$SearchCourses,
								...
								[$mdgriffith$elm_ui$Element$alignTop])),
						{
							...
							da: $author$project$Pages$Dashboard$CAFChangeTitle,
							df: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
				...
				_List_fromArray(
					[
								...
								])),
						{
							...
							da: $author$project$Pages$Dashboard$CAFChangeDate,
							df: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
					...
					]),
				{
					h3: A2(
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
						$mdgriffith$elm_ui$Element$text('Submit')),
					fN: $elm$core$Maybe$Just($author$project$Pages$Dashboard$CreateAssignment)
				})
			]));
};
	...
	function (unit, n, _v0) {
		...
		switch (unit) {
			...
			case 1:
				...
				var wholeMonths = ((12 * (date.gC - 1)) + ($justinmimbs$date$Date$monthToNumber(date.fH) - 1)) + n;
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$List$cons,
								$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cO + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aO + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fC)))),
								attrs))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
	...
	function (today, courses) {
		...
		return A2(
				...
				return _Utils_update(
					course,
					{
						gU: A2(
							$elm$core$List$filter,
							function (a) {
								return _Utils_eq(a.hj, course.hP);
							},
							validAssignments)
					});
			},
			A2(
				$elm$core$List$filter,
				function (course) {
					return A2($elm$core$List$member, course.hP, validCourseIds);
				},
				courses));
	});
var $mdgriffith$elm_ui$Element$Border$solid = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$borderStyle, $mdgriffith$elm_ui$Internal$Style$classes.g3);
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$pointer,
					$mdgriffith$elm_ui$Element$Events$onClick(
					$author$project$Pages$Dashboard$ViewAssignmentModal(assignment.hP))
				]),
			_List_fromArray(
				[
					A2(
					...
					A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text(
								_Utils_ap(
									displayDate ? ($author$project$Pages$Dashboard$toGermanDateString(assignment.ht) + ': ') : '',
									assignment.jq))
							]))),
					A2(
					$mdgriffith$elm_ui$Element$el,
					...
					$mdgriffith$elm_ui$Element$text(assignment.gq.eL))
				]));
	});
		...
		var assignments = function () {
			if (!maybeDate.$) {
				...
				return A2(
					$elm$core$List$filter,
					function (assignment) {
						return _Utils_eq(assignment.ht, date);
					},
					course.gU);
			} else {
				return course.gU;
		...
		var validCourses = A2(
			...
			A2(
				...
				A2(
					$elm$core$List$map,
					function (course) {
						return _Utils_Tuple2(course.hP, course.gU);
					},
					courses)));
		return A2(
			$elm$core$List$filter,
			function (course) {
				return A2($elm$core$List$member, course.hP, validCourses);
			},
			courses);
	});
		...
		_List_fromArray(
			[
				...
				function () {
					...
					if (!_v1.$) {
						var user = _v1.a;
						return (user.ib !== '') ? _List_fromArray(
							[
...
var $mdgriffith$elm_ui$Element$Font$semiBold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.jm);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				($elm$core$String$length(user.eL) > 12) ? $mdgriffith$elm_ui$Element$text(
					'Hey, ' + (A3($elm$core$String$slice, 0, 12, user.eL) + '...')) : $mdgriffith$elm_ui$Element$text('Hey, ' + user.eL)),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				function () {
...
var $author$project$Components$Sidebar$viewSidebar = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Components$Sidebar$viewUser(model.gq),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				A2($author$project$Components$Sidebar$viewLinks, links, model.gF))
			]));
};
				...
				return _Utils_Tuple2(
					...
					$elm$core$List$length(
						A2(
							...
							function (a) {
								return _Utils_eq(
									$author$project$Components$LineChart$dateToPosixTime(a.ht),
									x.a);
							},
							assignments)));
			},
...
var $gampleman$elm_visualization$Scale$convert = F2(
	function (_v0, value) {
		var scale = _v0;
		return A3(scale.P, scale.dE, scale.D, value);
	});
var $gampleman$elm_visualization$Scale$rangeExtent = function (_v0) {
	var options = _v0;
	return A2(options.bL, options.dE, options.D);
};
...
var $ryannhg$date_format$DateFormat$Language$Language = F6(
	function (toMonthName, toMonthAbbreviation, toWeekdayName, toWeekdayAbbreviation, toAmPm, toOrdinalSuffix) {
		return {jr: toAmPm, js: toMonthAbbreviation, jt: toMonthName, bT: toOrdinalSuffix, jw: toWeekdayAbbreviation, jx: toWeekdayName};
	});
...
var $gampleman$elm_visualization$Scale$time = F3(
	function (zone, range_, domain_) {
		return {
			...
			dE: domain_,
			c$: $gampleman$elm_visualization$Scale$Time$invert,
			ci: $gampleman$elm_visualization$Scale$Time$nice(zone),
			D: range_,
			bL: $gampleman$elm_visualization$Scale$Time$rangeExtent,
			eF: $gampleman$elm_visualization$Scale$Time$tickFormat(zone),
			eG: $gampleman$elm_visualization$Scale$Time$ticks(zone)
		};
	});
...
var $gampleman$elm_visualization$Scale$linear = F2(
	function (range_, domain_) {
		return {P: $gampleman$elm_visualization$Scale$Linear$convert, dE: domain_, c$: $gampleman$elm_visualization$Scale$Linear$invert, ci: $gampleman$elm_visualization$Scale$Linear$nice, D: range_, bL: $gampleman$elm_visualization$Scale$Linear$rangeExtent, eF: $gampleman$elm_visualization$Scale$Linear$tickFormat, eG: $gampleman$elm_visualization$Scale$Linear$ticks};
	});
...
var $gampleman$elm_visualization$Scale$tickFormat = function (_v0) {
	var opts = _v0;
	return opts.eF(opts.dE);
};
var $gampleman$elm_visualization$Scale$ticks = F2(
	function (_v0, count) {
		var scale = _v0;
		return A2(scale.eG, scale.dE, count);
	});
var $gampleman$elm_visualization$Axis$computeOptions = F2(
	function (attrs, scale) {
		...
		return A3(
			...
			{
				bR: opts.bR,
				eF: A2($gampleman$elm_visualization$Scale$tickFormat, scale, opts.bR),
				cr: opts.cr,
				bS: opts.bS,
				a$: opts.a$,
				eG: A2($gampleman$elm_visualization$Scale$ticks, scale, opts.bR)
			},
			postList);
	});
...
var $gampleman$elm_visualization$Axis$element = F4(
	function (_v0, k, displacement, textAnchorPosition) {
		...
		var y1 = _v0.jJ;
		var y2 = _v0.jK;
		var translate = _v0.eI;
		var horizontal = _v0.dL;
		return F2(
			function (attrs, scale) {
				...
				var spacing = A2($elm$core$Basics$max, opts.bS, 0) + opts.cr;
				...
				return A2(
					...
					A2(
						...
						A2(
							...
							_List_Nil),
						A2($elm$core$List$map, drawTick, opts.eG)));
			});
	});
...
var $gampleman$elm_visualization$Axis$verticalAttrs = {
	...
	gz: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$y, $elm$core$String$fromFloat),
	...
	jJ: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$x1, $elm$core$String$fromFloat),
	jK: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$x2, $elm$core$String$fromFloat)
};
...
var $gampleman$elm_visualization$Axis$horizontalAttrs = {
	...
	gz: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$x, $elm$core$String$fromFloat),
	...
	jJ: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$y1, $elm$core$String$fromFloat),
	jK: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$y2, $elm$core$String$fromFloat)
};
	...
	function (attrs, children) {
		...
		if (spaced.$ === 1) {
			return A4(
				...
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.b1 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aO + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eP)))),
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
						A2(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							{
								gF: $elm$core$Maybe$Just('dashboard'),
								hr: model.hr,
								gq: model.gq
							}),
							A2(
...
var $author$project$Pages$Dashboard$page = $author$project$Spa$Page$application(
	{hV: $author$project$Pages$Dashboard$init, h5: $author$project$Pages$Dashboard$load, iN: $author$project$Pages$Dashboard$save, i7: $author$project$Pages$Dashboard$subscriptions, jA: $author$project$Pages$Dashboard$update, jB: $author$project$Pages$Dashboard$view});
...
var $author$project$Pages$Dashboard$Admin$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{b3: $author$project$Api$Loading, hr: shared.hr, bp: url, gq: shared.gq},
					...
					_List_fromArray(
						[
							...
							function () {
								...
								if (!_v2.$) {
									var user = _v2.a;
									return (user.fZ === 1) ? _List_fromArray(
										[
											A2(
											$mdgriffith$elm_ui$Element$column,
											_List_Nil,
...
var $author$project$Pages$Dashboard$Admin$page = $author$project$Spa$Page$application(
	{hV: $author$project$Pages$Dashboard$Admin$init, h5: $author$project$Pages$Dashboard$Admin$load, iN: $author$project$Pages$Dashboard$Admin$save, i7: $author$project$Pages$Dashboard$Admin$subscriptions, jA: $author$project$Pages$Dashboard$Admin$update, jB: $author$project$Pages$Dashboard$Admin$view});
var $author$project$Pages$Dashboard$Moodle$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{bZ: $author$project$Api$NotAsked, y: $author$project$Api$NotAsked, hr: shared.hr, aS: '', aT: $author$project$Api$NotAsked, ch: '', aU: '', bp: url, gq: shared.gq},
			$elm$core$Platform$Cmd$none);
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{gQ: false, a6: r.a6, bb: r.bb, be: r.be, bf: r.bf, bk: r.bk, bn: r.bn, bp: r.bp}));
};
		...
		return $elm$http$Http$post(
			{
				...
				bb: A2($author$project$Api$expectJson, options.d9, $author$project$Api$Moodle$Moodle$decoder),
			...
			case 0:
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						{d9: $author$project$Pages$Dashboard$Moodle$GotSiteData}));
			case 1:
				var data = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 4:
				return _Utils_Tuple2(
					...
					A4(
						...
						$author$project$Pages$Dashboard$Moodle$addHttpSchemeIfMissing(model.ch),
						model.aU,
						model.aS,
		...
		return A3(
			$mdgriffith$elm_ui$Element$Input$textHelper,
			{
				...
				E: $mdgriffith$elm_ui$Element$Input$TextInputNode(
					pass.iY ? 'text' : 'password')
			},
			attrs,
			{h3: pass.h3, da: pass.da, df: pass.df, dk: pass.dk});
	});
			...
			[
				...
				function () {
					...
					if (_v1.$ === 3) {
						return _List_fromArray(
							[
								$author$project$Pages$Dashboard$Moodle$viewStatusIndicatorThingy(model.bZ),
								A2(
								$mdgriffith$elm_ui$Element$Input$text,
								_Utils_ap(
										...
										])),
								{
									...
									da: $author$project$Pages$Dashboard$Moodle$ChangeMoodleUsernameInput,
									df: $elm$core$Maybe$Just(
										A2(
											$mdgriffith$elm_ui$Element$Input$placeholder,
											_List_Nil,
										...
										])),
								{
									...
									da: $author$project$Pages$Dashboard$Moodle$ChangeMoodlePasswordInput,
									df: $elm$core$Maybe$Just(
										A2(
											$mdgriffith$elm_ui$Element$Input$placeholder,
											_List_Nil,
											...
											]))),
								{
									...
									fN: ($elm$core$String$isEmpty(model.aU) || $elm$core$String$isEmpty(model.aS)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just($author$project$Pages$Dashboard$Moodle$Authenticate)
								})
							]);
					} else {
						return _List_fromArray(
							[
								...
								$author$project$Pages$Dashboard$Moodle$inputStyle,
								{
									...
									da: $author$project$Pages$Dashboard$Moodle$ChangeMoodleUrlInput,
									df: $elm$core$Maybe$Just(
										A2(
											$mdgriffith$elm_ui$Element$Input$placeholder,
											_List_Nil,
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Components$Sidebar$viewSidebar(
							{
								gF: $elm$core$Maybe$Just('moodle integration'),
								hr: model.hr,
								gq: model.gq
							}),
							A2(
...
var $author$project$Pages$Dashboard$Moodle$page = $author$project$Spa$Page$application(
	{hV: $author$project$Pages$Dashboard$Moodle$init, h5: $author$project$Pages$Dashboard$Moodle$load, iN: $author$project$Pages$Dashboard$Moodle$save, i7: $author$project$Pages$Dashboard$Moodle$subscriptions, jA: $author$project$Pages$Dashboard$Moodle$update, jB: $author$project$Pages$Dashboard$Moodle$view});
var $author$project$Pages$Login$init = F2(
	function (_v0, url) {
		return _Utils_Tuple2(
			{bB: $author$project$Api$NotAsked, cm: '', bp: url, cy: ''},
			$elm$core$Platform$Cmd$none);
	});
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'username',
					$elm$json$Json$Encode$string(credentials.eL)),
					_Utils_Tuple2(
					'password',
					$elm$json$Json$Encode$string(credentials.el))
				]));
				...
				if (data.$ === 3) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{bB: data}),
						A2($author$project$Utils$Route$navigate, model.bp.h2, 1));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			default:
				return _Utils_Tuple2(
					...
					A2(
						...
						{e8: $elm$core$Maybe$Nothing, el: model.cm, eL: model.cy},
						{d9: $author$project$Pages$Login$GotLoginData}));
		}
	});
								...
								[
									...
									_List_fromArray(
										[
											...
											{
												h3: $mdgriffith$elm_ui$Element$Input$labelHidden('username'),
												da: $author$project$Pages$Login$UsernameInput,
												df: $elm$core$Maybe$Just(
													A2(
														$mdgriffith$elm_ui$Element$Input$placeholder,
														_List_Nil,
									...
									_List_fromArray(
										[
											...
											{
												h3: $mdgriffith$elm_ui$Element$Input$labelHidden('password'),
												da: $author$project$Pages$Login$PasswordInput,
												df: $elm$core$Maybe$Just(
													A2(
														$mdgriffith$elm_ui$Element$Input$placeholder,
														_List_Nil,
									...
									{
										h3: $author$project$Pages$Login$viewLoginButton(model),
										fN: $elm$core$Maybe$Just($author$project$Pages$Login$Login)
									})
								])))
					]))
			]),
...
var $author$project$Pages$Login$page = $author$project$Spa$Page$application(
	{hV: $author$project$Pages$Login$init, h5: $author$project$Pages$Login$load, iN: $author$project$Pages$Login$save, i7: $author$project$Pages$Login$subscriptions, jA: $author$project$Pages$Login$update, jB: $author$project$Pages$Login$view});
...
var $author$project$Pages$NotFound$page = $author$project$Spa$Page$static(
	{jB: $author$project$Pages$NotFound$view});
var $author$project$Pages$Register$init = F2(
	function (_v0, url) {
		return _Utils_Tuple2(
			{
				cb: '',
				d: {e8: $elm$core$Maybe$Nothing, el: $elm$core$Maybe$Nothing, eL: $elm$core$Maybe$Nothing},
				cm: '',
				bM: $author$project$Api$NotAsked,
				bp: url,
				cy: '',
				cz: $author$project$Api$NotAsked,
				cA: ''
			},
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Api$Homework$UsernameTaken$usernameTaken = F2(
	function (username, options) {
		return $elm$http$Http$get(
			{
				bb: A2($author$project$Api$expectJson, options.d9, $elm$json$Json$Decode$bool),
			...
			case 0:
				...
				return ($elm$core$String$length(input) > 0) ? _Utils_Tuple2(
					...
					A2(
						...
						input,
						{d9: $author$project$Pages$Register$GotUsernameTaken})) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							d: A2(
					...
					_Utils_update(
						model,
						{
							d: A2(
								...
								model.d,
								A2($author$project$Pages$Register$validatePasswordInput, input, model.cA)),
							cm: input
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
					...
					_Utils_update(
						model,
						{
							d: A2(
								$author$project$Pages$Register$setPasswordError,
								model.d,
								A2($author$project$Pages$Register$validatePasswordInput, model.cm, input)),
							cA: input
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
			...
			default:
				return $author$project$Pages$Register$areErrorsEmpty(model.d) ? _Utils_Tuple2(
					...
					A2(
						...
						{
							e8: $elm$core$Maybe$Just(model.cb),
							el: model.cm,
							eL: model.cy
						},
						{d9: $author$project$Pages$Register$GotRegistrationData})) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Pages$Register$viewInputError = F2(
	function (model, inputName) {
		return (inputName === 'email') ? $author$project$Pages$Register$inputErrorMessage(model.d.e8) : ((inputName === 'username') ? $author$project$Pages$Register$inputErrorMessage(model.d.eL) : ((inputName === 'password') ? $author$project$Pages$Register$inputErrorMessage(model.d.el) : $mdgriffith$elm_ui$Element$none));
	});
								...
								[
										...
										[
											...
											_List_fromArray(
												[
													...
													{
														h3: $mdgriffith$elm_ui$Element$Input$labelHidden('email'),
														da: $author$project$Pages$Register$EmailInput,
														df: $elm$core$Maybe$Just(
															A2(
																$mdgriffith$elm_ui$Element$Input$placeholder,
																_List_Nil,
											...
											_List_fromArray(
												[
													...
													{
														h3: $mdgriffith$elm_ui$Element$Input$labelHidden('username'),
														da: $author$project$Pages$Register$UsernameInput,
														df: $elm$core$Maybe$Just(
															A2(
																$mdgriffith$elm_ui$Element$Input$placeholder,
																_List_Nil,
									...
									_List_fromArray(
										[
											...
											$author$project$Pages$Register$passwordStrengthIndicator(model.cm),
											A2(
											$mdgriffith$elm_ui$Element$Input$newPassword,
											$author$project$Pages$Register$inputStyle,
											{
												h3: $mdgriffith$elm_ui$Element$Input$labelHidden('password'),
												da: $author$project$Pages$Register$PasswordInput,
												df: $elm$core$Maybe$Just(
													A2(
														$mdgriffith$elm_ui$Element$Input$placeholder,
														_List_Nil,
									...
									{
										h3: $mdgriffith$elm_ui$Element$Input$labelHidden('validate password'),
										da: $author$project$Pages$Register$ValidatePasswordInput,
										df: $elm$core$Maybe$Just(
											A2(
												$mdgriffith$elm_ui$Element$Input$placeholder,
												_List_Nil,
									...
									{
										h3: $author$project$Pages$Register$viewRegistrationButton(model),
										fN: $elm$core$Maybe$Just($author$project$Pages$Register$Register)
									})
								])))
					]))
			]),
...
var $author$project$Pages$Register$page = $author$project$Spa$Page$application(
	{hV: $author$project$Pages$Register$init, h5: $author$project$Pages$Register$load, iN: $author$project$Pages$Register$save, i7: $author$project$Pages$Register$subscriptions, jA: $author$project$Pages$Register$update, jB: $author$project$Pages$Register$view});
		...
		return _Utils_Tuple2(
			...
			function () {
				if (!shared.fR) {
					var _v0 = shared.gq;
					if (!_v0.$) {
						return A2($author$project$Utils$Route$navigate, url.h2, 1);
					} else {
		...
		return _Utils_Tuple2(
			...
			function () {
				if (!shared.fR) {
					var _v0 = shared.gq;
					if (!_v0.$) {
						return A2($author$project$Utils$Route$navigate, model.bp.h2, 1);
					} else {
						return $elm$core$Platform$Cmd$none;
					}
				} else {
...
var $mdgriffith$elm_ui$Element$Font$underline = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.jz);
...
var $author$project$Pages$Top$page = $author$project$Spa$Page$application(
	{hV: $author$project$Pages$Top$init, h5: $author$project$Pages$Top$load, iN: $author$project$Pages$Top$save, i7: $author$project$Pages$Top$subscriptions, jA: $author$project$Pages$Top$update, jB: $author$project$Pages$Top$view});
	...
	function (params, key, url) {
		return {
			...
			en: A2(
				$elm$core$Maybe$withDefault,
				$elm$core$Dict$empty,
				A2($elm$core$Maybe$map, $author$project$Spa$Url$toQueryDict, url.en)),
			f2: url
		};
	});
...
var $author$project$Spa$Generated$Pages$upgrade = F3(
	function (toModel, toMsg, page) {
			...
			function (params, shared) {
				return A3(
					...
					A2(
						page.hV,
						shared,
						A3($author$project$Spa$Url$create, params, shared.h2, shared.bp)));
			});
		...
		return {aq: bundle_, hV: init_, jA: update_};
	});
var $author$project$Spa$Generated$Pages$pages = {
	cS: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Dashboard__Model, $author$project$Spa$Generated$Pages$Dashboard__Msg, $author$project$Pages$Dashboard$page),
	cT: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Dashboard__Admin__Model, $author$project$Spa$Generated$Pages$Dashboard__Admin__Msg, $author$project$Pages$Dashboard$Admin$page),
	cU: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Dashboard__Moodle__Model, $author$project$Spa$Generated$Pages$Dashboard__Moodle__Msg, $author$project$Pages$Dashboard$Moodle$page),
	c4: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Login__Model, $author$project$Spa$Generated$Pages$Login__Msg, $author$project$Pages$Login$page),
	c8: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$NotFound__Model, $author$project$Spa$Generated$Pages$NotFound__Msg, $author$project$Pages$NotFound$page),
	dg: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Register__Model, $author$project$Spa$Generated$Pages$Register__Msg, $author$project$Pages$Register$page),
	jy: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Top__Model, $author$project$Spa$Generated$Pages$Top__Msg, $author$project$Pages$Top$page)
};
var $author$project$Spa$Generated$Pages$init = function (route) {
	switch (route) {
		case 0:
			return $author$project$Spa$Generated$Pages$pages.jy.hV(0);
		case 1:
			return $author$project$Spa$Generated$Pages$pages.cS.hV(0);
		case 2:
			return $author$project$Spa$Generated$Pages$pages.c4.hV(0);
		case 3:
			return $author$project$Spa$Generated$Pages$pages.c8.hV(0);
		case 4:
			return $author$project$Spa$Generated$Pages$pages.dg.hV(0);
		case 5:
			return $author$project$Spa$Generated$Pages$pages.cT.hV(0);
		default:
			return $author$project$Spa$Generated$Pages$pages.cU.hV(0);
	}
};
...
var $author$project$Spa$Generated$Pages$bundle = function (bigModel) {
	switch (bigModel.$) {
		case 0:
			...
			return $author$project$Spa$Generated$Pages$pages.jy.aq(model);
		case 1:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.cS.aq(model);
		case 2:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.c4.aq(model);
		case 3:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.c8.aq(model);
		case 4:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.dg.aq(model);
		case 5:
			var model = bigModel.a;
...
var $author$project$Spa$Generated$Pages$subscriptions = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).i7(0);
};
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				case 0:
					...
					if (_v4.$ === 1) {
						return _Utils_update(
							record,
							{
								hN: $elm$core$Maybe$Just(hoverable)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{hE: $elm$core$Maybe$Nothing, hN: $elm$core$Maybe$Nothing, ia: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.iL, $mdgriffith$elm_ui$Internal$Style$classes.gS, $mdgriffith$elm_ui$Internal$Style$classes.iZ]))),
...
var $author$project$Spa$Generated$Pages$load = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).h5(0);
};
var $author$project$Spa$Generated$Pages$save = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).iN(0);
};
...
var $author$project$Api$Homework$User$logout = function (options) {
	return $elm$http$Http$riskyRequest(
		{
			a6: $elm$http$Http$emptyBody,
			bb: $elm$http$Http$expectWhatever(options.d9),
			be: _List_Nil,
			bf: 'POST',
			bk: $elm$core$Maybe$Nothing,
			bn: $elm$core$Maybe$Nothing,
			...
			case 1:
				return _Utils_Tuple2(
					...
					$author$project$Api$Homework$User$logout(
						{d9: $author$project$Shared$GotLogoutData}));
			case 2:
				var w = msg.a;
				var h = msg.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							hr: $author$project$Shared$classifyDevice(
								{hK: h, jD: w})
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.jy.jA, msg, model);
					} else {
						break _v0$7;
					}
				case 1:
					if (_v0.b.$ === 1) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.cS.jA, msg, model);
					} else {
						break _v0$7;
					}
				case 2:
					if (_v0.b.$ === 2) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.c4.jA, msg, model);
					} else {
						break _v0$7;
					}
				case 3:
					if (_v0.b.$ === 3) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.c8.jA, msg, model);
					} else {
						break _v0$7;
					}
				case 4:
					if (_v0.b.$ === 4) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.dg.jA, msg, model);
					} else {
						break _v0$7;
					}
				case 5:
					if (_v0.b.$ === 5) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.cT.jA, msg, model);
					} else {
						break _v0$7;
					}
				default:
					if (_v0.b.$ === 6) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.cU.jA, msg, model);
					} else {
						break _v0$7;
					}
			}
				...
				if (!maybeUser.$) {
					return _List_fromArray(
						[
							...
							A3($author$project$Shared$navBarElement, $author$project$Shared$viewHomeButton, options.ju, '/')),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$Events$onClick(
									options.ju($author$project$Shared$Logout))
								]),
							A3(
								$author$project$Shared$navBarElement,
...
var $author$project$Spa$Generated$Pages$view = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).jB(0);
};
var $author$project$Main$view = function (model) {
	return A2(
		$author$project$Shared$view,
		{
			...
			ju: $author$project$Main$Shared
		},
		model.am);
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		hV: $author$project$Main$init,
		is: $author$project$Main$UrlChanged,
		it: $author$project$Main$LinkClicked,
		i7: $author$project$Main$subscriptions,
		jA: $author$project$Main$update,
		jB: A2($elm$core$Basics$composeR, $author$project$Main$view, $author$project$Spa$Document$toBrowserDocument)
	});
