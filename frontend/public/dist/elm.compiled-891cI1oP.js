...
{
	if (region.fl.cM === region.fX.cM)
	{
		return 'on line ' + region.fl.cM;
	}
	return 'on lines ' + region.fl.cM + ' through ' + region.fX.cM;
}
	...
	return _Platform_initialize(
		...
		function(sendToApp, initialModel) {
			...
			return _Browser_makeAnimator(initialModel, function(model)
			{
				...
				(title !== doc.kb) && (_VirtualDom_doc.title = title = doc.kb);
			});
		}
	);
});
...
{
	var onUrlChange = impl.jg;
	var onUrlRequest = impl.jh;
	...
	return _Browser_document({
		...
		iJ: function(flags)
		{
			return A3(impl.iJ, flags, _Browser_getUrl(), key);
		},
		kl: impl.kl,
		kk: impl.kk,
		jU: impl.jU
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { iC: 'hidden', h$: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { iC: 'mozHidden', h$: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { iC: 'msHidden', h$: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { iC: 'webkitHidden', h$: 'webkitvisibilitychange' }
		: { iC: 'hidden', h$: 'visibilitychange' };
}
...
function _Browser_getViewport()
{
	return {
		...
		hk: {
			...
			kn: _Browser_doc.documentElement.clientWidth,
...
function _Browser_getScene()
{
	...
	return {
		kn: Math.max(body.scrollWidth, body.offsetWidth, elem.scrollWidth, elem.offsetWidth, elem.clientWidth),
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.a7, request.bq, true);
		} catch (e) {
...
function _Http_track(router, xhr, tracker)
{
	...
	xhr.addEventListener('progress', function(event) {
		...
		_Scheduler_rawSpawn(A2($elm$core$Platform$sendToSelf, router, _Utils_Tuple2(tracker, $elm$http$Http$Receiving({
			jr: event.loaded,
			g4: event.lengthComputable ? $elm$core$Maybe$Just(event.total) : $elm$core$Maybe$Nothing
		}))));
	});
}
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{w: nodeList, t: (len / $elm$core$Array$branchFactor) | 0, v: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {f2: fragment, f8: host, gI: path, gK: port_, gQ: protocol, e6: query};
	});
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {bA: frag, jo: params, bp: unvisited, aR: value, bN: visited};
	});
var $elm$url$Url$Parser$getFirstMatch = function (states) {
	...
	while (true) {
		if (!states.b) {
			...
			var _v1 = state.bp;
			if (!_v1.b) {
				return $elm$core$Maybe$Just(state.aR);
			} else {
				if ((_v1.a === '') && (!_v1.b.b)) {
					return $elm$core$Maybe$Just(state.aR);
				} else {
		...
		return $elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					...
					_List_Nil,
					$elm$url$Url$Parser$preparePath(url.gI),
...
var $author$project$Shared$Model = F5(
	function (url, key, user, device, overrideLoggedInRedirect) {
		return {ii: device, iU: key, gF: overrideLoggedInRedirect, bq: url, hg: user};
	});
var $author$project$Shared$Desktop = 2;
var $author$project$Shared$Device = F4(
	function (_class, orientation, width, height) {
		return {h1: _class, iA: height, jl: orientation, kn: width};
	});
...
var $author$project$Shared$classifyDevice = function (options) {
	return (options.kn < 900) ? A4($author$project$Shared$Device, 0, 0, options.kn, options.iA) : ((options.kn < 1400) ? A4($author$project$Shared$Device, 1, 0, options.kn, options.iA) : A4($author$project$Shared$Device, 2, 1, options.kn, options.iA));
};
				...
				switch (response.$) {
					...
					case 3:
						...
						if (!_v1.$) {
							var value = _v1.a;
							return $elm$core$Result$Err(
								A2($author$project$Api$BadStatus, metadata.fm, value));
						} else {
							var err = _v1.a;
							return $elm$core$Result$Err(
								A2(
...
var $elm$http$Http$riskyRequest = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{hH: true, aZ: r.aZ, a3: r.a3, a4: r.a4, a7: r.a7, bi: r.bi, bn: r.bn, bq: r.bq}));
};
var $author$project$Models$User = F5(
	function (id, username, email, privilege, moodleUrl) {
		return {fW: email, iF: id, i0: moodleUrl, gM: privilege, fx: username};
	});
	...
	return $elm$http$Http$riskyRequest(
		{
			...
			a3: A2($author$project$Api$expectJson, options.gB, $author$project$Api$Homework$User$userDecoder),
			a4: _List_Nil,
			a7: 'GET',
			bi: $elm$core$Maybe$Nothing,
			bn: $elm$core$Maybe$Nothing,
			bq: $author$project$Api$Api$apiAddress + '/user'
		});
};
		...
		return _Utils_Tuple2(
			A5(
				...
				$author$project$Shared$classifyDevice(
					{iA: flags.iA, kn: flags.kn}),
				false),
			$author$project$Api$Homework$User$getUserFromSession(
				{gB: $author$project$Shared$GotUser}));
	});
...
var $author$project$Models$Course = F5(
	function (id, name, assignments, fromMoodle, user) {
		return {hL: assignments, iw: fromMoodle, iF: id, i1: name, hg: user};
	});
var $author$project$Models$Assignment = F8(
	function (id, courseId, user, title, dueDate, fromMoodle, doneBy, doneByUsers) {
		return {ia: courseId, ij: doneBy, ik: doneByUsers, im: dueDate, iw: fromMoodle, iF: id, kb: title, hg: user};
	});
	...
	function (defaultOffset, posixMinutes, eras) {
		...
		while (true) {
			if (!eras.b) {
				...
				if (_Utils_cmp(era.fl, posixMinutes) < 0) {
...
var $author$project$Api$Homework$Course$assignmentDecoder = A9(
	...
	A2(
		$elm$json$Json$Decode$field,
		'done_by_users',
		$elm$json$Json$Decode$list($author$project$Api$Homework$User$userDecoder)));
	...
	return $elm$http$Http$riskyRequest(
		{
			...
			bi: $elm$core$Maybe$Nothing,
			bn: $elm$core$Maybe$Nothing,
			bq: $author$project$Api$Api$apiAddress + '/courses/active?expandUsers'
		});
};
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				bi: $elm$core$Maybe$Nothing,
				bn: $elm$core$Maybe$Nothing,
				bq: $author$project$Api$Api$apiAddress + ('/assignments?days=' + $elm$core$String$fromInt(maxDays))
			});
	});
...
var $author$project$Api$Homework$Assignment$getContributors = function (onResponse) {
	return $elm$http$Http$riskyRequest(
		{
			aZ: $elm$http$Http$emptyBody,
			a3: A2($author$project$Api$expectJson, onResponse, $author$project$Api$Homework$Assignment$contributorsDecoder),
			a4: _List_Nil,
			a7: 'GET',
			bi: $elm$core$Maybe$Nothing,
			bn: $elm$core$Maybe$Nothing,
			bq: $author$project$Api$Api$apiAddress + '/assignments/contributors'
		});
};
	...
	return $elm$http$Http$riskyRequest(
		{
			...
			bi: $elm$core$Maybe$Nothing,
			bn: $elm$core$Maybe$Nothing,
			bq: $author$project$Api$Api$apiAddress + '/courses/stats'
		});
};
...
var $author$project$Pages$Dashboard$initCommands = _List_fromArray(
	[
		...
		{gB: $author$project$Pages$Dashboard$GotCourseData}),
...
var $author$project$Pages$Dashboard$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{
				bu: 0,
				cn: $author$project$Api$Loading,
				bR: $author$project$Api$NotAsked,
				bS: false,
				cv: $author$project$Api$Loading,
				D: $author$project$Api$Loading,
				ds: $author$project$Api$Loading,
				dt: $author$project$Api$NotAsked,
				aD: '',
				ii: shared.ii,
				bz: '',
				e: _List_Nil,
				eG: $author$project$Api$NotAsked,
				b3: $elm$core$Maybe$Nothing,
				bg: $author$project$Api$NotAsked,
				aL: '',
				...
				cf: 0,
				bj: '',
				J: A3($justinmimbs$date$Date$fromCalendarDate, 2019, 0, 1),
				bq: url,
				hg: shared.hg,
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				a3: A2($author$project$Api$expectJson, onResponse, $author$project$Api$Homework$Course$assignmentDecoder),
				a4: _List_Nil,
				a7: 'PUT',
				bi: $elm$core$Maybe$Nothing,
				bn: $elm$core$Maybe$Nothing,
				bq: $author$project$Api$Api$apiAddress + ('/assignment/' + id)
			});
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'title',
				$elm$json$Json$Encode$string(assignment.kb)),
				_Utils_Tuple2(
				'course',
				$elm$json$Json$Encode$int(assignment.ia)),
				_Utils_Tuple2(
				'due_date',
				$elm$json$Json$Encode$int(
					$author$project$Api$Homework$Assignment$dateEncoder(assignment.im))),
				_Utils_Tuple2(
				'from_moodle',
				$elm$json$Json$Encode$bool(assignment.iw))
			]));
};
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				a3: A2($author$project$Api$expectJson, options.gB, $author$project$Api$Homework$Course$assignmentDecoder),
				a4: _List_Nil,
				a7: 'POST',
				bi: $elm$core$Maybe$Nothing,
				bn: $elm$core$Maybe$Nothing,
				bq: $author$project$Api$Api$apiAddress + '/assignment'
			});
	});
		...
		while (true) {
			...
			if (_Utils_cmp(
				...
				return A2(
					$elm$core$Array$builderToArray,
					true,
					{w: nodeList, t: nodeListSize, v: jsArray});
			} else {
...
var $author$project$Api$Homework$Assignment$markAssignmentDone = F3(
	function (id, done, onResponse) {
		return $elm$http$Http$riskyRequest(
			{
				aZ: $elm$http$Http$emptyBody,
				a3: A2($author$project$Api$expectJson, onResponse, $author$project$Api$Homework$Course$assignmentDecoder),
				...
				bi: $elm$core$Maybe$Nothing,
				bn: $elm$core$Maybe$Nothing,
				bq: $author$project$Api$Api$apiAddress + ('/assignment/' + (id + ('/' + (done ? 'done' : 'undone'))))
			});
	});
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				bi: $elm$core$Maybe$Nothing,
				bn: $elm$core$Maybe$Nothing,
				bq: $author$project$Api$Api$apiAddress + ('/assignment?id=' + id)
			});
	});
var $author$project$Api$Homework$Course$MinimalCourse = F3(
	function (id, name, fromMoodle) {
		return {iw: fromMoodle, iF: id, i1: name};
	});
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				bi: $elm$core$Maybe$Nothing,
				bn: $elm$core$Maybe$Nothing,
				bq: $author$project$Api$Api$apiAddress + ('/courses/search/' + searchterm)
			});
	});
...
var $justinmimbs$date$Date$toOrdinalDate = function (_v0) {
	...
	return {
		eR: rd - $justinmimbs$date$Date$daysBeforeYear(y),
		hs: y
	};
};
var $justinmimbs$date$Date$toCalendarDate = function (_v0) {
	...
	return A3($justinmimbs$date$Date$toCalendarDateHelp, date.hs, 0, date.eR);
};
...
var $justinmimbs$date$Date$toWeekDate = function (_v0) {
	...
	return {
		hl: 1 + (((rd - week1Day1) / 7) | 0),
		hm: wy,
		km: $justinmimbs$date$Date$numberToWeekday(wdn)
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {fO: col, h9: contextStack, gN: problem, gX: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.gX, s.fO, x, s.g));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.gX, s.fO, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{fO: newCol, g: s.g, l: s.l, b: newOffset, gX: newRow, a: s.a});
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{fO: 1, g: s.g, l: s.l, b: s.b + 1, gX: s.gX + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{fO: s.fO + 1, g: s.g, l: s.l, b: newOffset, gX: s.gX, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{fO: col, g: s0.g, l: s0.l, b: offset, gX: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.gX, s.fO, s);
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {fO: col, gN: problem, gX: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.gX, p.fO, p.gN);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{fO: 1, g: _List_Nil, l: 1, b: 0, gX: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
			return $elm$core$Result$Ok(value);
		} else {
...
var $justinmimbs$date$Date$language_en = {
	ec: $justinmimbs$date$Date$withOrdinalSuffix,
	eM: $justinmimbs$date$Date$monthToName,
	dK: A2(
		$elm$core$Basics$composeR,
		$justinmimbs$date$Date$monthToName,
		$elm$core$String$left(3)),
	fy: $justinmimbs$date$Date$weekdayToName,
	bO: A2(
		$elm$core$Basics$composeR,
	...
	function (msg, model) {
		switch (msg.$) {
				...
				if (data.$ === 2) {
					...
					if (e.$ === 3) {
						...
						return ((s === 401) || (s === 403)) ? _Utils_Tuple2(
							model,
							A2($author$project$Utils$Route$navigate, model.bq.iU, 2)) : _Utils_Tuple2(
							_Utils_update(
								model,
								{D: data}),
							$elm$core$Platform$Cmd$none);
			...
			case 1:
				...
				return $elm$core$String$isEmpty(
					...
					_Utils_update(
						model,
						{
							e: A2($elm$core$List$member, errorMsg, model.e) ? model.e : A2(
					...
					$elm$core$Platform$Cmd$none) : (_Utils_eq(model.aM, $elm$core$Maybe$Nothing) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							e: A2($elm$core$List$member, errorMsg, model.e) ? model.e : A2(
					...
					A2(
						...
						text,
						{gB: $author$project$Pages$Dashboard$GotSearchCoursesData})) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							e: A2(
					...
					A2(
						$author$project$Api$Homework$Course$searchCourses,
						text,
						{gB: $author$project$Pages$Dashboard$GotSearchCoursesData})));
			case 3:
				var course = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 4:
				...
				return $elm$core$String$isEmpty(
					$elm$core$String$trim(text)) ? (A2($elm$core$List$member, errorMsg, model.e) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{bj: text}),
				...
				if (!_v3.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								bu: ($justinmimbs$date$Date$toRataDie(date) - epochStartOffset) - ($justinmimbs$date$Date$toRataDie(model.J) - epochStartOffset),
								aD: text,
								e: A2(
									$elm$core$List$append,
									A2(
										...
										model.e),
									((($justinmimbs$date$Date$toRataDie(date) - epochStartOffset) - ($justinmimbs$date$Date$toRataDie(model.J) - epochStartOffset)) < 0) ? _List_fromArray(
										[errorMsg2]) : _List_Nil),
								aN: $elm$core$Maybe$Just(date),
								aO: $elm$time$Time$millisToPosix(
									($elm$core$Basics$floor(
										$justinmimbs$date$Date$toRataDie(date) - epochStartOffset) * (((1000 * 60) * 60) * 24)) - (((1000 * 60) * 60) * 24))
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return A2($elm$core$List$member, errorMsg, model.e) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{
								bu: 0,
								...
								aO: $elm$time$Time$millisToPosix(
									($elm$core$Basics$floor(
										$justinmimbs$date$Date$toRataDie(model.J) - epochStartOffset) * (((1000 * 60) * 60) * 24)) - (((1000 * 60) * 60) * 24))
							}),
						$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						_Utils_update(
							model,
			...
			case 9:
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							aO: time,
							J: A2($justinmimbs$date$Date$fromPosix, model.cl, time)
						}),
					$elm$core$Platform$Cmd$none);
			case 10:
				var zone = msg.a;
				...
				if (!_v4.$) {
					...
					if (!_v5.$) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{aD: '', e: _List_Nil, bg: $author$project$Api$NotAsked, aL: '', aM: $elm$core$Maybe$Nothing, aN: $elm$core$Maybe$Nothing}),
							A2(
								$author$project$Api$Homework$Assignment$createAssignment,
								{ia: course.iF, im: dueDate, iw: course.iw, kb: model.bj},
								{gB: $author$project$Pages$Dashboard$GotCreateAssignmentData}));
					} else {
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Api$Homework$Course$getActiveCourses(
								{gB: $author$project$Pages$Dashboard$GotCourseData}),
								A2($author$project$Api$Homework$Assignment$getAssignments, model.aQ, $author$project$Pages$Dashboard$GotAssignmentData)
							])));
			case 8:
				var epochStartOffset = 719162;
				var date = A2(
					...
					$elm$time$Time$millisToPosix(
						$elm$core$Basics$floor(
							$elm$time$Time$posixToMillis(model.aO) + (((1000 * 60) * 60) * 24))));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							bu: ($justinmimbs$date$Date$toRataDie(date) - epochStartOffset) - ($justinmimbs$date$Date$toRataDie(model.J) - epochStartOffset),
							aD: $author$project$Pages$Dashboard$toGermanDateString(date),
							e: A2(
								$elm$core$List$filter,
								function (error) {
							...
							aO: $elm$time$Time$millisToPosix(
								$elm$core$Basics$floor(
									$justinmimbs$date$Date$toRataDie(
										A2($justinmimbs$date$Date$fromPosix, model.cl, model.aO)) - epochStartOffset) * (((1000 * 60) * 60) * 24))
						}),
					$elm$core$Platform$Cmd$none);
			case 11:
				var id = msg.a;
				return _Utils_Tuple2(
					...
					A2(
						...
						id,
						{gB: $author$project$Pages$Dashboard$GotRemoveAssignmentData}));
			case 12:
				var data = msg.a;
				if (data.$ === 3) {
												...
												return _Utils_update(
													c,
													{
														hL: A2(
															$elm$core$List$filter,
															function (a) {
																return !_Utils_eq(a.iF, assignment.iF);
															},
															c.hL)
													});
											},
			...
			case 24:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{cn: $author$project$Api$Loading, aQ: days}),
			...
			case 16:
				...
				if (_v8.$ === 3) {
					...
					return _Utils_Tuple2(
											...
											return _Utils_update(
												c,
												{
													hL: A2(
														$elm$core$List$map,
														function (a) {
															return _Utils_eq(a.iF, assignmentId) ? _Utils_update(
																a,
																{kb: model.bz}) : a;
														},
														c.hL)
						...
						A3($author$project$Api$Homework$Assignment$changeAssignmentTitle, assignmentId, model.bz, $author$project$Pages$Dashboard$GotChangeAssignmentTitle));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 17:
			...
			case 22:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{bR: $author$project$Api$Loading, eG: data}),
					A2($author$project$Api$Homework$Assignment$getAssignmentByID, id, $author$project$Pages$Dashboard$GotAssignmentModalData));
			case 26:
				var data = msg.a;
				return _Utils_Tuple2(
...
var $mdgriffith$elm_ui$Internal$Model$asColumn = 1;
var $mdgriffith$elm_ui$Internal$Style$classes = {hu: 'a', hv: 'atv', hz: 'ab', hA: 'cx', hB: 'cy', hC: 'acb', hD: 'accx', hE: 'accy', hF: 'acr', fF: 'al', fG: 'ar', hG: 'at', d$: 'ah', d0: 'av', hJ: 's', hP: 'bh', hQ: 'b', hS: 'w7', hU: 'bd', hV: 'bdt', di: 'bn', hW: 'bs', dk: 'cpe', h2: 'cp', h3: 'cpx', h4: 'cpy', a0: 'c', dn: 'ctr', dp: 'cb', dq: 'ccx', a1: 'ccy', cu: 'cl', dr: 'cr', h8: 'ct', ib: 'cptr', ic: 'ctxt', iv: 'fcs', f0: 'focus-within', ix: 'fs', iz: 'g', ek: 'hbh', el: 'hc', f6: 'he', em: 'hf', f7: 'hfp', iD: 'hv', iG: 'ic', iI: 'fr', dB: 'lbl', iL: 'iml', iM: 'imlf', iN: 'imlp', iO: 'implw', iP: 'it', iS: 'i', go: 'lnk', b6: 'nb', gy: 'notxt', jd: 'ol', jf: 'or', bF: 'oq', jn: 'oh', aK: 'pg', gG: 'p', jp: 'ppe', jx: 'ui', gX: 'r', jC: 'sb', jD: 'sbx', jE: 'sby', jG: 'sbt', jL: 'e', jM: 'cap', jN: 'sev', jT: 'sk', dX: 't', jZ: 'tc', j_: 'w8', j$: 'w2', j0: 'w9', j1: 'tj', dY: 'tja', j2: 'tl', j3: 'w3', j4: 'w5', j5: 'w4', j6: 'tr', j7: 'w6', j8: 'w1', j9: 'tun', V: 'ts', bL: 'clr', kj: 'u', fz: 'wc', hn: 'we', fA: 'wf', ho: 'wfp', fB: 'wrp'};
var $mdgriffith$elm_ui$Internal$Model$Generic = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$div = $mdgriffith$elm_ui$Internal$Model$Generic;
var $mdgriffith$elm_ui$Internal$Model$NoNearbyChildren = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.hJ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a0);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.hJ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.iz);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.hJ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aK);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.hJ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.gG);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.hJ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.gX);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.hJ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.jL);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.jy)) + ('-cols-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.az)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.jO.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.jO.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.gX) + ('-' + ($elm$core$String$fromInt(pos.fO) + ('-' + ($elm$core$String$fromInt(pos.kn) + ('-' + $elm$core$String$fromInt(pos.iA)))))));
		case 11:
...
var $mdgriffith$elm_ui$Internal$Model$formatBoxShadow = function (shadow) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					shadow.ge ? $elm$core$Maybe$Just('inset') : $elm$core$Maybe$Nothing,
					$elm$core$Maybe$Just(
					...
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.g4) + 'px'),
					$elm$core$Maybe$Just(
					$mdgriffith$elm_ui$Internal$Model$formatColor(shadow.bU))
				])));
};
...
var $mdgriffith$elm_ui$Internal$Model$renderFocusStyle = function (focus) {
	return _List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.f0) + ':focus-within',
			A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				_List_fromArray(
			...
			A2(
			$mdgriffith$elm_ui$Internal$Model$Style,
			$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.hJ) + (':focus .focusable, ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.hJ) + '.focusable:focus')),
			A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Style$baseSheet = _List_fromArray(
	[
		...
		A2(
		$mdgriffith$elm_ui$Internal$Style$Class,
		$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.hJ) + ':focus',
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.iD, $mdgriffith$elm_ui$Internal$Style$classes.bL)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.iD, $mdgriffith$elm_ui$Internal$Style$classes.bF)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.iv, $mdgriffith$elm_ui$Internal$Style$classes.bL)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.iv, $mdgriffith$elm_ui$Internal$Style$classes.bF)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.hv, $mdgriffith$elm_ui$Internal$Style$classes.bL)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.hv, $mdgriffith$elm_ui$Internal$Style$classes.bF)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				_List_fromArray(
					[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.hF,
						_List_fromArray(
							[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:first-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.hD,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.hD,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:only-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.hD,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + ($mdgriffith$elm_ui$Internal$Style$classes.hD + ' ~ u'),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + ($mdgriffith$elm_ui$Internal$Style$classes.hF + (' ~ s.' + $mdgriffith$elm_ui$Internal$Style$classes.hD)),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
				...
				_List_fromArray(
					[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.hC,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1')
							])),
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:first-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.hE,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.hE,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:only-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.hE,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + ($mdgriffith$elm_ui$Internal$Style$classes.hE + ' ~ u'),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + ($mdgriffith$elm_ui$Internal$Style$classes.hC + (' ~ s.' + $mdgriffith$elm_ui$Internal$Style$classes.hE)),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
				...
				_List_fromArray(
					[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.hJ + ':first-child'),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						$mdgriffith$elm_ui$Internal$Style$Child,
						$mdgriffith$elm_ui$Internal$Style$dot(
							$mdgriffith$elm_ui$Internal$Style$classes.hJ + ($mdgriffith$elm_ui$Internal$Style$selfName(3) + (':first-child + .' + $mdgriffith$elm_ui$Internal$Style$classes.hJ))),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						$mdgriffith$elm_ui$Internal$Style$Child,
						$mdgriffith$elm_ui$Internal$Style$dot(
							$mdgriffith$elm_ui$Internal$Style$classes.hJ + ($mdgriffith$elm_ui$Internal$Style$selfName(2) + (':first-child + .' + $mdgriffith$elm_ui$Internal$Style$classes.hJ))),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
...
var $mdgriffith$elm_ui$Internal$Style$explainer = '\n.explain {\n    border: 6px solid rgb(174, 121, 15) !important;\n}\n.explain > .' + ($mdgriffith$elm_ui$Internal$Style$classes.hJ + (' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n.ctr {\n    border: none !important;\n}\n.explain > .ctr > .' + ($mdgriffith$elm_ui$Internal$Style$classes.hJ + ' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n')));
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.hJ) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gX) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.hJ) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.hJ) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gX) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.hJ) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dn) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {dm: closing, B: _List_Nil, be: _List_Nil, ar: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								B: A2(
									$elm$core$List$cons,
									{dm: '\n}', B: _List_Nil, be: props, ar: '@supports (' + (prop + (':' + (value + (') {' + parent.ar))))},
									rendered.B)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.ar + ('{' + (renderValues(rule.be) + (rule.dm + '}')));
		}
	};
...
var $mdgriffith$elm_ui$Internal$Model$hasSmallCaps = function (typeface) {
	if (typeface.$ === 5) {
		var font = typeface.a;
		return A2($elm$core$List$any, $mdgriffith$elm_ui$Internal$Model$isSmallCaps, font.hi);
	} else {
		return false;
	}
};
			...
			switch (pseudo) {
				...
				case 0:
					var renderedProps = A3(
						...
						props);
					return _List_fromArray(
						[selector + ('-fs:focus {' + (renderedProps + '\n}')), ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.hJ + (':focus ' + (selector + '-fs  {')))) + (renderedProps + '\n}'), (selector + '-fs:focus-within {') + (renderedProps + '\n}'), ('.focusable-parent:focus ~ ' + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.hJ + (' ' + (selector + '-fs {'))))) + (renderedProps + '\n}')]);
				default:
					return _List_fromArray(
						[
	...
	if (typeface.$ === 5) {
		...
		return $elm$core$Maybe$Just(
			A2(
				$elm$core$String$join,
				', ',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$renderVariant, font.hi)));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 5:
				...
				var single = '.' + $mdgriffith$elm_ui$Internal$Style$classes.jL;
				var row = '.' + $mdgriffith$elm_ui$Internal$Style$classes.gX;
				var wrappedRow = '.' + ($mdgriffith$elm_ui$Internal$Style$classes.fB + row);
				var right = '.' + $mdgriffith$elm_ui$Internal$Style$classes.fG;
				var paragraph = '.' + $mdgriffith$elm_ui$Internal$Style$classes.gG;
				var page = '.' + $mdgriffith$elm_ui$Internal$Style$classes.aK;
				var left = '.' + $mdgriffith$elm_ui$Internal$Style$classes.fF;
				var halfY = $elm$core$String$fromFloat(y / 2) + 'px';
				var halfX = $elm$core$String$fromFloat(x / 2) + 'px';
				var column = '.' + $mdgriffith$elm_ui$Internal$Style$classes.a0;
				var _class = '.' + cls;
				var any = '.' + $mdgriffith$elm_ui$Internal$Style$classes.hJ;
				return $elm$core$List$concat(
					_List_fromArray(
						[
							A4(
			...
			case 8:
				...
				var xSpacing = toGridLength(template.jO.a);
				var ySpacing = toGridLength(template.jO.b);
				var rows = function (x) {
				...
				var msColumns = function (x) {
					...
					A2(
						...
						ySpacing,
						A2($elm$core$List$map, toGridLength, template.az)));
				var gapY = 'grid-row-gap:' + (toGridLength(template.jO.b) + ';');
				var gapX = 'grid-column-gap:' + (toGridLength(template.jO.a) + ';');
			...
			case 9:
				...
				var msPosition = A2(
					...
					_List_fromArray(
						[
							'-ms-grid-row: ' + ($elm$core$String$fromInt(position.gX) + ';'),
							'-ms-grid-row-span: ' + ($elm$core$String$fromInt(position.iA) + ';'),
							'-ms-grid-column: ' + ($elm$core$String$fromInt(position.fO) + ';'),
							'-ms-grid-column-span: ' + ($elm$core$String$fromInt(position.kn) + ';')
						]));
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.gX) + (' / ' + ($elm$core$String$fromInt(position.gX + position.iA) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.fO) + (' / ' + ($elm$core$String$fromInt(position.fO + position.kn) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.gX) + ('-' + ($elm$core$String$fromInt(position.fO) + ('-' + ($elm$core$String$fromInt(position.kn) + ('-' + $elm$core$String$fromInt(position.iA)))))));
...
var $mdgriffith$elm_ui$Internal$Model$renderFontAdjustmentRule = F3(
	function (fontToAdjust, _v0, otherFontName) {
		...
		return A2(
			...
			' ',
			_Utils_ap(
				A3($mdgriffith$elm_ui$Internal$Model$fontRule, name, $mdgriffith$elm_ui$Internal$Style$classes.jM, capital),
				A3($mdgriffith$elm_ui$Internal$Model$fontRule, name, $mdgriffith$elm_ui$Internal$Style$classes.ix, full)));
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.jM + (', ' + ('.' + (name + (' .' + $mdgriffith$elm_ui$Internal$Style$classes.jM))))))),
					_List_fromArray(
						[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.jM + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.dX + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.jM + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.dX)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {iA: height / size, g4: size, hj: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.hZ, adjustment.hO, adjustment.ih, adjustment.iY]);
	var lineHeight = 1.5;
	...
	return {
		hZ: A3($mdgriffith$elm_ui$Internal$Model$adjust, capitalSize, ascender - newBaseline, capitalVertical),
		f3: A3($mdgriffith$elm_ui$Internal$Model$adjust, fullSize, ascender - descender, fullVertical)
	};
};
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'line-height',
				$elm$core$String$fromFloat(converted.iA)),
				_Utils_Tuple2(
				'vertical-align',
				$elm$core$String$fromFloat(converted.hj) + 'em'),
				_Utils_Tuple2(
				'font-size',
				$elm$core$String$fromFloat(converted.g4) + 'em')
			]));
};
	...
	function (_static, opts, styles, children) {
		var dynamicStyleSheet = A2(
			...
			A3(
				...
				_Utils_Tuple2(
					$elm$core$Set$empty,
					$mdgriffith$elm_ui$Internal$Model$renderFocusStyle(opts.iv)),
				styles).b);
		return _static ? A2(
			$elm$core$List$cons,
			_Utils_Tuple2(
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.hJ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.jL))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.hJ, $mdgriffith$elm_ui$Internal$Style$classes.jL, $mdgriffith$elm_ui$Internal$Style$classes.dn, $mdgriffith$elm_ui$Internal$Style$classes.a1, $mdgriffith$elm_ui$Internal$Style$classes.hF])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.hJ, $mdgriffith$elm_ui$Internal$Style$classes.jL, $mdgriffith$elm_ui$Internal$Style$classes.dn, $mdgriffith$elm_ui$Internal$Style$classes.a1, $mdgriffith$elm_ui$Internal$Style$classes.hD])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.hJ, $mdgriffith$elm_ui$Internal$Style$classes.jL, $mdgriffith$elm_ui$Internal$Style$classes.dn, $mdgriffith$elm_ui$Internal$Style$classes.hE])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.hJ, $mdgriffith$elm_ui$Internal$Style$classes.jL, $mdgriffith$elm_ui$Internal$Style$classes.dn, $mdgriffith$elm_ui$Internal$Style$classes.hC])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.hJ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dX + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.fz + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.el)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.hJ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dX + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.fA + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.em)))));
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.iE, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
				...
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Keyed(
							A3($mdgriffith$elm_ui$Internal$Model$addKeyedChildren, 'nearby-element-pls', keyed, rendered.h0)),
				...
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Unkeyed(
							A2($mdgriffith$elm_ui$Internal$Model$addChildren, unkeyed, rendered.h0)),
						$mdgriffith$elm_ui$Internal$Model$NoStyleSheet));
			} else {
				var allStyles = newStyles;
				return $mdgriffith$elm_ui$Internal$Model$Styled(
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.b6, $mdgriffith$elm_ui$Internal$Style$classes.jL, $mdgriffith$elm_ui$Internal$Style$classes.hu]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.b6, $mdgriffith$elm_ui$Internal$Style$classes.jL, $mdgriffith$elm_ui$Internal$Style$classes.hQ]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.b6, $mdgriffith$elm_ui$Internal$Style$classes.jL, $mdgriffith$elm_ui$Internal$Style$classes.jf]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.b6, $mdgriffith$elm_ui$Internal$Style$classes.jL, $mdgriffith$elm_ui$Internal$Style$classes.jd]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.b6, $mdgriffith$elm_ui$Internal$Style$classes.jL, $mdgriffith$elm_ui$Internal$Style$classes.iI]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.b6, $mdgriffith$elm_ui$Internal$Style$classes.jL, $mdgriffith$elm_ui$Internal$Style$classes.hP]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.iE, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, $mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.d$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fF);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.d$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fG);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.d$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.hA);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.d0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.hG);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.d0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.hz);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.d0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.hB);
	}
};
	...
	switch (h.$) {
		case 0:
			...
			return _Utils_Tuple3(
				...
				$mdgriffith$elm_ui$Internal$Style$classes.f6 + (' ' + name),
				_List_fromArray(
					[
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$heightFill, $mdgriffith$elm_ui$Internal$Flag$none),
				$mdgriffith$elm_ui$Internal$Style$classes.f7 + (' height-fill-' + $elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.hJ + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.a0 + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Internal$Model$renderWidth = function (w) {
	switch (w.$) {
		case 0:
			...
			return _Utils_Tuple3(
				$mdgriffith$elm_ui$Internal$Flag$none,
				$mdgriffith$elm_ui$Internal$Style$classes.hn + (' width-px-' + $elm$core$String$fromInt(px)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_Nil) : _Utils_Tuple3(
				A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$widthFill, $mdgriffith$elm_ui$Internal$Flag$none),
				$mdgriffith$elm_ui$Internal$Style$classes.ho + (' width-fill-' + $elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.hJ + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.gX + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
					...
					case 7:
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$width, has)) {
							...
							switch (width.$) {
								case 0:
									var px = width.a;
									var $temp$classes = ($mdgriffith$elm_ui$Internal$Style$classes.hn + (' width-px-' + $elm$core$String$fromInt(px))) + (' ' + classes),
										$temp$node = node,
									...
									continue gatherAttrRecursive;
								case 1:
									var $temp$classes = classes + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fz),
										$temp$node = node,
										$temp$has = A2(
								...
								case 2:
									var portion = width.a;
									if (portion === 1) {
										var $temp$classes = classes + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fA),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.ho + (' width-fill-' + $elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
											$mdgriffith$elm_ui$Internal$Flag$widthFill,
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$height, has)) {
							...
							switch (height.$) {
								case 0:
									...
									var name = 'height-px-' + val;
									var $temp$classes = $mdgriffith$elm_ui$Internal$Style$classes.f6 + (' ' + (name + (' ' + classes))),
										$temp$node = node,
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.f7 + (' height-fill-' + $elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
											$mdgriffith$elm_ui$Internal$Flag$heightFill,
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.h8 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cu)),
				A2(
					$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cu + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a1)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $author$project$Pages$Dashboard$CloseModal = {$: 14};
...
var $author$project$Pages$Dashboard$UnfocusAssignmentTitle = {$: 19};
var $mdgriffith$elm_ui$Internal$Model$Class = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
var $mdgriffith$elm_ui$Internal$Flag$fontWeight = $mdgriffith$elm_ui$Internal$Flag$flag(13);
var $mdgriffith$elm_ui$Element$Font$bold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.hS);
var $mdgriffith$elm_ui$Internal$Flag$fontAlignment = $mdgriffith$elm_ui$Internal$Flag$flag(12);
var $mdgriffith$elm_ui$Element$Font$center = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontAlignment, $mdgriffith$elm_ui$Internal$Style$classes.jZ);
...
var $mdgriffith$elm_ui$Element$pointer = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$cursor, $mdgriffith$elm_ui$Internal$Style$classes.ib);
...
var $mdgriffith$elm_ui$Element$clip = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.h2);
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {cr: -box.cr, cK: -box.cK, cW: -box.cW, c6: -box.c6};
};
	...
	function (isMultiline, stacked, attrs) {
		return function (redist) {
			...
			A3(
				...
				{Y: _List_Nil, p: _List_Nil, A: _List_Nil, d: _List_Nil, ck: _List_Nil},
				attrs));
	});
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.gy + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.jp)),
...
var $mdgriffith$elm_ui$Element$scrollbarY = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.jE);
...
var $mdgriffith$elm_ui$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
		...
		var redistributed = A3(
			...
			$mdgriffith$elm_ui$Element$Input$isStacked(textOptions.iV),
			withDefaults);
		...
		var inputElement = A4(
			...
			_Utils_ap(
					...
					if (!_v4.$) {
						...
						return _List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.iP)
							]);
					} else {
						return _List_fromArray(
							[
				...
				_Utils_ap(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Input$value(textOptions.dX),
							$mdgriffith$elm_ui$Internal$Model$Attr(
							$elm$html$Html$Events$onInput(textOptions.dN)),
							$mdgriffith$elm_ui$Element$Input$hiddenLabelAttribute(textOptions.iV),
					...
					_Utils_ap(
						(heightConstrained ? $elm$core$List$cons($mdgriffith$elm_ui$Element$scrollbarY) : $elm$core$Basics$identity)(
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
									A2($elm$core$List$any, $mdgriffith$elm_ui$Element$Input$hasFocusStyle, withDefaults) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.f0),
									...
									function () {
										if (textOptions.dX === '') {
											...
											if (_v1.$ === 1) {
												...
												return _List_fromArray(
													[
														A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, _List_Nil, textOptions.dX === '')
													]);
											}
										} else {
											return _List_fromArray(
												[
													...
													A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.iM)
															]),
														_List_fromArray(
															[
																$elm$html$Html$text(textOptions.dX + '\u00A0')
															])))
												]);
										}
									}()))
										...
										if (_v2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.Y, textOptions.dX === ''))
												]);
										}
									}()
									])))),
		...
		return A3(
			...
			A2(
				$elm$core$List$cons,
				A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$cursor, $mdgriffith$elm_ui$Internal$Style$classes.ic),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$Input$isHiddenLabel(textOptions.iV) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : $mdgriffith$elm_ui$Element$spacing(5),
		...
		function (user, color) {
			return A2(
				...
				A2(
					...
					$mdgriffith$elm_ui$Element$text(
						A3($elm$core$String$slice, 0, 1, user.fx))));
		});
	var didIDoThis = F2(
										...
										[
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
																	_Utils_eq(user.iF, assignment.hg.iF) ? $mdgriffith$elm_ui$Element$Events$onClick(
																	$author$project$Pages$Dashboard$FocusAssignmentTitle(assignment.kb)) : $mdgriffith$elm_ui$Element$pointer,
																	$mdgriffith$elm_ui$Element$pointer
																]),
															model.bS ? A2(
																...
																_List_fromArray(
																	[
																		...
																		$author$project$Pages$Dashboard$ChangeAssignmentTitle(assignment.iF),
																		$author$project$Pages$Dashboard$UnfocusAssignmentTitle)
																	]),
																{
																	iV: $mdgriffith$elm_ui$Element$Input$labelHidden('edit assignment title'),
																	dN: $author$project$Pages$Dashboard$ChangeAssignmentTitleTfText,
																...
																$mdgriffith$elm_ui$Element$text(assignment.kb)))
														])),
													A2(
													$mdgriffith$elm_ui$Element$el,
													_List_fromArray(
											...
											$mdgriffith$elm_ui$Element$text(
												'Course: ' + A2(
													$elm$core$Maybe$withDefault,
													'undefined',
													A2($author$project$Pages$Dashboard$getCourseNameById, courses, assignment.ia)))),
											A2(
											$mdgriffith$elm_ui$Element$row,
											_List_fromArray(
												[
											...
											A3(
												...
												assignment.ik,
												colors(
													$elm$core$List$length(assignment.ik)))),
											A2(
											$mdgriffith$elm_ui$Element$row,
											_List_fromArray(
												[
											...
											_Utils_ap(
												_Utils_eq(user.iF, assignment.hg.iF) ? _List_fromArray(
													[
														A3(
														$author$project$Pages$Dashboard$viewButton,
														'[delete]',
														$author$project$Styling$Colors$redColor,
														$author$project$Pages$Dashboard$RemoveAssignment(assignment.iF))
													]) : _List_Nil,
												_List_fromArray(
													[
														A3(
														$author$project$Pages$Dashboard$viewButton,
														A2(didIDoThis, user.iF, assignment.ij) ? '[I didn\'t do this]' : '[I did this]',
														$author$project$Styling$Colors$greenColor,
														A2(
															$author$project$Pages$Dashboard$MarkAssignmentDone,
															assignment.iF,
															!A2(didIDoThis, user.iF, assignment.ij)))
													])))
										]);
								case 1:
									return _List_fromArray(
...
var $gampleman$elm_visualization$Shape$defaultPieConfig = {eb: 0, eh: 2 * $elm$core$Basics$pi, iK: 0, gD: 100, eS: 0, eT: 0, g6: $elm$core$Basics$compare, c0: 0, hh: $elm$core$Basics$identity};
...
var $gampleman$elm_visualization$Shape$Pie$pie = F2(
	function (settings, data) {
		...
		var da = A2(
			...
			A2($elm$core$Basics$max, (-2) * $elm$core$Basics$pi, settings.eh - settings.c0));
		var p = A2(
			$elm$core$Basics$min,
		...
		var computeValue = F2(
			function (el, angle) {
				var value = settings.hh(el);
				return {
					eb: settings.eb,
					eh: (angle + ((value > 0) ? (value * k) : 0)) + pa,
					iK: settings.iK,
					gD: settings.gD,
					eS: p,
					eT: settings.eT,
		...
		return $elm$core$Dict$values(
			A3(
				$elm$core$List$foldl,
				helper,
				_Utils_Tuple2(settings.c0, $elm$core$Dict$empty),
...
var $gampleman$elm_visualization$Shape$Pie$centroid = function (arcData) {
	var r = (arcData.iK + arcData.gD) / 2;
	var a = ((arcData.c0 + arcData.eh) / 2) - ($elm$core$Basics$pi / 2);
	return _Utils_Tuple2(
...
var $author$project$Components$PieChart$pieLabel = F2(
	function (slice, _v0) {
		...
		var _v1 = $gampleman$elm_visualization$Shape$centroid(
			_Utils_update(
				slice,
				{iK: $author$project$Components$PieChart$radius - dings, gD: $author$project$Components$PieChart$radius - dings}));
		var x = _v1.a;
		var y = _v1.b;
		return A2(
...
var $folkertdev$elm_deque$Internal$rebalance = function (deque) {
	...
	if ((sizeF + sizeR) < 2) {
		...
		if (_Utils_cmp(sizeF, (balanceConstant * sizeR) + 1) > 0) {
			...
			return {ab: newFront, ad: newRear, R: size1, S: size2};
		} else {
...
var $folkertdev$one_true_path_experiment$SubPath$with = F2(
	function (moveto, drawtos) {
		return $folkertdev$one_true_path_experiment$SubPath$SubPath(
			{
				fU: $folkertdev$elm_deque$Deque$fromList(drawtos),
				gw: moveto
			});
	});
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									{
									d3: $folkertdev$one_true_path_experiment$LowLevel$Command$largestArc,
									ee: cw,
									bf: _Utils_Tuple2(r, r),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									{
									d3: $gampleman$elm_visualization$Shape$Pie$boolToArc(
...
var $folkertdev$elm_deque$Internal$empty = {ab: _List_Nil, ad: _List_Nil, R: 0, S: 0};
	...
	if (!_v0.b.b) {
		...
		return _Utils_Tuple2(
			...
			$folkertdev$elm_deque$Internal$rebalance(
				{ab: deque.ab, ad: rs, R: deque.R, S: deque.S - 1}));
	}
};
...
var $folkertdev$elm_deque$Deque$pushBack = F2(
	function (elem, _v0) {
		...
		return A2(
			...
			{
				ab: deque.ab,
				ad: A2($elm$core$List$cons, elem, deque.ad),
				R: deque.R,
				S: deque.S + 1
			});
	});
var $folkertdev$one_true_path_experiment$SubPath$close = function (subpath) {
	if (subpath.$ === 1) {
		...
		var moveto = subpath.a.gw;
		var drawtos = subpath.a.fU;
		...
		if ((!_v1.a.$) && (_v1.a.a.$ === 4)) {
			...
			return $folkertdev$one_true_path_experiment$SubPath$SubPath(
				{
					fU: A2($folkertdev$elm_deque$Deque$pushBack, $folkertdev$one_true_path_experiment$LowLevel$Command$closePath, drawtos),
					gw: moveto
				});
		}
	}
...
var $folkertdev$one_true_path_experiment$SubPath$pushBack = F2(
	function (drawto, data) {
		return _Utils_update(
			data,
			{
				fU: A2($folkertdev$elm_deque$Deque$pushBack, drawto, data.fU)
			});
	});
var $folkertdev$elm_deque$Internal$length = function (deque) {
	return deque.R + deque.S;
};
...
var $folkertdev$elm_deque$Deque$append = F2(
	function (p, q) {
		...
		return $folkertdev$elm_deque$Deque$isEmpty(p) ? q : ($folkertdev$elm_deque$Deque$isEmpty(q) ? p : {
			ab: _Utils_ap(
				x.ab,
				$elm$core$List$reverse(x.ad)),
			ad: $elm$core$List$reverse(
				_Utils_ap(
					y.ab,
					$elm$core$List$reverse(y.ad))),
			R: x.R + x.S,
			S: y.R + y.S
		});
	});
var $folkertdev$one_true_path_experiment$SubPath$unsafeConcatenate = F2(
	function (a, b) {
		return _Utils_update(
			a,
			{
				fU: A2($folkertdev$elm_deque$Deque$append, a.fU, b.fU)
			});
	});
...
var $gampleman$elm_visualization$Shape$Pie$cornerTangents = F7(
	function (x0, y0, x1, y1, r1, rc, cw) {
		...
		var fcx = _v0.a;
		var fxy = _v0.b;
		return {O: fcx, P: fxy, ak: -ox, aV: fcx * ((r1 / r) - 1), al: -oy, aX: fxy * ((r1 / r) - 1)};
	});
...
var $folkertdev$elm_deque$Internal$foldl = F3(
	function (f, initial, deque) {
		return function (initial_) {
			return A3($elm$core$List$foldr, f, initial_, deque.ad);
		}(
			A3($elm$core$List$foldl, f, initial, deque.ab));
	});
	...
	function (drawto, state) {
		...
		var maybeUpdateCursor = function (coordinate) {
			return _Utils_update(
				state,
				{
					m: A2($elm$core$Maybe$withDefault, state.m, coordinate)
				});
		};
		var _v0 = state.m;
		var cursorX = _v0.a;
			...
			case 1:
				...
				if (_v2.$ === 1) {
					...
					return _Utils_update(
						...
						{
							m: target,
							C: $elm$core$Maybe$Just(control2)
						});
				}
			case 2:
				var coordinates = drawto.a;
...
var $folkertdev$one_true_path_experiment$SubPath$finalCursorState = function (_v0) {
	...
	var _v1 = moveto;
	var start = _v1;
	var initial = {m: start, C: $elm$core$Maybe$Nothing, fl: start};
...
var $folkertdev$elm_deque$Internal$map = F2(
	function (f, deque) {
		return {
			ab: A2($elm$core$List$map, f, deque.ab),
			ad: A2($elm$core$List$map, f, deque.ad),
			R: deque.R,
			S: deque.S
		};
	});
...
var $ianmackenzie$elm_geometry$Vector2d$minus = F2(
	function (_v0, _v1) {
		var v2 = _v0;
		var v1 = _v1;
		return {hp: v1.hp - v2.hp, hr: v1.hr - v2.hr};
	});
...
var $gampleman$elm_visualization$Shape$Pie$arc = function (arcData) {
	var a1 = arcData.eh - ($elm$core$Basics$pi / 2);
	var a0 = arcData.c0 - ($elm$core$Basics$pi / 2);
	var cw = _Utils_cmp(a1, a0) > 0;
	var da = $elm$core$Basics$abs(a1 - a0);
	var _v0 = (_Utils_cmp(arcData.iK, arcData.gD) > 0) ? _Utils_Tuple2(arcData.gD, arcData.iK) : _Utils_Tuple2(arcData.iK, arcData.gD);
	var r0 = _v0.a;
	var r1 = _v0.b;
	var path = function () {
		if (_Utils_cmp(r1, $gampleman$elm_visualization$Shape$Pie$epsilon) < 1) {
			...
			if (_Utils_cmp(da, (2 * $elm$core$Basics$pi) - $gampleman$elm_visualization$Shape$Pie$epsilon) > 0) {
				...
				var rc = A2(
					...
					arcData.eb);
				var ap = arcData.eS / 2;
				var rp = (_Utils_cmp(ap, $gampleman$elm_visualization$Shape$Pie$epsilon) > 0) ? ((arcData.eT > 0) ? arcData.eT : $elm$core$Basics$sqrt(
					...
					if (_Utils_cmp(da1, $gampleman$elm_visualization$Shape$Pie$epsilon) < 1) {
						...
						if (_Utils_cmp(rc1, $gampleman$elm_visualization$Shape$Pie$epsilon) > 0) {
							...
							var p = A2(
								$folkertdev$one_true_path_experiment$SubPath$with,
								$folkertdev$one_true_path_experiment$LowLevel$Command$moveTo(
									_Utils_Tuple2(t0.O + t0.ak, t0.P + t0.al)),
								_List_Nil);
							return (_Utils_cmp(rc1, rc) < 0) ? A7(
								...
								t0.P,
								rc1,
								A2($elm$core$Basics$atan2, t0.al, t0.ak),
								A2($elm$core$Basics$atan2, t1.al, t1.ak),
								!cw,
								p) : A7(
								$gampleman$elm_visualization$Shape$Pie$makeArc,
								t1.O,
								t1.P,
								rc1,
								A2($elm$core$Basics$atan2, t1.aX, t1.aV),
								A2($elm$core$Basics$atan2, t1.al, t1.ak),
								!cw,
								A7(
									$gampleman$elm_visualization$Shape$Pie$makeArc,
									...
									0,
									r1,
									A2($elm$core$Basics$atan2, t0.P + t0.aX, t0.O + t0.aV),
									A2($elm$core$Basics$atan2, t1.P + t1.aX, t1.O + t1.aV),
									!cw,
									A7(
										$gampleman$elm_visualization$Shape$Pie$makeArc,
										t0.O,
										...
										rc1,
										A2($elm$core$Basics$atan2, t0.al, t0.ak),
										A2($elm$core$Basics$atan2, t0.aX, t0.aV),
										!cw,
										p)));
						} else {
							return A7(
...
var $folkertdev$elm_deque$Internal$toList = function (deque) {
	return _Utils_ap(
		deque.ab,
		$elm$core$List$reverse(deque.ad));
};
	...
	if (subpath.$ === 1) {
		...
		return $folkertdev$one_true_path_experiment$SubPath$SubPath(
			_Utils_update(
				data,
				{
					fU: $folkertdev$one_true_path_experiment$SubPath$compressHelper(data.fU)
				}));
	}
};
var $folkertdev$svg_path_lowlevel$Path$LowLevel$DecimalPlaces = $elm$core$Basics$identity;
var $folkertdev$svg_path_lowlevel$Path$LowLevel$decimalPlaces = $elm$core$Basics$identity;
var $folkertdev$one_true_path_experiment$SubPath$defaultConfig = {dx: $elm$core$Maybe$Nothing, dJ: false};
		...
		return $elm$core$Maybe$Just(
			{
				...
				gw: $folkertdev$one_true_path_experiment$LowLevel$Command$toLowLevelMoveTo(moveto)
			});
	}
};
var $folkertdev$svg_path_lowlevel$Path$LowLevel$defaultConfig = {cH: $elm$core$String$fromFloat};
...
var $folkertdev$svg_path_lowlevel$Path$LowLevel$optionFolder = F2(
	function (option, config) {
		...
		return _Utils_update(
			config,
			{
				cH: $folkertdev$svg_path_lowlevel$Path$LowLevel$roundTo(n)
			});
	});
...
var $folkertdev$svg_path_lowlevel$Path$LowLevel$stringifyCoordinate = F2(
	function (config, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		return config.cH(x) + (',' + config.cH(y));
	});
...
var $folkertdev$svg_path_lowlevel$Path$LowLevel$stringifyEllipticalArcArgument = F2(
	function (config, _v0) {
		var radii = _v0.bf;
		var xAxisRotate = _v0.aW;
		var arcFlag = _v0.d3;
		var direction = _v0.ee;
		var target = _v0.au;
		...
		return A2(
			...
			A2(
				...
				$folkertdev$one_true_path_experiment$SubPath$toLowLevel(
					(config.dJ ? $folkertdev$one_true_path_experiment$SubPath$compress : $elm$core$Basics$identity)(subpath))));
	});
...
var $author$project$Components$PieChart$view = function (model) {
	var pieData = A2(
		...
		_Utils_update(
			...
			{gD: $author$project$Components$PieChart$radius}),
		A2(
			$elm$core$List$map,
			$elm$core$Basics$toFloat,
...
var $mdgriffith$elm_ui$Element$Font$italic = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.iS);
...
var $author$project$Pages$Dashboard$Add1Day = {$: 8};
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.dq + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.a1 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.jG + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.gy)))))),
						A2(
							$elm$core$List$cons,
							$mdgriffith$elm_ui$Element$pointer,
							A2(
...
var $mdgriffith$elm_ui$Element$Border$dotted = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$borderStyle, $mdgriffith$elm_ui$Internal$Style$classes.hV);
...
var $mdgriffith$elm_ui$Element$Border$roundEach = function (_v0) {
	var topLeft = _v0.bk;
	var topRight = _v0.bl;
	var bottomLeft = _v0.a_;
	var bottomRight = _v0.a$;
	return A2(
		$mdgriffith$elm_ui$Internal$Model$StyleClass,
		$mdgriffith$elm_ui$Internal$Flag$borderRound,
		A3(
				...
				iV: A2(
					...
					_List_fromArray(
						[
							...
							{a_: 10, a$: 10, bk: 0, bl: 0}) : $mdgriffith$elm_ui$Element$Border$rounded(0),
					...
					_List_fromArray(
						[
							...
							A2(
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text(course.i1)
									])))
						])),
...
var $author$project$Pages$Dashboard$courseToKeyValue = F2(
	function (last, course) {
		return _Utils_Tuple2(
			$elm$core$String$fromInt(course.iF),
			A2(
				$author$project$Pages$Dashboard$viewSearchDropdownElement,
				course,
				_Utils_eq(course.iF, last.iF)));
	});
...
var $elm$core$Array$appendHelpBuilder = F2(
	function (tail, builder) {
		...
		} : {w: builder.w, t: builder.t, v: appended});
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Pages$Dashboard$viewCreateAssignmentFormErrors(model.e),
				$author$project$Pages$Dashboard$viewCreateAssignmentFormStatus(model.dt),
				A2(
				function () {
					var _v0 = model.ii.h1;
					if (!_v0) {
				...
				_List_fromArray(
					[
							...
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$Background$color($author$project$Pages$Dashboard$inputColor),
										$mdgriffith$elm_ui$Element$Border$width(0),
										_Utils_eq(model.bg, $author$project$Api$NotAsked) ? $mdgriffith$elm_ui$Element$Border$rounded(10) : $mdgriffith$elm_ui$Element$Border$roundEach(
										{a_: 0, a$: 0, bk: 10, bl: 10}),
										$mdgriffith$elm_ui$Element$Font$color(
										A3($mdgriffith$elm_ui$Element$rgb, 1, 1, 1)),
										$mdgriffith$elm_ui$Element$height(
										$mdgriffith$elm_ui$Element$px(50))
									]),
								{
									...
									dN: $author$project$Pages$Dashboard$SearchCourses,
								...
								$author$project$Pages$Dashboard$viewSearchDropdown(model.bg)
							])),
						A2(
						$mdgriffith$elm_ui$Element$Input$text,
						A2(
								...
								[$mdgriffith$elm_ui$Element$alignTop])),
						{
							...
							dN: $author$project$Pages$Dashboard$CAFChangeTitle,
							dS: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
							...
							iV: A2(
								...
								$mdgriffith$elm_ui$Element$text(
									function () {
										var _v1 = model.aN;
										if (!_v1.$) {
											return 'due date (required) -- selected date ' + ($elm$core$String$fromInt(model.bu) + ' days from now.');
										} else {
											return 'due date (required)';
										}
									}())),
							dN: $author$project$Pages$Dashboard$CAFChangeDate,
							dS: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
									$mdgriffith$elm_ui$Element$text(
										$author$project$Pages$Dashboard$toGermanDateString(model.J)))),
							dX: model.aD
						}),
						A2(
						$mdgriffith$elm_ui$Element$el,
				...
				((!$elm$core$List$isEmpty(model.e)) || ($elm$core$String$isEmpty(model.bj) || ($elm$core$String$isEmpty(model.aL) || $elm$core$String$isEmpty(model.aD)))) ? A2(
				$mdgriffith$elm_ui$Element$Input$button,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					...
					]),
				{
					iV: A2(
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
						$mdgriffith$elm_ui$Element$text('Submit')),
					aI: $elm$core$Maybe$Just($author$project$Pages$Dashboard$CreateAssignment)
				})
			]));
};
	...
	function (unit, n, _v0) {
		...
		switch (unit) {
			...
			case 1:
				...
				var wholeMonths = ((12 * (date.hs - 1)) + ($justinmimbs$date$Date$monthToNumber(date.gu) - 1)) + n;
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$List$cons,
								$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.dq + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.a1 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.go)))),
								attrs))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
	...
	function (today, courses) {
		...
		return A2(
				...
				return _Utils_update(
					course,
					{
						hL: A2(
							$elm$core$List$filter,
							function (a) {
								return _Utils_eq(a.ia, course.iF);
							},
							validAssignments)
					});
			},
			A2(
				$elm$core$List$filter,
				function (course) {
					return A2($elm$core$List$member, course.iF, validCourseIds);
				},
				courses));
	});
var $mdgriffith$elm_ui$Element$Border$solid = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$borderStyle, $mdgriffith$elm_ui$Internal$Style$classes.hW);
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Pages$Dashboard$ViewAssignmentModal(assignment.iF)),
					$mdgriffith$elm_ui$Element$htmlAttribute(
					$elm$html$Html$Attributes$class('button'))
				]),
			_List_fromArray(
				[
					...
					A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text(
								_Utils_ap(
									displayDate ? ($author$project$Pages$Dashboard$toGermanDateString(assignment.im) + ': ') : '',
									assignment.kb))
							]))),
					A2(
					$mdgriffith$elm_ui$Element$el,
					...
					$mdgriffith$elm_ui$Element$text(assignment.hg.fx))
				]));
	});
		...
		var assignments = function () {
			if (!maybeDate.$) {
				...
				return A2(
					$elm$core$List$filter,
					function (assignment) {
						return _Utils_eq(assignment.im, date);
					},
					course.hL);
			} else {
				return course.hL;
		...
		var validCourses = A2(
			...
			A2(
				...
				A2(
					$elm$core$List$map,
					function (course) {
						return _Utils_Tuple2(course.iF, course.hL);
					},
					courses)));
		return A2(
			$elm$core$List$filter,
			function (course) {
				return A2($elm$core$List$member, course.iF, validCourses);
			},
			courses);
	});
		...
		_List_fromArray(
			[
				...
				function () {
					...
					if (!_v1.$) {
						var user = _v1.a;
						return (user.i0 !== '') ? _List_fromArray(
							[
								A4($author$project$Pages$Dashboard$viewAssignmentsDayColumn, model.D, 'today', $author$project$Styling$Colors$redColor, model.J),
								A4(
								$author$project$Pages$Dashboard$viewAssignmentsDayColumn,
								model.D,
								'tomorrow',
								$author$project$Styling$Colors$yellowColor,
								A3($justinmimbs$date$Date$add, 3, 1, model.J)),
								A4(
								$author$project$Pages$Dashboard$viewAssignmentsDayColumn,
								model.D,
								'the day after tomorrow',
								$author$project$Styling$Colors$greenColor,
								A3($justinmimbs$date$Date$add, 3, 2, model.J))
							]) : _List_fromArray(
							[
								A2(
								$mdgriffith$elm_ui$Element$column,
								...
								_List_fromArray(
									[
											...
											]),
										{
											...
											bq: $author$project$Spa$Generated$Route$toString(6)
										})
									]))
							]);
					} else {
				...
				if (_v2.$ === 3) {
					...
					return ($elm$core$List$length(
						A2($author$project$Pages$Dashboard$otherOutstandingAssignments, model.J, courses)) > 0) ? A2($author$project$Pages$Dashboard$viewOtherAssignments, model.D, model.J) : $mdgriffith$elm_ui$Element$none;
				} else {
					return $mdgriffith$elm_ui$Element$none;
				}
			}()
	...
	function (linkData, active) {
		return A2(
				...
				]),
			{
				...
				bq: $author$project$Spa$Generated$Route$toString(linkData.b)
			});
	});
...
var $mdgriffith$elm_ui$Element$Font$semiBold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.j7);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				($elm$core$String$length(user.fx) > 12) ? $mdgriffith$elm_ui$Element$text(
					'Hey, ' + (A3($elm$core$String$slice, 0, 12, user.fx) + '...')) : $mdgriffith$elm_ui$Element$text('Hey, ' + user.fx)),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				function () {
...
var $author$project$Components$Sidebar$viewSidebar = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Components$Sidebar$viewUser(model.hg),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				A2($author$project$Components$Sidebar$viewLinks, links, model.hv))
			]));
};
				...
				return _Utils_Tuple2(
					...
					$elm$core$List$length(
						A2(
							...
							function (a) {
								return _Utils_eq(
									$author$project$Components$LineChart$dateToPosixTime(a.im),
									x.a);
							},
							assignments)));
			},
...
var $gampleman$elm_visualization$Scale$convert = F2(
	function (_v0, value) {
		var scale = _v0;
		return A3(scale.aB, scale.ef, scale.aj, value);
	});
var $gampleman$elm_visualization$Scale$rangeExtent = function (_v0) {
	var options = _v0;
	return A2(options.e7, options.ef, options.aj);
};
...
var $ryannhg$date_format$DateFormat$Language$Language = F6(
	function (toMonthName, toMonthAbbreviation, toWeekdayName, toWeekdayAbbreviation, toAmPm, toOrdinalSuffix) {
		return {kc: toAmPm, kd: toMonthAbbreviation, ke: toMonthName, cg: toOrdinalSuffix, kh: toWeekdayAbbreviation, ki: toWeekdayName};
	});
...
var $gampleman$elm_visualization$Scale$Time$scale = F3(
	function (zone, range_, domain_) {
		return {
			...
			gx: $gampleman$elm_visualization$Scale$Time$nice(zone),
			aj: range_,
			e7: F2(
				function (_v0, r) {
					return r;
				}),
			fp: $gampleman$elm_visualization$Scale$Time$tickFormat(zone),
			fq: $gampleman$elm_visualization$Scale$Time$ticks(zone)
		};
	});
...
var $gampleman$elm_visualization$Scale$Continuous$scaleWithTransform = F4(
	function (transform, untransform, range_, domain_) {
		return {
			aB: A2($gampleman$elm_visualization$Scale$Continuous$convertTransform, transform, $gampleman$elm_visualization$Interpolation$float),
			ef: domain_,
			iR: A2($gampleman$elm_visualization$Scale$Continuous$invertTransform, transform, untransform),
			gx: $gampleman$elm_visualization$Scale$Continuous$nice,
			aj: range_,
			e7: F2(
				function (_v0, r) {
					return r;
				}),
			fp: $gampleman$elm_visualization$Scale$Continuous$tickFormat,
			fq: $gampleman$elm_visualization$Scale$Continuous$ticks
		};
	});
...
var $gampleman$elm_visualization$Scale$tickFormat = function (_v0) {
	var opts = _v0;
	return opts.fp(opts.ef);
};
var $gampleman$elm_visualization$Scale$ticks = F2(
	function (_v0, count) {
		var scale = _v0;
		return A2(scale.fq, scale.ef, count);
	});
var $gampleman$elm_visualization$Axis$computeOptions = F2(
	function (attrs, scale) {
		...
		return A3(
			...
			{
				cd: opts.cd,
				fp: A2($gampleman$elm_visualization$Scale$tickFormat, scale, opts.cd),
				c4: opts.c4,
				ce: opts.ce,
				bh: opts.bh,
				fq: A2($gampleman$elm_visualization$Scale$ticks, scale, opts.cd)
			},
			postList);
	});
...
var $gampleman$elm_visualization$Axis$element = F4(
	function (_v0, k, displacement, textAnchorPosition) {
		...
		var y1 = _v0.kt;
		var y2 = _v0.ku;
		var translate = _v0.fu;
		var horizontal = _v0.en;
		return F2(
			function (attrs, scale) {
				...
				var spacing = A2($elm$core$Basics$max, opts.ce, 0) + opts.c4;
				...
				var domainLine = horizontal ? ('M' + ($elm$core$String$fromFloat(k * opts.bh) + (',' + ($elm$core$String$fromFloat(range0) + ('H0.5V' + ($elm$core$String$fromFloat(range1) + ('H' + $elm$core$String$fromFloat(k * opts.bh)))))))) : ('M' + ($elm$core$String$fromFloat(range0) + (',' + ($elm$core$String$fromFloat(k * opts.bh) + ('V0.5H' + ($elm$core$String$fromFloat(range1) + ('V' + $elm$core$String$fromFloat(k * opts.bh))))))));
				return A2(
					$elm$svg$Svg$g,
					_List_fromArray(
						[
					...
					A2(
						...
						A2(
							...
							_List_Nil),
						A2($elm$core$List$map, drawTick, opts.fq)));
			});
	});
...
var $gampleman$elm_visualization$Axis$verticalAttrs = {
	...
	hp: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$y, $elm$core$String$fromFloat),
	kp: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$y1, $elm$core$String$fromFloat),
	kq: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$y2, $elm$core$String$fromFloat),
	hr: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$x, $elm$core$String$fromFloat),
	kt: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$x1, $elm$core$String$fromFloat),
	ku: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$x2, $elm$core$String$fromFloat)
};
...
var $gampleman$elm_visualization$Axis$horizontalAttrs = {
	...
	hp: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$x, $elm$core$String$fromFloat),
	kp: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$x1, $elm$core$String$fromFloat),
	kq: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$x2, $elm$core$String$fromFloat),
	hr: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$y, $elm$core$String$fromFloat),
	kt: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$y1, $elm$core$String$fromFloat),
	ku: A2($elm$core$Basics$composeL, $elm$svg$Svg$Attributes$y2, $elm$core$String$fromFloat)
};
...
var $mdgriffith$elm_ui$Element$Font$underline = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.kj);
			...
			[
				...
				switch (_v0.$) {
					case 3:
						...
						return $mdgriffith$elm_ui$Element$html(
							A4($author$project$Components$LineChart$mainn, assignments, model.J, model.aQ, model.cf));
					case 2:
						var error = _v0.a;
						return A2(
							$mdgriffith$elm_ui$Element$el,
	...
	function (attrs, children) {
		...
		if (spaced.$ === 1) {
			return A4(
				...
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cu + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.a1 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fB)))),
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
						A2(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							{
								hv: $elm$core$Maybe$Just('dashboard'),
								ii: model.ii,
								hg: model.hg
							}),
							A2(
...
var $author$project$Pages$Dashboard$page = $author$project$Spa$Page$application(
	{iJ: $author$project$Pages$Dashboard$init, iW: $author$project$Pages$Dashboard$load, jz: $author$project$Pages$Dashboard$save, jU: $author$project$Pages$Dashboard$subscriptions, kk: $author$project$Pages$Dashboard$update, kl: $author$project$Pages$Dashboard$view});
	...
	return $elm$http$Http$riskyRequest(
		{
			...
			bi: $elm$core$Maybe$Nothing,
			bn: $elm$core$Maybe$Nothing,
			bq: $author$project$Api$Api$apiAddress + '/assignments/contributors/all'
		});
};
var $author$project$Pages$Dashboard$Admin$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{cw: $author$project$Api$Loading, ii: shared.ii, bq: url, hg: shared.hg},
					...
					_List_fromArray(
						[
							...
							function () {
								...
								if (!_v2.$) {
									var user = _v2.a;
									return (user.gM === 1) ? _List_fromArray(
										[
											A2(
											$mdgriffith$elm_ui$Element$column,
											_List_Nil,
...
var $author$project$Pages$Dashboard$Admin$page = $author$project$Spa$Page$application(
	{iJ: $author$project$Pages$Dashboard$Admin$init, iW: $author$project$Pages$Dashboard$Admin$load, jz: $author$project$Pages$Dashboard$Admin$save, jU: $author$project$Pages$Dashboard$Admin$subscriptions, kk: $author$project$Pages$Dashboard$Admin$update, kl: $author$project$Pages$Dashboard$Admin$view});
var $author$project$Pages$Dashboard$Moodle$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{co: $author$project$Api$NotAsked, D: $author$project$Api$NotAsked, ii: shared.ii, a8: '', a9: $author$project$Api$NotAsked, cR: '', ba: '', bq: url, hg: shared.hg},
			$elm$core$Platform$Cmd$none);
	});
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				a3: A2($author$project$Api$expectJson, onResponse, $author$project$Api$Homework$User$userDecoder),
				a4: _List_Nil,
				a7: 'POST',
				bi: $elm$core$Maybe$Nothing,
				bn: $elm$core$Maybe$Nothing,
				bq: $author$project$Api$Api$apiAddress + '/moodle/authenticate'
			});
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{hH: false, aZ: r.aZ, a3: r.a3, a4: r.a4, a7: r.a7, bi: r.bi, bn: r.bn, bq: r.bq}));
};
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{aZ: r.aZ, a3: r.a3, a4: _List_Nil, a7: 'POST', bi: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bq: r.bq});
};
		...
		return $elm$http$Http$post(
			{
				...
				a3: A2($author$project$Api$expectJson, options.gB, $author$project$Api$Moodle$Moodle$decoder),
				bq: 'https://api.hausis.3nt3.de' + '/moodle/get-school-info'
			});
	});
			...
			case 0:
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						{gB: $author$project$Pages$Dashboard$Moodle$GotSiteData}));
			case 1:
				var data = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 4:
				return _Utils_Tuple2(
					...
					A4(
						...
						$author$project$Pages$Dashboard$Moodle$addHttpSchemeIfMissing(model.cR),
						model.ba,
						model.a8,
			...
			default:
				...
				var sitename = function () {
					if (data.$ === 2) {
						...
						if (e.$ === 3) {
							var status = e.a;
							return (status === 401) ? model.a9 : $author$project$Api$NotAsked;
						} else {
...
var $mdgriffith$elm_ui$Element$Input$currentPassword = F2(
	function (attrs, pass) {
		return A3(
			...
			{
				am: $elm$core$Maybe$Just('current-password'),
				at: false,
				L: $mdgriffith$elm_ui$Element$Input$TextInputNode(
					pass.jK ? 'text' : 'password')
			},
			attrs,
			{iV: pass.iV, dN: pass.dN, dS: pass.dS, dX: pass.dX});
	});
			...
			[
				...
				function () {
					...
					if (_v1.$ === 3) {
						return _List_fromArray(
							[
								$author$project$Pages$Dashboard$Moodle$viewStatusIndicatorThingy(model.co),
								A2(
								$mdgriffith$elm_ui$Element$Input$text,
								_Utils_ap(
										...
										])),
								{
									...
									dN: $author$project$Pages$Dashboard$Moodle$ChangeMoodleUsernameInput,
									dS: $elm$core$Maybe$Just(
										A2(
											$mdgriffith$elm_ui$Element$Input$placeholder,
											_List_Nil,
										...
										])),
								{
									...
									dN: $author$project$Pages$Dashboard$Moodle$ChangeMoodlePasswordInput,
									dS: $elm$core$Maybe$Just(
										A2(
											$mdgriffith$elm_ui$Element$Input$placeholder,
											_List_Nil,
								...
								_Utils_ap(
									$author$project$Pages$Dashboard$Moodle$inputStyle,
									_Utils_ap(
										($elm$core$String$isEmpty(model.ba) || $elm$core$String$isEmpty(model.a8)) ? _List_fromArray(
											[
												$mdgriffith$elm_ui$Element$Background$color($author$project$Pages$Dashboard$Moodle$inputColor),
											...
											]))),
								{
									...
									aI: ($elm$core$String$isEmpty(model.ba) || $elm$core$String$isEmpty(model.a8)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just($author$project$Pages$Dashboard$Moodle$Authenticate)
								})
							]);
					} else {
						return _List_fromArray(
							[
								...
								$author$project$Pages$Dashboard$Moodle$inputStyle,
								{
									...
									dN: $author$project$Pages$Dashboard$Moodle$ChangeMoodleUrlInput,
									dS: $elm$core$Maybe$Just(
										A2(
											$mdgriffith$elm_ui$Element$Input$placeholder,
											_List_Nil,
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Components$Sidebar$viewSidebar(
							{
								hv: $elm$core$Maybe$Just('moodle integration'),
								ii: model.ii,
								hg: model.hg
							}),
							A2(
...
var $author$project$Pages$Dashboard$Moodle$page = $author$project$Spa$Page$application(
	{iJ: $author$project$Pages$Dashboard$Moodle$init, iW: $author$project$Pages$Dashboard$Moodle$load, jz: $author$project$Pages$Dashboard$Moodle$save, jU: $author$project$Pages$Dashboard$Moodle$subscriptions, kk: $author$project$Pages$Dashboard$Moodle$update, kl: $author$project$Pages$Dashboard$Moodle$view});
var $author$project$Pages$Login$init = F2(
	function (_v0, url) {
		return _Utils_Tuple2(
			{b2: $author$project$Api$NotAsked, cV: '', bq: url, dc: ''},
			$elm$core$Platform$Cmd$none);
	});
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'username',
					$elm$json$Json$Encode$string(credentials.fx)),
					_Utils_Tuple2(
					'password',
					$elm$json$Json$Encode$string(credentials.e3))
				]));
	} else {
		var email = _v0.a;
		return $elm$json$Json$Encode$object(
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				bi: $elm$core$Maybe$Nothing,
				bn: $elm$core$Maybe$Nothing,
				bq: $author$project$Api$Api$apiAddress + '/user/login'
			});
	});
				...
				if (data.$ === 3) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{b2: data}),
						A2($author$project$Utils$Route$navigate, model.bq.iU, 1));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			default:
				return _Utils_Tuple2(
					...
					A2(
						...
						{fW: $elm$core$Maybe$Nothing, e3: model.cV, fx: model.dc},
						{gB: $author$project$Pages$Login$GotLoginData}));
		}
	});
								...
								[
									...
									_List_fromArray(
										[
											...
											{
												iV: $mdgriffith$elm_ui$Element$Input$labelHidden('username'),
												dN: $author$project$Pages$Login$UsernameInput,
												dS: $elm$core$Maybe$Just(
													A2(
														$mdgriffith$elm_ui$Element$Input$placeholder,
														_List_Nil,
									...
									_List_fromArray(
										[
											...
											{
												iV: $mdgriffith$elm_ui$Element$Input$labelHidden('password'),
												dN: $author$project$Pages$Login$PasswordInput,
												dS: $elm$core$Maybe$Just(
													A2(
														$mdgriffith$elm_ui$Element$Input$placeholder,
														_List_Nil,
									...
									{
										iV: $author$project$Pages$Login$viewLoginButton(model),
										aI: $elm$core$Maybe$Just($author$project$Pages$Login$Login)
									})
								])))
					]))
			]),
...
var $author$project$Pages$Login$page = $author$project$Spa$Page$application(
	{iJ: $author$project$Pages$Login$init, iW: $author$project$Pages$Login$load, jz: $author$project$Pages$Login$save, jU: $author$project$Pages$Login$subscriptions, kk: $author$project$Pages$Login$update, kl: $author$project$Pages$Login$view});
...
var $author$project$Pages$NotFound$page = $author$project$Spa$Page$static(
	{kl: $author$project$Pages$NotFound$view});
var $author$project$Pages$Register$init = F2(
	function (_v0, url) {
		return _Utils_Tuple2(
			{
				cE: '',
				e: {fW: $elm$core$Maybe$Nothing, e3: $elm$core$Maybe$Nothing, fx: $elm$core$Maybe$Nothing},
				cV: '',
				b9: $author$project$Api$NotAsked,
				bq: url,
				dc: '',
				dd: $author$project$Api$NotAsked,
				de: ''
			},
			$elm$core$Platform$Cmd$none);
	});
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				bi: $elm$core$Maybe$Nothing,
				bn: $elm$core$Maybe$Nothing,
				bq: $author$project$Api$Api$apiAddress + '/user/register'
			});
	});
...
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aZ: $elm$http$Http$emptyBody, a3: r.a3, a4: _List_Nil, a7: 'GET', bi: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bq: r.bq});
};
var $author$project$Api$Homework$UsernameTaken$usernameTaken = F2(
	function (username, options) {
		return $elm$http$Http$get(
			{
				a3: A2($author$project$Api$expectJson, options.gB, $elm$json$Json$Decode$bool),
				bq: $author$project$Api$Api$apiAddress + ('/username-taken/' + username)
			});
	});
...
var $author$project$Pages$Register$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				...
				return ($elm$core$String$length(input) > 0) ? _Utils_Tuple2(
					...
					A2(
						...
						input,
						{gB: $author$project$Pages$Register$GotUsernameTaken})) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							e: A2(
					...
					_Utils_update(
						model,
						{
							e: A2(
								...
								model.e,
								A2($author$project$Pages$Register$validatePasswordInput, input, model.de)),
							cV: input
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
					...
					_Utils_update(
						model,
						{
							e: A2(
								$author$project$Pages$Register$setPasswordError,
								model.e,
								A2($author$project$Pages$Register$validatePasswordInput, model.cV, input)),
							de: input
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
			...
			default:
				return $author$project$Pages$Register$areErrorsEmpty(model.e) ? _Utils_Tuple2(
					model,
					A2(
						$author$project$Api$Homework$User$register,
						{
							fW: $elm$core$Maybe$Just(model.cE),
							e3: model.cV,
							fx: model.dc
						},
						{gB: $author$project$Pages$Register$GotRegistrationData})) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
...
var $mdgriffith$elm_ui$Element$Input$email = $mdgriffith$elm_ui$Element$Input$textHelper(
	{
		am: $elm$core$Maybe$Just('email'),
		at: false,
		L: $mdgriffith$elm_ui$Element$Input$TextInputNode('email')
	});
...
var $mdgriffith$elm_ui$Element$Input$newPassword = F2(
	function (attrs, pass) {
		return A3(
			$mdgriffith$elm_ui$Element$Input$textHelper,
			{
				am: $elm$core$Maybe$Just('new-password'),
				at: false,
				L: $mdgriffith$elm_ui$Element$Input$TextInputNode(
					pass.jK ? 'text' : 'password')
			},
...
var $author$project$Pages$Register$viewInputError = F2(
	function (model, inputName) {
		return (inputName === 'email') ? $author$project$Pages$Register$inputErrorMessage(model.e.fW) : ((inputName === 'username') ? $author$project$Pages$Register$inputErrorMessage(model.e.fx) : ((inputName === 'password') ? $author$project$Pages$Register$inputErrorMessage(model.e.e3) : $mdgriffith$elm_ui$Element$none));
	});
								...
								[
										...
										[
											...
											_List_fromArray(
												[
													...
													{
														iV: $mdgriffith$elm_ui$Element$Input$labelHidden('email'),
														dN: $author$project$Pages$Register$EmailInput,
														dS: $elm$core$Maybe$Just(
															A2(
																$mdgriffith$elm_ui$Element$Input$placeholder,
																_List_Nil,
											...
											_List_fromArray(
												[
													...
													{
														iV: $mdgriffith$elm_ui$Element$Input$labelHidden('username'),
														dN: $author$project$Pages$Register$UsernameInput,
														dS: $elm$core$Maybe$Just(
															A2(
																$mdgriffith$elm_ui$Element$Input$placeholder,
																_List_Nil,
									...
									_List_fromArray(
										[
											...
											$author$project$Pages$Register$passwordStrengthIndicator(model.cV),
											A2(
											$mdgriffith$elm_ui$Element$Input$newPassword,
											$author$project$Pages$Register$inputStyle,
											{
												iV: $mdgriffith$elm_ui$Element$Input$labelHidden('password'),
												dN: $author$project$Pages$Register$PasswordInput,
												dS: $elm$core$Maybe$Just(
													A2(
														$mdgriffith$elm_ui$Element$Input$placeholder,
														_List_Nil,
									...
									{
										iV: $mdgriffith$elm_ui$Element$Input$labelHidden('validate password'),
										dN: $author$project$Pages$Register$ValidatePasswordInput,
										dS: $elm$core$Maybe$Just(
											A2(
												$mdgriffith$elm_ui$Element$Input$placeholder,
												_List_Nil,
									...
									{
										iV: $author$project$Pages$Register$viewRegistrationButton(model),
										aI: $elm$core$Maybe$Just($author$project$Pages$Register$Register)
									})
								])))
					]))
			]),
...
var $author$project$Pages$Register$page = $author$project$Spa$Page$application(
	{iJ: $author$project$Pages$Register$init, iW: $author$project$Pages$Register$load, jz: $author$project$Pages$Register$save, jU: $author$project$Pages$Register$subscriptions, kk: $author$project$Pages$Register$update, kl: $author$project$Pages$Register$view});
		...
		return _Utils_Tuple2(
			...
			function () {
				if (!shared.gF) {
					var _v0 = shared.hg;
					if (!_v0.$) {
						return A2($author$project$Utils$Route$navigate, url.iU, 1);
					} else {
		...
		return _Utils_Tuple2(
			...
			function () {
				if (!shared.gF) {
					var _v0 = shared.hg;
					if (!_v0.$) {
						return A2($author$project$Utils$Route$navigate, model.bq.iU, 1);
					} else {
						return $elm$core$Platform$Cmd$none;
					}
				} else {
...
var $author$project$Pages$Top$page = $author$project$Spa$Page$application(
	{iJ: $author$project$Pages$Top$init, iW: $author$project$Pages$Top$load, jz: $author$project$Pages$Top$save, jU: $author$project$Pages$Top$subscriptions, kk: $author$project$Pages$Top$update, kl: $author$project$Pages$Top$view});
	...
	function (params, key, url) {
		return {
			...
			e6: A2(
				$elm$core$Maybe$withDefault,
				$elm$core$Dict$empty,
				A2($elm$core$Maybe$map, $author$project$Spa$Url$toQueryDict, url.e6)),
			gS: url
		};
	});
...
var $author$project$Spa$Generated$Pages$upgrade = F3(
	function (toModel, toMsg, page) {
			...
			function (params, shared) {
				return A3(
					...
					A2(
						page.iJ,
						shared,
						A3($author$project$Spa$Url$create, params, shared.iU, shared.bq)));
			});
		...
		return {ax: bundle_, iJ: init_, kk: update_};
	});
var $author$project$Spa$Generated$Pages$pages = {
	du: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Dashboard__Model, $author$project$Spa$Generated$Pages$Dashboard__Msg, $author$project$Pages$Dashboard$page),
	dv: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Dashboard__Admin__Model, $author$project$Spa$Generated$Pages$Dashboard__Admin__Msg, $author$project$Pages$Dashboard$Admin$page),
	dw: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Dashboard__Moodle__Model, $author$project$Spa$Generated$Pages$Dashboard__Moodle__Msg, $author$project$Pages$Dashboard$Moodle$page),
	dG: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Login__Model, $author$project$Spa$Generated$Pages$Login__Msg, $author$project$Pages$Login$page),
	dL: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$NotFound__Model, $author$project$Spa$Generated$Pages$NotFound__Msg, $author$project$Pages$NotFound$page),
	dT: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Register__Model, $author$project$Spa$Generated$Pages$Register__Msg, $author$project$Pages$Register$page),
	c6: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Top__Model, $author$project$Spa$Generated$Pages$Top__Msg, $author$project$Pages$Top$page)
};
var $author$project$Spa$Generated$Pages$init = function (route) {
	switch (route) {
		case 0:
			return $author$project$Spa$Generated$Pages$pages.c6.iJ(0);
		case 1:
			return $author$project$Spa$Generated$Pages$pages.du.iJ(0);
		case 2:
			return $author$project$Spa$Generated$Pages$pages.dG.iJ(0);
		case 3:
			return $author$project$Spa$Generated$Pages$pages.dL.iJ(0);
		case 4:
			return $author$project$Spa$Generated$Pages$pages.dT.iJ(0);
		case 5:
			return $author$project$Spa$Generated$Pages$pages.dv.iJ(0);
		default:
			return $author$project$Spa$Generated$Pages$pages.dw.iJ(0);
	}
};
...
var $elm$browser$Browser$Events$onSelfMsg = F3(
	function (router, _v0, state) {
		...
		var messages = A2($elm$core$List$filterMap, toMessage, state.ha);
		return A2(
			$elm$core$Task$andThen,
			function (_v1) {
				return $elm$core$Task$succeed(state);
...
var $author$project$Spa$Generated$Pages$bundle = function (bigModel) {
	switch (bigModel.$) {
		case 0:
			...
			return $author$project$Spa$Generated$Pages$pages.c6.ax(model);
		case 1:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.du.ax(model);
		case 2:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.dG.ax(model);
		case 3:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.dL.ax(model);
		case 4:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.dT.ax(model);
		case 5:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.dv.ax(model);
		default:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.dw.ax(model);
	}
};
var $author$project$Spa$Generated$Pages$subscriptions = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).jU(0);
};
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$author$project$Shared$subscriptions(model.as)),
				A2(
				$elm$core$Platform$Sub$map,
				$author$project$Main$Pages,
				$author$project$Spa$Generated$Pages$subscriptions(model.aK))
			]));
};
...
var $mdgriffith$elm_ui$Internal$Model$focusDefaultStyle = {
	...
	jJ: $elm$core$Maybe$Just(
		{
			bT: 0,
			bU: A4($mdgriffith$elm_ui$Internal$Model$Rgba, 155 / 255, 203 / 255, 1, 1),
			b: _Utils_Tuple2(0, 0),
			g4: 3
		})
};
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				case 1:
					...
					if (_v5.$ === 1) {
						return _Utils_update(
							record,
							{
								iv: $elm$core$Maybe$Just(focusStyle)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{iv: $elm$core$Maybe$Nothing, iD: $elm$core$Maybe$Nothing, b4: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.jx, $mdgriffith$elm_ui$Internal$Style$classes.hJ, $mdgriffith$elm_ui$Internal$Style$classes.jL]))),
...
var $author$project$Spa$Generated$Pages$load = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).iW(0);
};
...
var $author$project$Api$Homework$User$logout = function (options) {
	return $elm$http$Http$riskyRequest(
		{
			aZ: $elm$http$Http$emptyBody,
			a3: $elm$http$Http$expectWhatever(options.gB),
			a4: _List_Nil,
			a7: 'POST',
			bi: $elm$core$Maybe$Nothing,
			bn: $elm$core$Maybe$Nothing,
			bq: $author$project$Api$Api$apiAddress + '/user/logout'
		});
};
			...
			case 1:
				return _Utils_Tuple2(
					...
					$author$project$Api$Homework$User$logout(
						{gB: $author$project$Shared$GotLogoutData}));
			case 2:
				var w = msg.a;
				var h = msg.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							ii: $author$project$Shared$classifyDevice(
								{iA: h, kn: w})
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.c6.kk, msg, model);
					} else {
						break _v0$7;
					}
				case 1:
					if (_v0.b.$ === 1) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.du.kk, msg, model);
					} else {
						break _v0$7;
					}
				case 2:
					if (_v0.b.$ === 2) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.dG.kk, msg, model);
					} else {
						break _v0$7;
					}
				case 3:
					if (_v0.b.$ === 3) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.dL.kk, msg, model);
					} else {
						break _v0$7;
					}
				case 4:
					if (_v0.b.$ === 4) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.dT.kk, msg, model);
					} else {
						break _v0$7;
					}
				case 5:
					if (_v0.b.$ === 5) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.dv.kk, msg, model);
					} else {
						break _v0$7;
					}
				default:
					if (_v0.b.$ === 6) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.dw.kk, msg, model);
					} else {
						break _v0$7;
					}
			}
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							aK: page,
							as: A2($author$project$Spa$Generated$Pages$save, page, shared)
						}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$Pages, pageCmd));
			case 2:
				var sharedMsg = msg.a;
				var _v2 = A2($author$project$Shared$update, sharedMsg, model.as);
				var shared = _v2.a;
				var sharedCmd = _v2.b;
				var _v3 = A2($author$project$Spa$Generated$Pages$load, model.aK, shared);
				var page = _v3.a;
				var pageCmd = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				var pageMsg = msg.a;
				var _v4 = A2($author$project$Spa$Generated$Pages$update, pageMsg, model.aK);
				var page = _v4.a;
				var pageCmd = _v4.b;
				var shared = A2($author$project$Spa$Generated$Pages$save, page, model.as);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{aK: page, as: shared}),
				...
				if (!maybeUser.$) {
					return _List_fromArray(
						[
							...
							A3($author$project$Shared$navBarElement, $author$project$Shared$viewHomeButton, options.kf, '/')),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$Events$onClick(
									options.kf($author$project$Shared$Logout))
								]),
							A3(
								$author$project$Shared$navBarElement,
...
var $author$project$Spa$Generated$Pages$view = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).kl(0);
};
	...
	return A2(
		$author$project$Shared$view,
		{
			aK: A2(
				$author$project$Spa$Document$map,
				$author$project$Main$Pages,
				$author$project$Spa$Generated$Pages$view(model.aK)),
			kf: $author$project$Main$Shared
		},
		model.as);
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		iJ: $author$project$Main$init,
		jg: $author$project$Main$UrlChanged,
		jh: $author$project$Main$LinkClicked,
		jU: $author$project$Main$subscriptions,
		kk: $author$project$Main$update,
		kl: A2($elm$core$Basics$composeR, $author$project$Main$view, $author$project$Spa$Document$toBrowserDocument)
	});
