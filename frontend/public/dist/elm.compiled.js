...
var $author$project$Shared$Model = F5(
	function (url, key, user, device, overrideLoggedInRedirect) {
		return {device: device, key: key, overrideLoggedInRedirect: overrideLoggedInRedirect, url: url, user: user};
	});
...
var $author$project$Components$LineChart$Future = {$: 'Future'};
...
var $author$project$Models$Assignment = F7(
	function (id, courseId, user, title, dueDate, fromMoodle, doneBy) {
		return {courseId: courseId, doneBy: doneBy, dueDate: dueDate, fromMoodle: fromMoodle, id: id, title: title, user: user};
	});
...
var $author$project$Api$Homework$Assignment$getContributors = function (onResponse) {
	return $elm$http$Http$riskyRequest(
		{
			body: $elm$http$Http$emptyBody,
			expect: A2($author$project$Api$expectJson, onResponse, $author$project$Api$Homework$Assignment$contributorsDecoder),
			headers: _List_Nil,
			method: 'GET',
			timeout: $elm$core$Maybe$Nothing,
			tracker: $elm$core$Maybe$Nothing,
			url: $author$project$Api$Api$apiAddress + '/assignments/contributors'
		});
};
	...
	return $elm$http$Http$riskyRequest(
		{
			...
			timeout: $elm$core$Maybe$Nothing,
			tracker: $elm$core$Maybe$Nothing,
			url: $author$project$Api$Api$apiAddress + '/courses/stats'
		});
};
		...
		return _Utils_Tuple2(
			{
				...
				assignmentModalData: $author$project$Api$NotAsked,
				assignmentTitleFocused: false,
				contributorData: $author$project$Api$Loading,
				courseData: $author$project$Api$Loading,
				courseStatsData: $author$project$Api$Loading,
				createAssignmentData: $author$project$Api$NotAsked,
				dateTfText: '',
				device: shared.device,
				editAssignmentTitleTfText: '',
				errors: _List_Nil,
				maybeAssignmentModalActivated: $elm$core$Maybe$Nothing,
				...
				timeRange: 7,
				timeRangeDirection: $author$project$Components$LineChart$Future,
				titleTfText: '',
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				expect: A2($author$project$Api$expectJson, onResponse, $author$project$Api$Homework$Course$assignmentDecoder),
				headers: _List_Nil,
				method: 'PUT',
				timeout: $elm$core$Maybe$Nothing,
				tracker: $elm$core$Maybe$Nothing,
				url: $author$project$Api$Api$apiAddress + ('/assignment/' + id)
			});
	});
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							today: A2($justinmimbs$date$Date$fromPosix, model.zone, time)
						}),
					$elm$core$Platform$Cmd$none);
			case 'AdjustTimeZone':
				var zone = msg.a;
				...
				if (_v4.$ === 'Just') {
					...
					if (_v5.$ === 'Just') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{dateTfText: '', errors: _List_Nil, searchCoursesData: $author$project$Api$NotAsked, searchCoursesText: '', selectedCourse: $elm$core$Maybe$Nothing, selectedDate: $elm$core$Maybe$Nothing}),
							A2(
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Api$Homework$Course$getActiveCourses(
								{onResponse: $author$project$Pages$Dashboard$GotCourseData}),
								A2($author$project$Api$Homework$Assignment$getAssignments, model.timeRange, $author$project$Pages$Dashboard$GotAssignmentData)
							])));
			case 'Add1Day':
				var epochStartOffset = 719162;
				var date = A2(
							...
							selectedDateTime: $elm$time$Time$millisToPosix(
								$elm$core$Basics$floor(
									$justinmimbs$date$Date$toRataDie(
										A2($justinmimbs$date$Date$fromPosix, model.zone, model.selectedDateTime)) - epochStartOffset) * (((1000 * 60) * 60) * 24))
						}),
					$elm$core$Platform$Cmd$none);
			...
			case 'CloseModal':
				return _Utils_Tuple2(
					_Utils_update(
						...
						{maybeAssignmentModalActivated: $elm$core$Maybe$Nothing}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeAssignmentTitle':
				var assignmentId = msg.a;
				var _v8 = model.courseData;
				if (_v8.$ === 'Success') {
					...
					return _Utils_Tuple2(
											...
											return _Utils_update(
												c,
												{
													assignments: A2(
														$elm$core$List$map,
														function (a) {
															return _Utils_eq(a.id, assignmentId) ? _Utils_update(
																a,
																{title: model.editAssignmentTitleTfText}) : a;
														},
														c.assignments)
												});
										},
						...
						A3($author$project$Api$Homework$Assignment$changeAssignmentTitle, assignmentId, model.editAssignmentTitleTfText, $author$project$Pages$Dashboard$GotChangeAssignmentTitle));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'ChangeAssignmentTitleTfText':
				var text = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{editAssignmentTitleTfText: text}),
					$elm$core$Platform$Cmd$none);
			case 'FocusAssignmentTitle':
				var title = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{assignmentTitleFocused: true, editAssignmentTitleTfText: title}),
					$elm$core$Platform$Cmd$none);
			case 'UnfocusAssignmentTitle':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{assignmentTitleFocused: false}),
					$elm$core$Platform$Cmd$none);
			case 'GotChangeAssignmentTitle':
				var assignmentData = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{assignmentModalData: assignmentData, assignmentTitleFocused: false}),
					$elm$core$Platform$Cmd$none);
...
var $author$project$Pages$Dashboard$ChangeAssignmentTitle = function (a) {
	return {$: 'ChangeAssignmentTitle', a: a};
};
var $author$project$Pages$Dashboard$ChangeAssignmentTitleTfText = function (a) {
	return {$: 'ChangeAssignmentTitleTfText', a: a};
};
var $author$project$Pages$Dashboard$CloseModal = {$: 'CloseModal'};
...
var $author$project$Pages$Dashboard$UnfocusAssignmentTitle = {$: 'UnfocusAssignmentTitle'};
			...
			if (_v2.$ === 'Just') {
				...
				return A2(
					...
					A2(
						...
						function () {
							var _v3 = model.assignmentModalData;
							switch (_v3.$) {
								case 'Success':
										...
										[
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
																	_Utils_eq(user.id, assignment.user.id) ? $mdgriffith$elm_ui$Element$Events$onClick(
																	$author$project$Pages$Dashboard$FocusAssignmentTitle(assignment.title)) : $mdgriffith$elm_ui$Element$pointer,
																	$mdgriffith$elm_ui$Element$pointer
																]),
															model.assignmentTitleFocused ? A2(
																...
																_List_fromArray(
																	[
																		...
																		$author$project$Pages$Dashboard$ChangeAssignmentTitle(assignment.id),
																		$author$project$Pages$Dashboard$UnfocusAssignmentTitle)
																	]),
																{
																	label: $mdgriffith$elm_ui$Element$Input$labelHidden('edit assignment title'),
																	onChange: $author$project$Pages$Dashboard$ChangeAssignmentTitleTfText,
											...
											$mdgriffith$elm_ui$Element$text(
												'Course: ' + A2(
													$elm$core$Maybe$withDefault,
													'undefined',
													A2($author$project$Pages$Dashboard$getCourseNameById, courses, assignment.courseId)))),
											A2(
											$mdgriffith$elm_ui$Element$row,
											_List_fromArray(
												[
...
var $author$project$Components$PieChart$pieLabel = F2(
	function (slice, _v0) {
		...
		var _v1 = $gampleman$elm_visualization$Shape$centroid(
			_Utils_update(
				slice,
				{innerRadius: $author$project$Components$PieChart$radius - dings, outerRadius: $author$project$Components$PieChart$radius - dings}));
		var x = _v1.a;
		var y = _v1.b;
		return A2(
...
var $author$project$Components$PieChart$view = function (model) {
	var pieData = A2(
		...
		_Utils_update(
			...
			{outerRadius: $author$project$Components$PieChart$radius}),
		A2(
			$elm$core$List$map,
			$elm$core$Basics$toFloat,
...
var $author$project$Pages$Dashboard$ViewAssignmentModal = function (a) {
	return {$: 'ViewAssignmentModal', a: a};
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Pages$Dashboard$ViewAssignmentModal(assignment.id)),
					$mdgriffith$elm_ui$Element$htmlAttribute(
					$elm$html$Html$Attributes$class('button'))
				]),
			_List_fromArray(
				...
				switch (courseData.$) {
					case 'Success':
						...
						var assignments = A2(
							$elm$core$List$filter,
							function (a) {
								return _Utils_eq(a.dueDate, date);
							},
							A3(
								$elm$core$List$foldl,
		...
		_List_fromArray(
			[
				...
				function () {
					...
					if (_v1.$ === 'Just') {
						var user = _v1.a;
						return (user.moodleUrl !== '') ? _List_fromArray(
							[
								...
								_List_fromArray(
									[
											...
											]),
										{
											...
											url: $author$project$Spa$Generated$Route$toString($author$project$Spa$Generated$Route$Dashboard__Moodle)
										})
									]))
							]);
					} else {
						...
						_List_fromArray(
							[
									...
									buttonStyle),
								{
									label: A2(
										$mdgriffith$elm_ui$Element$el,
										(model.timeRange === 7) ? _List_fromArray(
									...
									buttonStyle),
								{
									label: A2(
										$mdgriffith$elm_ui$Element$el,
										(model.timeRange === 31) ? _List_fromArray(
											[$mdgriffith$elm_ui$Element$Font$bold, $mdgriffith$elm_ui$Element$Font$underline]) : _List_Nil,
									...
									buttonStyle),
								{
									label: A2(
										$mdgriffith$elm_ui$Element$el,
										(model.timeRange === 90) ? _List_fromArray(
											[$mdgriffith$elm_ui$Element$Font$bold, $mdgriffith$elm_ui$Element$Font$underline]) : _List_Nil,
									...
									buttonStyle),
								{
									label: A2(
										$mdgriffith$elm_ui$Element$el,
										(model.timeRange === 187) ? _List_fromArray(
											[$mdgriffith$elm_ui$Element$Font$bold, $mdgriffith$elm_ui$Element$Font$underline]) : _List_Nil,
								...
								_List_fromArray(
									[
											...
											]),
										{
											label: A2(
												$mdgriffith$elm_ui$Element$el,
												_Utils_eq(model.timeRangeDirection, $author$project$Components$LineChart$Past) ? _List_fromArray(
													[$mdgriffith$elm_ui$Element$Font$bold, $mdgriffith$elm_ui$Element$Font$underline]) : _List_Nil,
											...
											]),
										{
											label: A2(
												$mdgriffith$elm_ui$Element$el,
												_Utils_eq(model.timeRangeDirection, $author$project$Components$LineChart$Future) ? _List_fromArray(
													[$mdgriffith$elm_ui$Element$Font$bold, $mdgriffith$elm_ui$Element$Font$underline]) : _List_Nil,
...
var $author$project$Pages$Dashboard$Admin$GotContributorInfo = function (a) {
	return {$: 'GotContributorInfo', a: a};
};
	...
	return $elm$http$Http$riskyRequest(
		{
			...
			timeout: $elm$core$Maybe$Nothing,
			tracker: $elm$core$Maybe$Nothing,
			url: $author$project$Api$Api$apiAddress + '/assignments/contributors/all'
		});
};
var $author$project$Pages$Dashboard$Admin$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{contributorInfo: $author$project$Api$Loading, device: shared.device, url: url, user: shared.user},
			$author$project$Api$Homework$Assignment$getContributorsAdmin($author$project$Pages$Dashboard$Admin$GotContributorInfo));
	});
					...
					_List_fromArray(
						[
							...
							function () {
								...
								if (_v2.$ === 'Just') {
									var user = _v2.a;
									return _Utils_eq(user.privilege, $author$project$Models$Admin) ? _List_fromArray(
										[
											A2(
											$mdgriffith$elm_ui$Element$column,
											_List_Nil,
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				expect: A2($author$project$Api$expectJson, onResponse, $author$project$Api$Homework$User$userDecoder),
				headers: _List_Nil,
				method: 'POST',
				timeout: $elm$core$Maybe$Nothing,
				tracker: $elm$core$Maybe$Nothing,
			...
			case 'Authenticate':
				return _Utils_Tuple2(
					...
					A4(
						...
						$author$project$Pages$Dashboard$Moodle$addHttpSchemeIfMissing(model.moodleUrlInput),
...
var $author$project$Pages$Top$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{url: url, user: shared.user},
			function () {
				if (!shared.overrideLoggedInRedirect) {
					var _v0 = shared.user;
					if (_v0.$ === 'Just') {
						return A2($author$project$Utils$Route$navigate, url.key, $author$project$Spa$Generated$Route$Dashboard);
					} else {
		...
		return _Utils_Tuple2(
			...
			function () {
				if (!shared.overrideLoggedInRedirect) {
					var _v0 = shared.user;
					if (_v0.$ === 'Just') {
						return A2($author$project$Utils$Route$navigate, model.url.key, $author$project$Spa$Generated$Route$Dashboard);
					} else {
						return $elm$core$Platform$Cmd$none;
					}
				} else {
				...
				if (userData.$ === 'Success') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								overrideLoggedInRedirect: false,
								user: $elm$core$Maybe$Just(user)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
...
var $author$project$Shared$OverrideRedirect = {$: 'OverrideRedirect'};
				...
				if (maybeUser.$ === 'Just') {
					return _List_fromArray(
						[
							...
							A3($author$project$Shared$navBarElement, $author$project$Shared$viewHomeButton, options.toMsg, '/')),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
