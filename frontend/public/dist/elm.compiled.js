...
var $author$project$Models$Assignment = F8(
	function (id, courseId, user, title, dueDate, fromMoodle, doneBy, doneByUsers) {
		return {courseId: courseId, doneBy: doneBy, doneByUsers: doneByUsers, dueDate: dueDate, fromMoodle: fromMoodle, id: id, title: title, user: user};
	});
	...
	return $elm$http$Http$riskyRequest(
		{
			...
			timeout: $elm$core$Maybe$Nothing,
			tracker: $elm$core$Maybe$Nothing,
			url: $author$project$Api$Api$apiAddress + '/courses/active?expandUsers'
		});
};
		...
		return _Utils_Tuple2(
			{
				...
				errors: _List_Nil,
				markAssignmentDoneData: $author$project$Api$NotAsked,
